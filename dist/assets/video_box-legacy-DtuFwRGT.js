...
`)}`}function $(e=0){return new Promise(t=>setTimeout(t,e))}function Ut(e,t){let n;return function(...r){clearTimeout(n),n=setTimeout(()=>(n=null,e.apply(this,r)),t)}}function Wt(e,t){let n=!1;return function(...r){n||(e.apply(this,r),n=!0,setTimeout(()=>{n=!1},t))}}function Gt(e,t,n){return X(t===O||t===k||e instanceof Element,`${n.join(`.`)} require '${O}' or 'Element' type`)}function Kt(e){return t=>{let{i18n:n,constructor:{ASPECT_RATIO:r}}=t,i=r.map(e=>`<span data-value="${e}">${e==="default"?n.get(`Default`):e}</span>`).join(``);return{...e,html:`${n.get(`Aspect Ratio`)}: ${i}`,click:(e,n)=>{let{value:r}=n.target.dataset;r&&(t.aspectRatio=r,e.show=!1)},mounted:e=>{let n=R(`[data-value="default"]`,e);n&&G(n,`art-current`),t.on(`aspectRatio`,t=>{let n=z(`span`,e).find(e=>e.dataset.value===t);n&&G(n,`art-current`)})}}}}function qt(e){return t=>({...e,html:t.i18n.get(`Close`),click:e=>{e.show=!1}})}function Jt(e){return t=>{let{i18n:n,constructor:{FLIP:r}}=t,i=r.map(e=>`<span data-value="${e}">${n.get(Nt(e))}</span>`).join(``);return{...e,html:`${n.get(`Video Flip`)}: ${i}`,click:(e,n)=>{let{value:r}=n.target.dataset;r&&(t.flip=r.toLowerCase(),e.show=!1)},mounted:e=>{let n=R(`[data-value="normal"]`,e);n&&G(n,`art-current`),t.on(`flip`,t=>{let n=z(`span`,e).find(e=>e.dataset.value===t);n&&G(n,`art-current`)})}}}}function Yt(e){return t=>({...e,html:t.i18n.get(`Video Info`),click:e=>{t.info.show=!0,e.show=!1}})}function Xt(e){return t=>{let{i18n:n,constructor:{PLAYBACK_RATE:r}}=t,i=r.map(e=>`<span data-value="${e}">${e===1?n.get(`Normal`):e.toFixed(1)}</span>`).join(``);return{...e,html:`${n.get(`Play Speed`)}: ${i}`,click:(e,n)=>{let{value:r}=n.target.dataset;r&&(t.playbackRate=Number(r),e.show=!1)},mounted:e=>{let n=R(`[data-value="1"]`,e);n&&G(n,`art-current`),t.on(`video:ratechange`,()=>{let n=z(`span`,e).find(e=>Number(e.dataset.value)===t.playbackRate);n&&G(n,`art-current`)})}}}}function Zt(e){let t=T?location.href:``;return{...e,html:`<a href="https://artplayer.org?ref=${encodeURIComponent(t)}" target="_blank" style="width:100%;">ArtPlayer ${y}</a>`}}function Qt(e){return t=>({...e,tooltip:t.i18n.get(`AirPlay`),mounted:e=>{let{proxy:n,icons:r}=t;U(e,r.airplay),n(e,`click`,()=>t.airplay())}})}function $t(e){return t=>({...e,tooltip:t.i18n.get(`Fullscreen`),mounted:e=>{let{proxy:n,icons:r,i18n:i}=t,a=U(e,r.fullscreenOn),o=U(e,r.fullscreenOff);W(o,`display`,`none`),n(e,`click`,()=>{t.fullscreen=!t.fullscreen}),t.on(`fullscreen`,t=>{t?(K(e,i.get(`Exit Fullscreen`)),W(a,`display`,`none`),W(o,`display`,`inline-flex`)):(K(e,i.get(`Fullscreen`)),W(a,`display`,`inline-flex`),W(o,`display`,`none`))})}})}function en(e){return t=>({...e,tooltip:t.i18n.get(`Web Fullscreen`),mounted:e=>{let{proxy:n,icons:r,i18n:i}=t,a=U(e,r.fullscreenWebOn),o=U(e,r.fullscreenWebOff);W(o,`display`,`none`),n(e,`click`,()=>{t.fullscreenWeb=!t.fullscreenWeb}),t.on(`fullscreenWeb`,t=>{t?(K(e,i.get(`Exit Web Fullscreen`)),W(a,`display`,`none`),W(o,`display`,`inline-flex`)):(K(e,i.get(`Web Fullscreen`)),W(a,`display`,`inline-flex`),W(o,`display`,`none`))})}})}function tn(e){return t=>({...e,tooltip:t.i18n.get(`PIP Mode`),mounted:e=>{let{proxy:n,icons:r,i18n:i}=t;U(e,r.pip),n(e,`click`,()=>{t.pip=!t.pip}),t.on(`pip`,t=>{K(e,i.get(t?`Exit PIP Mode`:`PIP Mode`))})}})}function nn(e){return t=>({...e,mounted:e=>{let{proxy:n,icons:r,i18n:i}=t,a=U(e,r.play),o=U(e,r.pause);K(a,i.get(`Play`)),K(o,i.get(`Pause`)),n(a,`click`,()=>{t.play()}),n(o,`click`,()=>{t.pause()});function s(){W(a,`display`,`flex`),W(o,`display`,`none`)}function c(){W(a,`display`,`none`),W(o,`display`,`flex`)}t.playing?c():s(),t.on(`video:playing`,()=>{c()}),t.on(`video:pause`,()=>{s()})}})}function rn(e,t){let{$progress:n}=e.template,{left:r}=Y(n),i=Z((w?t.touches[0].clientX:t.clientX)-r,0,n.clientWidth),a=i/n.clientWidth*e.duration;return{second:a,time:Q(a),width:i,percentage:Z(i/n.clientWidth,0,1)}}function an(e,t){if(e.isRotate){let n=t.touches[0].clientY/e.height,r=n*e.duration;e.emit(`setBar`,`played`,n,t),e.seek=r}else{let{second:n,percentage:r}=rn(e,t);e.emit(`setBar`,`played`,r,t),e.seek=n}}function on(e){return t=>{let{icons:n,option:r,proxy:i}=t,{$player:a,$progress:o}=t.template;return{...e,html:`
            ...
            `,mounted:e=>{let s=null,c=!1,l=R(`.art-progress-hover`,e),u=R(`.art-progress-loaded`,e),d=R(`.art-progress-played`,e),f=R(`.art-progress-highlight`,e),p=R(`.art-progress-indicator`,e),m=R(`.art-progress-tip`,e);n.indicator?U(p,n.indicator):W(p,`backgroundColor`,`var(--art-theme)`);function h(n){let{width:r}=rn(t,n),{text:i}=n.target.dataset;m.textContent=i;let a=m.clientWidth;r<=a/2?W(m,`left`,0):r>e.clientWidth-a/2?W(m,`left`,`${e.clientWidth-a}px`):W(m,`left`,`${r-a/2}px`)}function g(n,r){let{width:i,time:a}=r||rn(t,n);m.textContent=a||`00:00`;let o=m.clientWidth;i<=o/2?W(m,`left`,0):i>e.clientWidth-o/2?W(m,`left`,`${e.clientWidth-o}px`):W(m,`left`,`${i-o/2}px`)}function ee(){f.textContent=``;for(let e=0;e<r.highlight.length;e++){let n=r.highlight[e],i=Z(n.time,0,t.duration)/t.duration*100,a=`<span data-text="${n.text}" data-time="${n.time}" style="left: ${i}%"></span>`;U(f,a)}}function te(n,r,i){let o=n===`played`&&i&&w;n===`loaded`&&W(u,`width`,`${r*100}%`),n===`hover`&&(W(l,`width`,`${r*100}%`),q(i,f)?h(i):g(i),r===0?V(a,`art-progress-hover`):B(a,`art-progress-hover`)),n===`played`&&(W(d,`width`,`${r*100}%`),W(p,`left`,`${r*100}%`)),o&&(B(a,`art-progress-hover`),g(i,{width:e.clientWidth*r,time:Q(r*t.duration)}),clearTimeout(s),s=setTimeout(()=>{V(a,`art-progress-hover`)},500))}t.on(`setBar`,te),t.on(`video:loadedmetadata`,ee),t.constructor.USE_RAF?t.on(`raf`,()=>{t.emit(`setBar`,`played`,t.played),t.emit(`setBar`,`loaded`,t.loaded)}):(t.on(`video:timeupdate`,()=>{t.emit(`setBar`,`played`,t.played)}),t.on(`video:progress`,()=>{t.emit(`setBar`,`loaded`,t.loaded)}),t.on(`video:ended`,()=>{t.emit(`setBar`,`played`,1)})),t.emit(`setBar`,`loaded`,t.loaded||0),w||(i(o,`click`,e=>{e.target!==p&&an(t,e)}),i(o,`mousemove`,e=>{let{percentage:n}=rn(t,e);t.emit(`setBar`,`hover`,n,e)}),i(o,`mouseleave`,e=>{t.emit(`setBar`,`hover`,0,e)}),i(o,`mousedown`,e=>{c=e.button===0}),t.on(`document:mousemove`,e=>{if(c){let{second:n,percentage:r}=rn(t,e);t.emit(`setBar`,`played`,r,e),t.seek=n}}),t.on(`document:mouseup`,()=>{c&&(c=!1)}))}}}}function sn(e){return t=>({...e,tooltip:t.i18n.get(`Screenshot`),mounted:e=>{let{proxy:n,icons:r}=t;U(e,r.screenshot),n(e,`click`,()=>{t.screenshot()})}})}function cn(e){return t=>({...e,tooltip:t.i18n.get(`Show Setting`),mounted:e=>{let{proxy:n,icons:r,i18n:i}=t;U(e,r.setting),n(e,`click`,()=>{t.setting.toggle(),t.setting.resize()}),t.on(`setting`,t=>{K(e,i.get(t?`Hide Setting`:`Show Setting`))})}})}function ln(e){return t=>({...e,style:w?{fontSize:`12px`,padding:`0 5px`}:{cursor:`auto`,padding:`0 10px`},mounted:e=>{function n(){let n=`${Q(t.currentTime)} / ${Q(t.duration)}`;n!==e.textContent&&(e.textContent=n)}n();let r=[`video:loadedmetadata`,`video:timeupdate`,`video:progress`];for(let e=0;e<r.length;e++)t.on(r[e],n)}})}function un(e){return t=>({...e,mounted:e=>{let{proxy:n,icons:r}=t,i=U(e,r.volume),a=U(e,r.volumeClose),o=U(e,`<div class="art-volume-panel"></div>`),s=U(o,`<div class="art-volume-inner"></div>`),c=U(s,`<div class="art-volume-val"></div>`),l=U(s,`<div class="art-volume-slider"></div>`),u=U(U(l,`<div class="art-volume-handle"></div>`),`<div class="art-volume-loaded"></div>`),d=U(l,`<div class="art-volume-indicator"></div>`);function f(e){let{top:t,height:n}=Y(l);return 1-(e.clientY-t)/n}function p(){if(t.muted||t.volume===0)W(i,`display`,`none`),W(a,`display`,`flex`),W(d,`top`,`100%`),W(u,`top`,`100%`),c.textContent=0;else{let e=t.volume*100;W(i,`display`,`flex`),W(a,`display`,`none`),W(d,`top`,`${100-e}%`),W(u,`top`,`${100-e}%`),c.textContent=Math.floor(e)}}if(p(),t.on(`video:volumechange`,p),n(i,`click`,()=>{t.muted=!0}),n(a,`click`,()=>{t.muted=!1}),w)W(o,`display`,`none`);else{let e=!1;n(l,`mousedown`,n=>{e=n.button===0,t.volume=f(n)}),t.on(`document:mousemove`,n=>{e&&(t.muted=!1,t.volume=f(n))}),t.on(`document:mouseup`,()=>{e&&(e=!1)})}}})}function dn(e,t){let{constructor:n,template:{$player:r,$video:i}}=e;function a(t){q(t,r)?(e.isInput=t.target.tagName===`INPUT`,e.isFocus=!0,e.emit(`focus`,t)):(e.isInput=!1,e.isFocus=!1,e.emit(`blur`,t))}e.on(`document:click`,a),e.on(`document:contextmenu`,a);let o=[];t.proxy(i,`click`,t=>{let r=Date.now();o.push(r);let{MOBILE_CLICK_PLAY:i,DBCLICK_TIME:a,MOBILE_DBCLICK_PLAY:s,DBCLICK_FULLSCREEN:c}=n,l=o.filter(e=>r-e<=a);switch(l.length){case 1:e.emit(`click`,t),w?!e.isLock&&i&&e.toggle():e.toggle(),o=l;break;case 2:e.emit(`dblclick`,t),w?!e.isLock&&s&&e.toggle():c&&(e.fullscreen=!e.fullscreen),o=[];break;default:o=[]}})}function fn(e,t){return Math.atan2(t,e)*180/Math.PI}function pn(e,t,n,r){let i=t-r,a=n-e,o=0;if(Math.abs(a)<2&&Math.abs(i)<2)return o;let s=fn(a,i);return s>=-45&&s<45?o=4:s>=45&&s<135?o=1:s>=-135&&s<-45?o=2:(s>=135&&s<=180||s>=-180&&s<-135)&&(o=3),o}function mn(e,t){if(w&&!e.option.isLive){let{$video:n,$progress:r}=e.template,i=null,a=!1,o=0,s=0,c=0,l=t=>{if(t.touches.length===1&&!e.isLock){i===r&&an(e,t),a=!0;let{pageX:n,pageY:l}=t.touches[0];o=n,s=l,c=e.currentTime}},u=t=>{if(t.touches.length===1&&a&&e.duration){let{pageX:r,pageY:a}=t.touches[0],l=pn(o,s,r,a),u=[3,4].includes(l),d=[1,2].includes(l);if(u&&!e.isRotate||d&&e.isRotate){let l=Z((r-o)/e.width,-1,1),u=Z((a-s)/e.height,-1,1),d=e.isRotate?u:l,f=i===n?e.constructor.TOUCH_MOVE_RATIO:1,p=Z(c+e.duration*d*f,0,e.duration);e.seek=p,e.emit(`setBar`,`played`,Z(p/e.duration,0,1),t),e.notice.show=`${Q(p)} / ${Q(e.duration)}`}}};e.option.gesture&&(t.proxy(n,`touchstart`,e=>{i=n,l(e)}),t.proxy(n,`touchmove`,u)),t.proxy(r,`touchstart`,e=>{i=r,l(e)}),t.proxy(r,`touchmove`,u),e.on(`document:touchend`,()=>{a&&(o=0,s=0,c=0,a=!1,i=null)})}}function hn(e,t){let n=[`click`,`mouseup`,`keydown`,`touchend`,`touchmove`,`mousemove`,`pointerup`,`contextmenu`,`pointermove`,`visibilitychange`,`webkitfullscreenchange`],r=[`resize`,`scroll`,`orientationchange`],i=[];function a(a={}){for(let e=0;e<i.length;e++)t.remove(i[e]);i.length=0;let{$player:o}=e.template;n.forEach(n=>{let r=a.document||o.ownerDocument||document,s=t.proxy(r,n,t=>{e.emit(`document:${n}`,t)});i.push(s)}),r.forEach(n=>{let r=a.window||o.ownerDocument?.defaultView||window,s=t.proxy(r,n,t=>{e.emit(`window:${n}`,t)});i.push(s)})}a(),t.bindGlobalEvents=a}function gn(e,t){let{$player:n}=e.template;t.hover(n,t=>{B(n,`art-hover`),e.emit(`hover`,!0,t)},t=>{V(n,`art-hover`),e.emit(`hover`,!1,t)})}function _n(e,t){let{$player:n}=e.template;t.proxy(n,`mousemove`,t=>{e.emit(`mousemove`,t)})}function vn(e,t){let{option:n,constructor:r}=e;e.on(`resize`,()=>{let{aspectRatio:t,notice:r}=e;e.state===`standard`&&n.autoSize&&e.autoSize(),e.aspectRatio=t,r.show=``});let i=Ut(()=>e.emit(`resize`),r.RESIZE_TIME);e.on(`window:orientationchange`,()=>i()),e.on(`window:resize`,()=>i()),screen&&screen.orientation&&screen.orientation.onchange&&t.proxy(screen.orientation,`change`,()=>i())}function yn(e){if(e.constructor.USE_RAF){let t=null;(function n(){e.playing&&e.emit(`raf`),e.isDestroy||(t=requestAnimationFrame(n))})(),e.on(`destroy`,()=>{cancelAnimationFrame(t)})}}function bn(e){let{option:t,constructor:n,template:{$container:r}}=e,i=Wt(()=>{e.emit(`view`,wt(r,n.SCROLL_GAP))},n.SCROLL_TIME);e.on(`window:scroll`,()=>i()),e.on(`view`,n=>{t.autoMini&&(e.mini=!n)})}function xn(e){let{i18n:t,notice:n,proxy:r,template:{$video:i}}=e,a=!0;window.WebKitPlaybackTargetAvailabilityEvent&&i.webkitShowPlaybackTargetPicker?r(i,`webkitplaybacktargetavailabilitychanged`,e=>{switch(e.availability){case`available`:a=!0;break;case`not-available`:a=!1}}):a=!1,E(e,`airplay`,{value(){a?(i.webkitShowPlaybackTargetPicker(),e.emit(`airplay`)):n.show=t.get(`AirPlay Not Available`)}})}function Sn(e){let{i18n:t,notice:n,template:{$video:r,$player:i}}=e;E(e,`aspectRatio`,{get(){return i.dataset.aspectRatio||`default`},set(a){if(a||(a=`default`),a==="default")W(r,`width`,null),W(r,`height`,null),W(r,`margin`,null),delete i.dataset.aspectRatio;else{let e=a.split(`:`).map(Number),{clientWidth:t,clientHeight:n}=i,o=t/n,s=e[0]/e[1];o>s?(W(r,`width`,`${s*n}px`),W(r,`height`,`100%`),W(r,`margin`,`0 auto`)):(W(r,`width`,`100%`),W(r,`height`,`${t/s}px`),W(r,`margin`,`auto 0`)),i.dataset.aspectRatio=a}n.show=`${t.get(`Aspect Ratio`)}: ${a==="default"?t.get(`Default`):a}`,e.emit(`aspectRatio`,a)}})}function Cn(e){let{template:{$video:t}}=e;E(e,`attr`,{value(e,n){if(n===void 0)return t[e];t[e]=n}})}function wn(e){let{template:{$container:t,$video:n}}=e;E(e,`autoHeight`,{value(){let{clientWidth:r}=t,{videoHeight:i,videoWidth:a}=n,o=r/a*i;W(t,`height`,`${o}px`),e.emit(`autoHeight`,o)}})}function Tn(e){let{$container:t,$player:n,$video:r}=e.template;E(e,`autoSize`,{value(){let{videoWidth:i,videoHeight:a}=r,{width:o,height:s}=Y(t),c=i/a;if(o/s>c){let e=s*c/o*100;W(n,`width`,`${e}%`),W(n,`height`,`100%`)}else{let e=o/c/s*100;W(n,`width`,`100%`),W(n,`height`,`${e}%`)}e.emit(`autoSize`,{width:e.width,height:e.height})}})}function En(e){let{$player:t}=e.template;E(e,`cssVar`,{value(e,n){return n?t.style.setProperty(e,n):getComputedStyle(t).getPropertyValue(e)}})}function Dn(e){let{$video:t}=e.template;E(e,`currentTime`,{get:()=>t.currentTime||0,set:n=>{n=Number.parseFloat(n),!Number.isNaN(n)&&(t.currentTime=Z(n,0,e.duration))}})}function On(e){E(e,`duration`,{get:()=>{let{duration:t}=e.template.$video;return t===1/0?0:t||0}})}function kn(e){let{i18n:t,notice:n,option:r,constructor:i,proxy:a,template:{$player:o,$video:s,$poster:c}}=e,l=0;for(let t=0;t<b.events.length;t++)a(s,b.events[t],t=>{e.emit(`video:${t.type}`,t)});e.on(`video:canplay`,()=>{l=0,e.loading.show=!1}),e.once(`video:canplay`,()=>{e.loading.show=!1,e.controls.show=!0,e.mask.show=!0,e.isReady=!0,e.emit(`ready`)}),e.on(`video:ended`,()=>{r.loop?(e.seek=0,e.play(),e.controls.show=!1,e.mask.show=!1):(e.controls.show=!0,e.mask.show=!0)}),e.on(`video:error`,async a=>{l<i.RECONNECT_TIME_MAX?(await $(i.RECONNECT_SLEEP_TIME),l+=1,e.url=r.url,n.show=`${t.get(`Reconnect`)}: ${l}`,e.emit(`error`,a,l)):(e.mask.show=!0,e.loading.show=!1,e.controls.show=!0,B(o,`art-error`),await $(i.RECONNECT_SLEEP_TIME),n.show=t.get(`Video Load Failed`))}),e.on(`video:loadedmetadata`,()=>{e.emit(`resize`),w&&(e.loading.show=!1,e.controls.show=!0,e.mask.show=!0)}),e.on(`video:loadstart`,()=>{e.loading.show=!0,e.mask.show=!1,e.controls.show=!0}),e.on(`video:pause`,()=>{e.controls.show=!0,e.mask.show=!0}),e.on(`video:play`,()=>{e.mask.show=!1,W(c,`display`,`none`)}),e.on(`video:playing`,()=>{e.mask.show=!1}),e.on(`video:progress`,()=>{e.playing&&(e.loading.show=!1)}),e.on(`video:seeked`,()=>{e.loading.show=!1,e.mask.show=!0}),e.on(`video:seeking`,()=>{e.loading.show=!0,e.mask.show=!1}),e.on(`video:timeupdate`,()=>{e.mask.show=!1}),e.on(`video:waiting`,()=>{e.loading.show=!0,e.mask.show=!1})}function An(e){let{template:{$player:t},i18n:n,notice:r}=e;E(e,`flip`,{get(){return t.dataset.flip||`normal`},set(i){i||(i=`normal`),i===`normal`?delete t.dataset.flip:t.dataset.flip=i,r.show=`${n.get(`Video Flip`)}: ${n.get(Nt(i))}`,e.emit(`flip`,i)}})}function jn(e){let{i18n:t,notice:n,template:{$video:r,$player:i}}=e,a=e=>{F.on(`change`,()=>{e.emit(`fullscreen`,F.isFullscreen),F.isFullscreen?(e.state=`fullscreen`,B(i,`art-fullscreen`)):V(i,`art-fullscreen`),e.emit(`resize`)}),F.on(`error`,t=>{e.emit(`fullscreenError`,t)}),E(e,`fullscreen`,{get(){return F.isFullscreen},async set(e){e?await F.request(i):await F.exit()}})},o=e=>{e.on(`document:webkitfullscreenchange`,()=>{e.emit(`fullscreen`,e.fullscreen),e.emit(`resize`)}),E(e,`fullscreen`,{get(){return document.fullscreenElement===r},set(t){t?(e.state=`fullscreen`,r.webkitEnterFullscreen()):r.webkitExitFullscreen()}})};e.once(`video:loadedmetadata`,()=>{F.isEnabled?a(e):r.webkitSupportsFullscreen?o(e):E(e,`fullscreen`,{get(){return!1},set(){n.show=t.get(`Fullscreen Not Supported`)}}),E(e,`fullscreen`,Lt(e,`fullscreen`))})}function Mn(e){let{constructor:t,template:{$container:n,$player:r}}=e,i=``;E(e,`fullscreenWeb`,{get(){return H(r,`art-fullscreen-web`)},set(a){a?(i=r.style.cssText,t.FULLSCREEN_WEB_IN_BODY&&U(document.body,r),e.state=`fullscreenWeb`,W(r,`width`,`100%`),W(r,`height`,`100%`),B(r,`art-fullscreen-web`),e.emit(`fullscreenWeb`,!0)):(t.FULLSCREEN_WEB_IN_BODY&&U(n,r),i&&(r.style.cssText=i,i=``),V(r,`art-fullscreen-web`),e.emit(`fullscreenWeb`,!1)),e.emit(`resize`)}})}function Nn(e){let{$video:t}=e.template;E(e,`loaded`,{get:()=>e.loadedTime/t.duration}),E(e,`loadedTime`,{get:()=>t.buffered.length?t.buffered.end(t.buffered.length-1):0})}function Pn(e){let{icons:t,proxy:n,storage:r,template:{$player:i,$video:a}}=e,o=!1,s=0,c=0;function l(){let{$mini:t}=e.template;t&&(V(i,`art-mini`),W(t,`display`,`none`),i.prepend(a),e.emit(`mini`,!1))}function u(t,n){e.playing?(W(t,`display`,`none`),W(n,`display`,`flex`)):(W(t,`display`,`flex`),W(n,`display`,`none`))}function d(){let{$mini:i}=e.template;if(i)return U(i,a),W(i,`display`,`flex`);{let i=J(`div`);B(i,`art-mini-popup`),U(document.body,i),e.template.$mini=i,U(i,a);let d=U(i,`<div class="art-mini-close"></div>`);U(d,t.close),n(d,`click`,l);let f=U(i,`<div class="art-mini-state"></div>`),p=U(f,t.play),m=U(f,t.pause);return n(p,`click`,()=>e.play()),n(m,`click`,()=>e.pause()),u(p,m),e.on(`video:playing`,()=>u(p,m)),e.on(`video:pause`,()=>u(p,m)),e.on(`video:timeupdate`,()=>u(p,m)),n(i,`mousedown`,e=>{o=e.button===0,s=e.pageX,c=e.pageY}),e.on(`document:mousemove`,e=>{if(o){B(i,`art-mini-dragging`);let t=e.pageX-s,n=e.pageY-c;W(i,`transform`,`translate(${t}px, ${n}px)`)}}),e.on(`document:mouseup`,()=>{if(o){o=!1,V(i,`art-mini-dragging`);let e=Y(i);r.set(`left`,e.left),r.set(`top`,e.top),W(i,`left`,`${e.left}px`),W(i,`top`,`${e.top}px`),W(i,`transform`,null)}}),i}}function f(){let{$mini:t}=e.template,n=Y(t),i=window.innerHeight-n.height-50,a=window.innerWidth-n.width-50;r.set(`top`,i),r.set(`left`,a),W(t,`top`,`${i}px`),W(t,`left`,`${a}px`)}E(e,`mini`,{get(){return H(i,`art-mini`)},set(t){if(t){e.state=`mini`,B(i,`art-mini`);let t=d(),n=r.get(`top`),a=r.get(`left`);typeof n==`number`&&typeof a==`number`?(W(t,`top`,`${n}px`),W(t,`left`,`${a}px`),wt(t)||f()):f(),e.emit(`mini`,!0)}else l()}})}function Fn(e){let{option:t,storage:n,template:{$video:r,$poster:i}}=e;for(let n in t.moreVideoAttr)e.attr(n,t.moreVideoAttr[n]);t.muted&&(e.muted=t.muted),t.volume&&(r.volume=Z(t.volume,0,1));let a=n.get(`volume`);typeof a==`number`&&(r.volume=Z(a,0,1)),t.poster&&W(i,`backgroundImage`,`url(${t.poster})`),t.autoplay&&(r.autoplay=t.autoplay),t.playsInline&&(r.playsInline=!0,r[`webkit-playsinline`]=!0),t.theme&&(t.cssVar[`--art-theme`]=t.theme);for(let n in t.cssVar)e.cssVar(n,t.cssVar[n]);e.url=t.url}function In(e){let{template:{$video:t},i18n:n,notice:r}=e;E(e,`pause`,{value(){let i=t.pause();return r.show=n.get(`Pause`),e.emit(`pause`),i}})}function Ln(e){let{template:{$video:t},proxy:n,notice:r}=e;t.disablePictureInPicture=!1,E(e,`pip`,{get(){return document.pictureInPictureElement},set(n){n?(e.state=`pip`,t.requestPictureInPicture().catch(e=>{throw r.show=e,e})):document.exitPictureInPicture().catch(e=>{throw r.show=e,e})}}),n(t,`enterpictureinpicture`,()=>{e.emit(`pip`,!0)}),n(t,`leavepictureinpicture`,()=>{e.emit(`pip`,!1)})}function Rn(e){let{$video:t}=e.template;t.webkitSetPresentationMode(`inline`),E(e,`pip`,{get(){return t.webkitPresentationMode===`picture-in-picture`},set(n){n?(e.state=`pip`,t.webkitSetPresentationMode(`picture-in-picture`),e.emit(`pip`,!0)):(t.webkitSetPresentationMode(`inline`),e.emit(`pip`,!1))}})}function zn(e){let{i18n:t,notice:n,template:{$video:r}}=e;document.pictureInPictureEnabled?Ln(e):r.webkitSupportsPresentationMode?Rn(e):E(e,`pip`,{get(){return!1},set(){n.show=t.get(`PIP Not Supported`)}})}function Bn(e){let{template:{$video:t},i18n:n,notice:r}=e;E(e,`playbackRate`,{get(){return t.playbackRate},set(i){if(i){if(i===t.playbackRate)return;t.playbackRate=i,r.show=`${n.get(`Rate`)}: ${i===1?n.get(`Normal`):`${i}x`}`}else e.playbackRate=1}})}function Vn(e){E(e,`played`,{get:()=>e.currentTime/e.duration})}function Hn(e){let{$video:t}=e.template;E(e,`playing`,{get:()=>typeof t.playing==`boolean`?t.playing:t.currentTime>0&&!t.paused&&!t.ended&&t.readyState>2})}function Un(e){let{i18n:t,notice:n,option:r,constructor:{instances:i},template:{$video:a}}=e;E(e,`play`,{async value(){let o=await a.play();if(n.show=t.get(`Play`),e.emit(`play`),r.mutex)for(let t=0;t<i.length;t++){let n=i[t];n!==e&&n.pause()}return o}})}function Wn(e){let{template:{$poster:t}}=e;E(e,`poster`,{get:()=>{try{return t.style.backgroundImage.match(/"(.*)"/)[1]}catch{return``}},set(e){W(t,`backgroundImage`,`url(${e})`)}})}function Gn(e){E(e,`quality`,{set(t){let{controls:n,notice:r,i18n:i}=e,a=t.find(e=>e.default)||t[0];n.update({name:`quality`,position:`right`,index:10,style:{marginRight:`10px`},html:a?.html||``,selector:t,async onSelect(t){return await e.switchQuality(t.url),r.show=`${i.get(`Switch Video`)}: ${t.html}`,t.html}})}})}function Kn(e){E(e,`rect`,{get:()=>Y(e.template.$player)});let t=[`bottom`,`height`,`left`,`right`,`top`,`width`];for(let n=0;n<t.length;n++){let r=t[n];E(e,r,{get:()=>e.rect[r]})}E(e,`x`,{get:()=>e.left+window.pageXOffset}),E(e,`y`,{get:()=>e.top+window.pageYOffset})}function qn(e){let{notice:t,template:{$video:n}}=e,r=J(`canvas`);E(e,`getDataURL`,{value:()=>new Promise((e,i)=>{try{r.width=n.videoWidth,r.height=n.videoHeight,r.getContext(`2d`).drawImage(n,0,0),e(r.toDataURL(`image/png`))}catch(e){t.show=e,i(e)}})}),E(e,`getBlobUrl`,{value:()=>new Promise((e,i)=>{try{r.width=n.videoWidth,r.height=n.videoHeight,r.getContext(`2d`).drawImage(n,0,0),r.toBlob(t=>{e(URL.createObjectURL(t))})}catch(e){t.show=e,i(e)}})}),E(e,`screenshot`,{value:async t=>{let r=await e.getDataURL();return Mt(r,`${t||`artplayer_${Q(n.currentTime)}`}.png`),e.emit(`screenshot`,r),r}})}function Jn(e){let{notice:t}=e;E(e,`seek`,{set(n){e.currentTime=n,e.duration&&(t.show=`${Q(e.currentTime)} / ${Q(e.duration)}`),e.emit(`seek`,e.currentTime,n)}}),E(e,`forward`,{set(t){e.seek=e.currentTime+t}}),E(e,`backward`,{set(t){e.seek=e.currentTime-t}})}function Yn(e){let t=[`mini`,`pip`,`fullscreen`,`fullscreenWeb`];E(e,`state`,{get:()=>t.find(t=>e[t])||`standard`,set(n){for(let r=0;r<t.length;r++){let i=t[r];i!==n&&e[i]&&(e[i]=!1)}}})}function Xn(e){let{notice:t,i18n:n,template:r}=e;E(e,`subtitleOffset`,{get(){return r.$track?.offset||0},set(i){let{cues:a}=e.subtitle;if(!r.$track||a.length===0)return;let o=Z(i,-10,10);r.$track.offset=o;for(let t=0;t<a.length;t++){let n=a[t];n.originalStartTime=n.originalStartTime??n.startTime,n.originalEndTime=n.originalEndTime??n.endTime,n.startTime=Z(n.originalStartTime+o,0,e.duration),n.endTime=Z(n.originalEndTime+o,0,e.duration)}e.subtitle.update(),t.show=`${n.get(`Subtitle Offset`)}: ${i}s`,e.emit(`subtitleOffset`,i)}})}function Zn(e){function t(t,n){return new Promise((r,i)=>{if(t===e.url){r();return}let{playing:a,aspectRatio:o,playbackRate:s}=e;e.pause(),e.url=t,e.notice.show=``;let c={};c.error=t=>{e.off(`video:canplay`,c.canplay),e.off(`video:loadedmetadata`,c.metadata),i(t)},c.metadata=()=>{e.currentTime=n},c.canplay=async()=>{e.off(`video:error`,c.error),e.playbackRate=s,e.aspectRatio=o,a&&await e.play(),e.notice.show=``,r()},e.once(`video:error`,c.error),e.once(`video:loadedmetadata`,c.metadata),e.once(`video:canplay`,c.canplay)})}E(e,`switchQuality`,{value:n=>t(n,e.currentTime)}),E(e,`switchUrl`,{value:e=>t(e,0)}),E(e,`switch`,{set:e.switchUrl})}function Qn(e){E(e,`theme`,{get(){return e.cssVar(`--art-theme`)},set(t){e.cssVar(`--art-theme`,t)}})}function $n(e){let{option:t,template:{$progress:n,$video:r}}=e,i=null,a=!1,o=null;function s(){clearTimeout(i),i=null,a=!1,o=null}function c(i){let a=e.controls?.thumbnails;if(!a)return;let{number:s,column:c,width:l,height:u,scale:d}=t.thumbnails,f=l*d||o.naturalWidth/c,p=u*d||f/(r.videoWidth/r.videoHeight),m=n.clientWidth/s,h=Math.floor(i/m),g=Math.ceil(h/c)-1,ee=h%c||c-1;W(a,`backgroundImage`,`url(${o.src})`),W(a,`height`,`${p}px`),W(a,`width`,`${f}px`),W(a,`backgroundPosition`,`-${ee*f}px -${g*p}px`),i<=f/2?W(a,`left`,0):i>n.clientWidth-f/2?W(a,`left`,`${n.clientWidth-f}px`):W(a,`left`,`${i-f/2}px`)}e.on(`setBar`,async(r,i,s)=>{let l=e.controls?.thumbnails,{url:u,scale:d}=t.thumbnails;if(!(!l||!u)&&(r===`hover`||r===`played`&&s&&w)){if(!o&&!a&&(a=!0,o=await kt(u,d),a=!1),!o)return;let e=n.clientWidth*i;e>0&&e<n.clientWidth&&c(e)}}),E(e,`thumbnails`,{get(){return e.option.thumbnails},set(t){t.url&&!e.option.isLive&&(e.option.thumbnails=t,s())}})}function er(e){E(e,`toggle`,{value(){return e.playing?e.pause():e.play()}})}function tr(e){E(e,`type`,{get(){return e.option.type},set(t){e.option.type=t}})}function nr(e){let{option:t,template:{$video:n}}=e;E(e,`url`,{get(){return n.src},async set(r){if(r){let i=e.url,a=t.type||jt(r),o=t.customType[a];a&&o?(await $(),e.loading.show=!0,o.call(e,n,r,e)):(URL.revokeObjectURL(i),n.src=r),i!==e.url&&(e.option.url=r,e.isReady&&i&&e.once(`video:canplay`,()=>{e.emit(`restart`,r)}))}else await $(),e.loading.show=!0}})}function rr(e){let{template:{$video:t},i18n:n,notice:r,storage:i}=e;E(e,`volume`,{get:()=>t.volume||0,set:e=>{t.volume=Z(e,0,1),r.show=`${n.get(`Volume`)}: ${Number.parseInt(t.volume*100,10)}`,t.volume!==0&&i.set(`volume`,t.volume)}}),E(e,`muted`,{get:()=>t.muted,set:n=>{t.muted=n,e.emit(`muted`,n)}})}function ir(e){let{notice:t,constructor:n,template:{$player:r,$video:i}}=e,a=`art-auto-orientation`,o=`art-auto-orientation-fullscreen`,s=!1;function c(){let t=document.documentElement.clientWidth,n=document.documentElement.clientHeight;W(r,`width`,`${n}px`),W(r,`height`,`${t}px`),W(r,`transform-origin`,`0 0`),W(r,`transform`,`rotate(90deg) translate(0, -${t}px)`),B(r,a),e.isRotate=!0,e.emit(`resize`)}function l(){W(r,`width`,``),W(r,`height`,``),W(r,`transform-origin`,``),W(r,`transform`,``),V(r,a),e.isRotate=!1,e.emit(`resize`)}function u(){let{videoWidth:e,videoHeight:t}=i,n=document.documentElement.clientWidth,r=document.documentElement.clientHeight;return e>t&&n<r||e<t&&n>r}return e.on(`fullscreenWeb`,t=>{if(t){if(u()){let t=Number(n.AUTO_ORIENTATION_TIME??0);setTimeout(()=>{e.fullscreenWeb&&!H(r,a)&&c()},t)}}else H(r,a)&&l()}),e.on(`fullscreen`,async e=>{let n=!!screen?.orientation?.lock;if(e){if(n&&u())try{let e=screen.orientation.type.startsWith(`portrait`)?`landscape`:`portrait`;await screen.orientation.lock(e),s=!0,B(r,o)}catch(e){s=!1,t.show=e}}else if(H(r,o)&&V(r,o),n&&s){try{screen.orientation.unlock()}catch{}s=!1}}),{name:`autoOrientation`,get state(){return H(r,a)}}}function ar(e){let{i18n:t,icons:n,storage:r,constructor:i,proxy:a,template:{$poster:o}}=e,s=e.layers.add({name:`auto-playback`,html:`
            <div class="art-auto-playback-close"></div>
            <div class="art-auto-playback-last"></div>
            <div class="art-auto-playback-jump"></div>
        `}),c=R(`.art-auto-playback-last`,s),l=R(`.art-auto-playback-jump`,s),u=R(`.art-auto-playback-close`,s);U(u,n.close);let d=null;e.on(`video:timeupdate`,()=>{if(e.playing){let t=r.get(`times`)||{},n=Object.keys(t);n.length>i.AUTO_PLAYBACK_MAX&&delete t[n[0]],t[e.option.id||e.option.url]=e.currentTime,r.set(`times`,t)}});function f(){let n=(r.get(`times`)||{})[e.option.id||e.option.url];clearTimeout(d),W(s,`display`,`none`),n&&n>=i.AUTO_PLAYBACK_MIN&&(W(s,`display`,`flex`),c.textContent=`${t.get(`Last Seen`)} ${Q(n)}`,l.textContent=t.get(`Jump Play`),a(u,`click`,()=>{W(s,`display`,`none`)}),a(l,`click`,()=>{e.seek=n,e.play(),W(o,`display`,`none`),W(s,`display`,`none`)}),e.once(`video:timeupdate`,()=>{d=setTimeout(()=>{W(s,`display`,`none`)},i.AUTO_PLAYBACK_TIMEOUT)}))}return e.on(`ready`,f),e.on(`restart`,f),{name:`auto-playback`,get times(){return r.get(`times`)||{}},clear(){return r.del(`times`)},delete(e){let t=r.get(`times`)||{};return delete t[e],r.set(`times`,t),t}}}function or(e){let{constructor:t,proxy:n,template:{$player:r,$video:i}}=e,a=null,o=!1,s=1,c=n=>{n.touches.length===1&&e.playing&&!e.isLock&&(a=setTimeout(()=>{o=!0,s=e.playbackRate,e.playbackRate=t.FAST_FORWARD_VALUE,B(r,`art-fast-forward`)},t.FAST_FORWARD_TIME))},l=()=>{clearTimeout(a),o&&(o=!1,e.playbackRate=s,V(r,`art-fast-forward`))};return n(i,`touchstart`,c),e.on(`document:touchmove`,l),e.on(`document:touchend`,l),{name:`fastForward`,get state(){return H(r,`art-fast-forward`)}}}function sr(e){let{layers:t,icons:n,template:{$player:r}}=e;function i(){return H(r,`art-lock`)}function a(){B(r,`art-lock`),e.isLock=!0,e.emit(`lock`,!0)}function o(){V(r,`art-lock`),e.isLock=!1,e.emit(`lock`,!1)}return t.add({name:`lock`,mounted(t){let r=U(t,n.lock),i=U(t,n.unlock);W(r,`display`,`none`),e.on(`lock`,e=>{e?(W(r,`display`,`inline-flex`),W(i,`display`,`none`)):(W(r,`display`,`none`),W(i,`display`,`inline-flex`))})},click(){i()?o():a()}}),{name:`lock`,get state(){return i()},set state(e){e?a():o()}}}function cr(e){return e.on(`control`,t=>{t?V(e.template.$player,`art-mini-progress-bar`):B(e.template.$player,`art-mini-progress-bar`)}),{name:`mini-progress-bar`}}function lr(e){let{i18n:t,icons:n,constructor:{SETTING_ITEM_WIDTH:r,ASPECT_RATIO:i}}=e;function a(e){return e==="default"?t.get(`Default`):e}function o(){let t=e.setting.find(`aspect-ratio-${e.aspectRatio}`);e.setting.check(t)}return{width:r,name:`aspect-ratio`,html:t.get(`Aspect Ratio`),icon:n.aspectRatio,tooltip:a(e.aspectRatio),selector:i.map(t=>({value:t,name:`aspect-ratio-${t}`,default:t===e.aspectRatio,html:a(t)})),onSelect(t){return e.aspectRatio=t.value,t.html},mounted:()=>{o(),e.on(`aspectRatio`,()=>o())}}}function ur(e){let{i18n:t,icons:n,constructor:{SETTING_ITEM_WIDTH:r,FLIP:i}}=e;function a(e){return t.get(Nt(e))}function o(){let t=e.setting.find(`flip-${e.flip}`);e.setting.check(t)}return{width:r,name:`flip`,html:t.get(`Video Flip`),tooltip:a(e.flip),icon:n.flip,selector:i.map(t=>({value:t,name:`flip-${t}`,default:t===e.flip,html:a(t)})),onSelect(t){return e.flip=t.value,t.html},mounted:()=>{o(),e.on(`flip`,()=>o())}}}function dr(e){let{i18n:t,icons:n,constructor:{SETTING_ITEM_WIDTH:r,PLAYBACK_RATE:i}}=e;function a(e){return e===1?t.get(`Normal`):e.toFixed(1)}function o(){let t=e.setting.find(`playback-rate-${e.playbackRate}`);e.setting.check(t)}return{width:r,name:`playback-rate`,html:t.get(`Play Speed`),tooltip:a(e.playbackRate),icon:n.playbackRate,selector:i.map(t=>({value:t,name:`playback-rate-${t}`,default:t===e.playbackRate,html:a(t)})),onSelect(t){return e.playbackRate=t.value,t.html},mounted:()=>{o(),e.on(`video:ratechange`,()=>o())}}}function fr(e){let{i18n:t,icons:n,constructor:r}=e;return{width:r.SETTING_ITEM_WIDTH,name:`subtitle-offset`,html:t.get(`Subtitle Offset`),icon:n.subtitle,tooltip:`0s`,range:[0,-10,10,.1],onChange(t){return e.subtitleOffset=t.range[0],`${t.range[0]}s`},mounted:(t,n)=>{e.on(`subtitleOffset`,e=>{n.$range.value=e,n.tooltip=`${e}s`})}}}return{setters:[function(e){n=e.$i,r=e.C,i=e.Gi,a=e.Hr,o=e.Ji,s=e.Kt,c=e.Pi,l=e.Qn,u=e.Qr,d=e.Sn,f=e.V,p=e.Vn,m=e.X,h=e.Xn,g=e.Xr,ee=e.Y,te=e.Z,ne=e.Zn,re=e.at,ie=e.ht,ae=e.l,oe=e.qn,se=e.ra,ce=e.sa,le=e.tt,ue=e.un},function(e){de=e.a,fe=e.u}],execute:function(){_={exports:{}},pe=_.exports,v=vt(yt()),y=`5.4.0`,b={properties:`audioTracks.autoplay.buffered.controller.controls.crossOrigin.currentSrc.currentTime.defaultMuted.defaultPlaybackRate.duration.ended.error.loop.mediaGroup.muted.networkState.paused.playbackRate.played.preload.readyState.seekable.seeking.src.startDate.textTracks.videoTracks.volume`.split(`.`),methods:[`addTextTrack`,`canPlayType`,`load`,`play`,`pause`],events:[`abort`,`canplay`,`canplaythrough`,`durationchange`,`emptied`,`ended`,`error`,`loadeddata`,`loadedmetadata`,`loadstart`,`pause`,`play`,`playing`,`progress`,`ratechange`,`seeked`,`seeking`,`stalled`,`suspend`,`timeupdate`,`volumechange`,`waiting`],prototypes:[`width`,`height`,`videoWidth`,`videoHeight`,`poster`,`webkitDecodedFrameCount`,`webkitDroppedFrameCount`,`playsInline`,`webkitSupportsFullscreen`,`webkitDisplayingFullscreen`,`onenterpictureinpicture`,`onleavepictureinpicture`,`disablePictureInPicture`,`cancelVideoFrameCallback`,`requestVideoFrameCallback`,`getVideoPlaybackQuality`,`requestPictureInPicture`,`webkitEnterFullScreen`,`webkitEnterFullscreen`,`webkitExitFullScreen`,`webkitExitFullscreen`]},x=globalThis?.CUSTOM_USER_AGENT??(typeof navigator<`u`?navigator.userAgent:``),S=/^(?:(?!chrome|android).)*safari/i.test(x),C=/iPad|iPhone|iPod/i.test(x)&&!window.MSStream,he=C||x.includes(`Macintosh`)&&navigator.maxTouchPoints>=1,w=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(x)||he,T=typeof window<`u`&&typeof document<`u`,ge=class extends Error{constructor(e,t){super(e),typeof Error.captureStackTrace==`function`&&Error.captureStackTrace(this,t||this.constructor),this.name=`ArtPlayerError`}},E=Object.defineProperty,{hasOwnProperty:_e}=Object.prototype,ve=Object.freeze(Object.defineProperty({__proto__:null,ArtPlayerError:ge,addClass:B,append:U,assToVtt:Ht,capitalize:Nt,clamp:Z,createElement:J,debounce:Ut,def:E,download:Mt,errorHandle:X,escape:Pt,get:Lt,getComposedPath:At,getExt:jt,getIcon:Et,getRect:Y,getStyle:St,has:It,hasClass:H,includeFromEvent:q,inverseClass:G,isBrowser:T,isIOS:C,isIOS13:he,isInViewport:wt,isMobile:w,isSafari:S,loadImg:kt,mergeDeep:Rt,query:R,queryAll:z,remove:bt,removeClass:V,replaceElement:Tt,secondToTime:Q,setStyle:W,setStyleText:Dt,setStyles:xt,siblings:Ct,sleep:$,srtToVtt:Bt,supportsFlex:Ot,throttle:Wt,tooltip:K,unescape:Ft,userAgent:x,vttToBlob:Vt},Symbol.toStringTag,{value:`Module`})),ye=`array`,D=`boolean`,O=`string`,k=`number`,A=`object`,j=`function`,M={html:Gt,disable:`?${D}`,name:`?${O}`,index:`?${k}`,style:`?${A}`,click:`?${j}`,mounted:`?${j}`,tooltip:`?${O}|${k}`,width:`?${k}`,selector:`?${ye}`,onSelect:`?${j}`,switch:`?${D}`,onSwitch:`?${j}`,range:`?${ye}`,onRange:`?${j}`,onChange:`?${j}`},be={id:O,container:Gt,url:O,poster:O,type:O,theme:O,lang:O,volume:k,isLive:D,muted:D,autoplay:D,autoSize:D,autoMini:D,loop:D,flip:D,playbackRate:D,aspectRatio:D,screenshot:D,setting:D,hotkey:D,pip:D,mutex:D,backdrop:D,fullscreen:D,fullscreenWeb:D,subtitleOffset:D,miniProgressBar:D,useSSR:D,playsInline:D,lock:D,gesture:D,fastForward:D,autoPlayback:D,autoOrientation:D,airplay:D,proxy:`?${j}`,plugins:[j],layers:[M],contextmenu:[M],settings:[M],controls:[{...M,position:(e,t,n)=>{let r=[`top`,`left`,`right`];return X(r.includes(e),`${n.join(`.`)} only accept ${r.toString()} as parameters`)}}],quality:[{default:`?${D}`,html:O,url:O}],highlight:[{time:k,text:O}],thumbnails:{url:O,number:k,column:k,width:k,height:k,scale:k},subtitle:{url:O,name:O,type:O,style:A,escape:D,encoding:O,onVttLoad:j},moreVideoAttr:A,i18n:A,icons:A,cssVar:A,customType:A},N=class{constructor(e){this.id=0,this.art=e,this.cache=new Map,this.add=this.add.bind(this),this.remove=this.remove.bind(this),this.update=this.update.bind(this)}get show(){return H(this.art.template.$player,`art-${this.name}-show`)}set show(e){let{$player:t}=this.art.template,n=`art-${this.name}-show`;e?B(t,n):V(t,n),this.art.emit(this.name,e)}toggle(){this.show=!this.show}add(e){let t=typeof e==`function`?e(this.art):e;if(t.html=t.html||``,v(t,M),!this.$parent||!this.name||t.disable)return;let n=t.name||`${this.name}${this.id}`;X(!this.cache.has(n),`Can't add an existing [${n}] to the [${this.name}]`),this.id+=1;let r=J(`div`);B(r,`art-${this.name}`),B(r,`art-${this.name}-${n}`);let i=Array.from(this.$parent.children);r.dataset.index=t.index||this.id;let a=i.find(e=>Number(e.dataset.index)>=Number(r.dataset.index));a?a.insertAdjacentElement(`beforebegin`,r):U(this.$parent,r),t.html&&U(r,t.html),t.style&&xt(r,t.style),t.tooltip&&K(r,t.tooltip);let o=[];if(t.click){let e=this.art.events.proxy(r,`click`,e=>{e.preventDefault(),t.click.call(this.art,this,e)});o.push(e)}return t.selector&&[`left`,`right`].includes(t.position)&&this.selector(t,r,o),this[n]=r,this.cache.set(n,{$ref:r,events:o,option:t}),t.mounted&&t.mounted.call(this.art,r),r}remove(e){X(this.cache.has(e),`Can't find [${e}] from the [${this.name}]`);let t=this.cache.get(e);t.option.beforeUnmount&&t.option.beforeUnmount.call(this.art,t.$ref);for(let e of t.events)this.art.events.remove(e);this.cache.delete(e),delete this[e],bt(t.$ref)}update(e){if(this.cache.has(e.name)){let t=this.cache.get(e.name);e=Object.assign(t.option,e),this.remove(e.name)}return this.add(e)}},xe=class extends N{constructor(e){super(e),this.name=`contextmenu`,this.$parent=e.template.$contextmenu,w||this.init()}init(){let{option:e,proxy:t,template:{$player:n,$contextmenu:r}}=this.art;e.playbackRate&&this.add(Xt({name:`playbackRate`,index:10})),e.aspectRatio&&this.add(Kt({name:`aspectRatio`,index:20})),e.flip&&this.add(Jt({name:`flip`,index:30})),this.add(Yt({name:`info`,index:40})),this.add(Zt({name:`version`,index:50})),this.add(qt({name:`close`,index:60}));for(let t=0;t<e.contextmenu.length;t++)this.add(e.contextmenu[t]);t(n,`contextmenu`,e=>{if(!this.art.constructor.CONTEXTMENU)return;e.preventDefault(),this.show=!0;let t=e.clientX,i=e.clientY,{height:a,width:o,left:s,top:c}=Y(n),{height:l,width:u}=Y(r),d=t-s,f=i-c;t+u>s+o&&(d=o-u),i+l>c+a&&(f=a-l),xt(r,{top:`${f}px`,left:`${d}px`})}),t(n,`click`,e=>{q(e,r)||(this.show=!1)}),this.art.on(`blur`,()=>{this.show=!1})}},Se=class extends N{constructor(e){super(e),this.isHover=!1,this.name=`control`,this.timer=Date.now();let{constructor:t}=e,{$player:n,$bottom:r}=this.art.template;e.on(`mousemove`,()=>{w||(this.show=!0)}),e.on(`click`,()=>{w?this.toggle():this.show=!0}),e.on(`document:mousemove`,e=>{this.isHover=q(e,r)}),e.on(`video:timeupdate`,()=>{!e.setting.show&&!this.isHover&&!e.isInput&&e.playing&&this.show&&Date.now()-this.timer>=t.CONTROL_HIDE_TIME&&(this.show=!1)}),e.on(`control`,e=>{e?(V(n,`art-hide-cursor`),B(n,`art-hover`),this.timer=Date.now()):(B(n,`art-hide-cursor`),V(n,`art-hover`))}),this.init()}init(){let{option:e}=this.art;e.isLive||this.add(on({name:`progress`,position:`top`,index:10})),this.add({name:`thumbnails`,position:`top`,index:20}),this.add(nn({name:`playAndPause`,position:`left`,index:10})),this.add(un({name:`volume`,position:`left`,index:20})),e.isLive||this.add(ln({name:`time`,position:`left`,index:30})),e.quality.length&&$().then(()=>{this.art.quality=e.quality}),e.screenshot&&!w&&this.add(sn({name:`screenshot`,position:`right`,index:20})),e.setting&&this.add(cn({name:`setting`,position:`right`,index:30})),e.pip&&this.add(tn({name:`pip`,position:`right`,index:40})),e.airplay&&window.WebKitPlaybackTargetAvailabilityEvent&&this.add(Qt({name:`airplay`,position:`right`,index:50})),e.fullscreenWeb&&this.add(en({name:`fullscreenWeb`,position:`right`,index:60})),e.fullscreen&&this.add($t({name:`fullscreen`,position:`right`,index:70}));for(let t=0;t<e.controls.length;t++)this.add(e.controls[t])}add(e){let t=typeof e==`function`?e(this.art):e,{$progress:n,$controlsLeft:r,$controlsRight:i}=this.art.template;switch(t.position){case`top`:this.$parent=n;break;case`left`:this.$parent=r;break;case`right`:this.$parent=i;break;default:X(!1,`Control option.position must one of 'top', 'left', 'right'`)}super.add(t)}check(e){if(e){e.$control_value.innerHTML=e.html;for(let t=0;t<e.$control_option.length;t++){let n=e.$control_option[t];n.default=n===e,n.default&&G(n.$control_item,`art-current`)}}}selector(e,t,n){let{proxy:r}=this.art.events;B(t,`art-control-selector`);let i=J(`div`);B(i,`art-selector-value`),U(i,e.html),t.textContent=``,U(t,i);let a=J(`div`);B(a,`art-selector-list`),U(t,a);for(let t=0;t<e.selector.length;t++){let n=e.selector[t],r=J(`div`);B(r,`art-selector-item`),n.default&&B(r,`art-current`),r.dataset.index=t,r.dataset.value=n.value,r.innerHTML=n.html,U(a,r),E(n,`$control_option`,{get:()=>e.selector}),E(n,`$control_item`,{get:()=>r}),E(n,`$control_value`,{get:()=>i})}let o=r(a,`click`,async t=>{let n=At(t),r=e.selector.find(e=>e.$control_item===n.find(t=>e.$control_item===t));this.check(r),e.onSelect&&(i.innerHTML=await e.onSelect.call(this.art,r,r.$control_item,t))});n.push(o)}},Ce=class{constructor(e){this.destroyEvents=new Set,this.proxy=this.proxy.bind(this),this.hover=this.hover.bind(this),dn(e,this),gn(e,this),_n(e,this),vn(e,this),mn(e,this),bn(e),hn(e,this),yn(e)}proxy(e,t,n,r={}){if(Array.isArray(t))return t.map(t=>this.proxy(e,t,n,r));e.addEventListener(t,n,r);let i=()=>e.removeEventListener(t,n,r);return this.destroyEvents.add(i),i}hover(e,t,n){t&&this.proxy(e,`mouseenter`,t),n&&this.proxy(e,`mouseleave`,n)}remove(e){if(this.destroyEvents.has(e))try{e()}catch(e){console.warn(`Failed to remove event listener:`,e)}finally{this.destroyEvents.delete(e)}}destroy(){for(let e of this.destroyEvents)try{e()}catch(e){console.warn(`Failed to destroy event listener:`,e)}this.destroyEvents.clear()}},we=class{constructor(e){this.art=e,this.keys={},w||this.init()}init(){let{constructor:e}=this.art;this.art.option.hotkey&&(this.add(`Escape`,()=>{this.art.fullscreenWeb&&(this.art.fullscreenWeb=!1)}),this.add(`Space`,()=>{this.art.toggle()}),this.add(`ArrowLeft`,()=>{this.art.backward=e.SEEK_STEP}),this.add(`ArrowUp`,()=>{this.art.volume+=e.VOLUME_STEP}),this.add(`ArrowRight`,()=>{this.art.forward=e.SEEK_STEP}),this.add(`ArrowDown`,()=>{this.art.volume-=e.VOLUME_STEP})),this.art.on(`document:keydown`,e=>{if(this.art.isFocus){let t=document.activeElement.tagName.toUpperCase(),n=document.activeElement.getAttribute(`contenteditable`);if(t!==`INPUT`&&t!==`TEXTAREA`&&n!==``&&n!==`true`&&!e.altKey&&!e.ctrlKey&&!e.metaKey&&!e.shiftKey){let t=this.keys[e.code];if(t){e.preventDefault();for(let n=0;n<t.length;n++)t[n].call(this.art,e);this.art.emit(`hotkey`,e)}}}this.art.emit(`keydown`,e)})}add(e,t){return this.keys[e]?this.keys[e].includes(t)||this.keys[e].push(t):this.keys[e]=[t],this}remove(e,t){if(this.keys[e]){let n=this.keys[e].indexOf(t);n!==-1&&this.keys[e].splice(n,1),this.keys[e].length===0&&delete this.keys[e]}return this}},Te={"Video Info":`统计信息`,Close:`关闭`,"Video Load Failed":`加载失败`,Volume:`音量`,Play:`播放`,Pause:`暂停`,Rate:`速度`,Mute:`静音`,"Video Flip":`画面翻转`,Horizontal:`水平`,Vertical:`垂直`,Reconnect:`重新连接`,"Show Setting":`显示设置`,"Hide Setting":`隐藏设置`,Screenshot:`截图`,"Play Speed":`播放速度`,"Aspect Ratio":`画面比例`,Default:`默认`,Normal:`正常`,Open:`打开`,"Switch Video":`切换`,"Switch Subtitle":`切换字幕`,Fullscreen:`全屏`,"Exit Fullscreen":`退出全屏`,"Web Fullscreen":`网页全屏`,"Exit Web Fullscreen":`退出网页全屏`,"Mini Player":`迷你播放器`,"PIP Mode":`开启画中画`,"Exit PIP Mode":`退出画中画`,"PIP Not Supported":`不支持画中画`,"Fullscreen Not Supported":`不支持全屏`,"Subtitle Offset":`字幕偏移`,"Last Seen":`上次看到`,"Jump Play":`跳转播放`,AirPlay:`隔空播放`,"AirPlay Not Available":`隔空播放不可用`},typeof window<`u`&&(window[`artplayer-i18n-zh-cn`]=Te),Ee=class{constructor(e){this.art=e,this.languages={"zh-cn":Te},this.language={},this.update(e.option.i18n)}init(){let e=this.art.option.lang.toLowerCase();this.language=this.languages[e]||{}}get(e){return this.language[e]||e}update(e){this.languages=Rt(this.languages,e),this.init()}},De=`<svg width="18px" height="18px" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
    <g>
...
</svg>`,Ne=`<svg height="24" viewBox="0 0 24 24" width="24"><path d="M15,17h6v1h-6V17z M11,17H3v1h8v2h1v-2v-1v-2h-1V17z M14,8h1V6V5V3h-1v2H3v1h11V8z            M18,5v1h3V5H18z M6,14h1v-2v-1V9H6v2H3v1 h3V14z M10,12h11v-1H10V12z" data-darkreader-inline-fill="" style="--darkreader-inline-fill:#a8a6a4;"></path></svg>`,Pe=`<?xml version="1.0" standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
...
</svg>`,Fe=`<?xml version="1.0" standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
...
</svg>`,Ve=`<?xml version="1.0" standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
...
`,He=`<svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" viewBox="0 0 22 22">
...
</svg>`,We=`<svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" viewBox="0 0 22 22">
...
`,qe=`<svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" viewBox="0 0 22 22">
...
`,Xe=`<?xml version="1.0" standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
...
</svg>`,Ze=`<?xml version="1.0" standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
...
</svg>`,$e=`<svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" viewBox="0 0 22 22">
    <path d="M10.188 4.65L6 8H5a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h1l4.188 3.35a.5.5 0 0 0 .812-.39V5.04a.498.498 0 0 0-.812-.39zM14.446 3.778a1 1 0 0 0-.862 1.804 6.002 6.002 0 0 1-.007 10.838 1 1 0 0 0 .86 1.806A8.001 8.001 0 0 0 19 11a8.001 8.001 0 0 0-4.554-7.222z"></path>
    <path d="M15 11a3.998 3.998 0 0 0-2-3.465v6.93A3.998 3.998 0 0 0 15 11z"></path>
</svg>`,et=class{constructor(e){let t={loading:Be,state:Je,play:We,pause:He,check:je,volume:$e,volumeClose:Qe,screenshot:Ke,setting:qe,pip:Ue,arrowLeft:Oe,arrowRight:ke,playbackRate:Ge,aspectRatio:Ae,config:Ne,lock:Ve,flip:Fe,unlock:Ze,fullscreenOff:Ie,fullscreenOn:Le,fullscreenWebOff:Re,fullscreenWebOn:ze,switchOn:Xe,switchOff:Ye,error:Pe,close:Me,airplay:De,...e.option.icons};for(let e in t)E(this,e,{get:()=>Et(e,t[e])})}},tt=class extends N{constructor(e){super(e),this.name=`info`,w||this.init()}init(){let{proxy:e,constructor:t,template:{$infoPanel:n,$infoClose:r,$video:i}}=this.art;e(r,`click`,()=>{this.show=!1});let a=null,o=z(`[data-video]`,n)||[];this.art.on(`destroy`,()=>clearTimeout(a));function s(){for(let e=0;e<o.length;e++){let t=o[e],n=i[t.dataset.video],r=typeof n==`number`?n.toFixed(2):n;t.textContent!==r&&(t.textContent=r)}a=setTimeout(s,t.INFO_LOOP_TIME)}s()}},nt=class extends N{constructor(e){super(e);let{option:t,template:{$layer:n}}=e;this.name=`layer`,this.$parent=n;for(let e=0;e<t.layers.length;e++)this.add(t.layers[e])}},rt=class extends N{constructor(e){super(e),this.name=`loading`,U(e.template.$loading,e.icons.loading)}},it=class extends N{constructor(e){super(e),this.name=`mask`;let{template:t,icons:n,events:r}=e,i=U(t.$state,n.state),a=U(t.$state,n.error);W(a,`display`,`none`),e.on(`destroy`,()=>{W(i,`display`,`none`),W(a,`display`,null)}),r.proxy(t.$state,`click`,()=>e.play())}},at=class{constructor(e){this.art=e,this.timer=null,e.on(`destroy`,()=>this.destroy())}destroy(){this.timer&&(clearTimeout(this.timer),this.timer=null)}set show(e){let{constructor:t,template:{$player:n,$noticeInner:r}}=this.art;e?(r.textContent=e instanceof Error?e.message.trim():e,B(n,`art-notice-show`),clearTimeout(this.timer),this.timer=setTimeout(()=>{r.textContent=``,V(n,`art-notice-show`)},t.NOTICE_TIME)):V(n,`art-notice-show`)}get show(){let{template:{$player:e}}=this.art;return e.classList.contains(`art-notice-show`)}},ot=[[`requestFullscreen`,`exitFullscreen`,`fullscreenElement`,`fullscreenEnabled`,`fullscreenchange`,`fullscreenerror`],[`webkitRequestFullscreen`,`webkitExitFullscreen`,`webkitFullscreenElement`,`webkitFullscreenEnabled`,`webkitfullscreenchange`,`webkitfullscreenerror`],[`webkitRequestFullScreen`,`webkitCancelFullScreen`,`webkitCurrentFullScreenElement`,`webkitCancelFullScreen`,`webkitfullscreenchange`,`webkitfullscreenerror`],[`mozRequestFullScreen`,`mozCancelFullScreen`,`mozFullScreenElement`,`mozFullScreenEnabled`,`mozfullscreenchange`,`mozfullscreenerror`],[`msRequestFullscreen`,`msExitFullscreen`,`msFullscreenElement`,`msFullscreenEnabled`,`MSFullscreenChange`,`MSFullscreenError`]],P=(()=>{if(typeof document>`u`)return!1;let e=ot[0],t={};for(let n of ot)if(n[1]in document){for(let[r,i]of n.entries())t[e[r]]=i;return t}return!1})(),st={change:P.fullscreenchange,error:P.fullscreenerror},F={request(e=document.documentElement,t){return new Promise((n,r)=>{let i=()=>{F.off(`change`,i),n()};F.on(`change`,i);let a=e[P.requestFullscreen](t);a instanceof Promise&&a.then(i).catch(r)})},exit(){return new Promise((e,t)=>{if(!F.isFullscreen){e();return}let n=()=>{F.off(`change`,n),e()};F.on(`change`,n);let r=document[P.exitFullscreen]();r instanceof Promise&&r.then(n).catch(t)})},toggle(e,t){return F.isFullscreen?F.exit():F.request(e,t)},onchange(e){F.on(`change`,e)},onerror(e){F.on(`error`,e)},on(e,t){let n=st[e];n&&document.addEventListener(n,t,!1)},off(e,t){let n=st[e];n&&document.removeEventListener(n,t,!1)},raw:P},Object.defineProperties(F,{isFullscreen:{get:()=>!!document[P.fullscreenElement]},element:{enumerable:!0,get:()=>document[P.fullscreenElement]},isEnabled:{enumerable:!0,get:()=>!!document[P.fullscreenEnabled]}}),ct=class{constructor(e){nr(e),Cn(e),Un(e),In(e),er(e),Jn(e),rr(e),Dn(e),On(e),Zn(e),Bn(e),Sn(e),qn(e),jn(e),Mn(e),zn(e),Nn(e),Vn(e),Hn(e),Tn(e),Kn(e),An(e),Pn(e),Wn(e),wn(e),En(e),Qn(e),tr(e),Yn(e),Xn(e),xn(e),Gn(e),$n(e),kn(e),Fn(e)}},lt=class{constructor(e){this.art=e,this.id=0;let{option:t}=e;t.miniProgressBar&&!t.isLive&&this.add(cr),t.lock&&w&&this.add(sr),t.autoPlayback&&!t.isLive&&this.add(ar),t.autoOrientation&&w&&this.add(ir),t.fastForward&&w&&!t.isLive&&this.add(or);for(let e=0;e<t.plugins.length;e++)this.add(t.plugins[e])}add(e){this.id+=1;let t=e.call(this.art,this.art);return t instanceof Promise?t.then(t=>this.next(e,t)):this.next(e,t)}next(e,t){let n=t&&t.name||e.name||`plugin${this.id}`;return X(!It(this,n),`Cannot add a plugin that already has the same name: ${n}`),E(this,n,{value:t}),this}},ut=class extends N{constructor(e){super(e);let{option:t,controls:n,template:{$setting:r}}=e;this.name=`setting`,this.$parent=r,this.id=0,this.active=null,this.cache=new Map,this.option=[...this.builtin,...t.settings],t.setting&&(this.format(),this.render(),e.on(`blur`,()=>{this.show&&(this.show=!1,this.render())}),e.on(`focus`,e=>{let t=q(e,n.setting),r=q(e,this.$parent);this.show&&!t&&!r&&(this.show=!1,this.render())}),e.on(`resize`,()=>this.resize()))}get builtin(){let e=[],{option:t}=this.art;return t.playbackRate&&e.push(dr(this.art)),t.aspectRatio&&e.push(lr(this.art)),t.flip&&e.push(ur(this.art)),t.subtitleOffset&&e.push(fr(this.art)),e}traverse(e,t=this.option){for(let n=0;n<t.length;n++){let r=t[n];e(r),r.selector?.length&&this.traverse(e,r.selector)}}check(e){e&&(e.$parent.tooltip=e.html,this.traverse(t=>{t.default=t===e,t.default&&t.$item&&G(t.$item,`art-current`)},e.$option),this.render(e.$parents))}format(e=this.option,t,n,r=[]){for(let i=0;i<e.length;i++){let a=e[i];if(a?.name?(X(!r.includes(a.name),`The [${a.name}] already exists in [setting]`),r.push(a.name)):a.name=`setting-${this.id++}`,!a.$formatted){E(a,`$parent`,{get:()=>t}),E(a,`$parents`,{get:()=>n}),E(a,`$option`,{get:()=>e});let r=[];E(a,`$events`,{get:()=>r}),E(a,`$formatted`,{get:()=>!0})}this.format(a.selector||[],a,e,r)}this.option=e}find(e=``){let t=null;return this.traverse(n=>{n.name===e&&(t=n)}),t}resize(){let{controls:e,constructor:{SETTING_WIDTH:t,SETTING_ITEM_HEIGHT:n},template:{$player:r,$setting:i}}=this.art;if(e.setting&&this.show){let a=this.active[0]?.$parent?.width||t,{left:o,width:s}=Y(e.setting),{left:c,width:l}=Y(r),u=o-c+s/2-a/2;if(W(i,`height`,`${this.active===this.option?this.active.length*n:(this.active.length+1)*n}px`),W(i,`width`,`${a}px`),this.art.isRotate||w)return;u+a>l?(W(i,`left`,null),W(i,`right`,null)):(W(i,`left`,`${u}px`),W(i,`right`,`auto`))}}inactivate(e){for(let t=0;t<e.$events.length;t++)this.art.events.remove(e.$events[t]);e.$events.length=0}remove(e){let t=this.find(e);X(t,`Can't find [${e}] in the [setting]`);let n=t.$option.indexOf(t);t.$option.splice(n,1),this.inactivate(t),t.$item&&bt(t.$item),this.render()}update(e){let t=this.find(e.name);return t?(this.inactivate(t),Object.assign(t,e),this.format(),this.createItem(t,!0),this.render(),t):this.add(e)}add(e,t=this.option){return t.push(e),this.format(),this.createItem(e),this.render(),e}createHeader(e){if(!this.cache.has(e.$option))return;let t=this.cache.get(e.$option),{proxy:n,icons:{arrowLeft:r},constructor:{SETTING_ITEM_HEIGHT:i}}=this.art,a=J(`div`);W(a,`height`,`${i}px`),B(a,`art-setting-item`),B(a,`art-setting-item-back`);let o=U(a,`<div class="art-setting-item-left"></div>`),s=J(`div`);B(s,`art-setting-item-left-icon`),U(s,r),U(o,s),U(o,e.$parent.html);let c=n(a,`click`,()=>this.render(e.$parents));e.$parent.$events.push(c),U(t,a)}createItem(e,t=!1){if(!this.cache.has(e.$option))return;let n=this.cache.get(e.$option),r=e.$item,i=`selector`;It(e,`switch`)&&(i=`switch`),It(e,`range`)&&(i=`range`),It(e,`onClick`)&&(i=`button`);let{icons:a,proxy:o,constructor:s}=this.art,c=J(`div`);B(c,`art-setting-item`),W(c,`height`,`${s.SETTING_ITEM_HEIGHT}px`),c.dataset.name=e.name||``,c.dataset.value=e.value||``;let l=U(c,`<div class="art-setting-item-left"></div>`),u=U(c,`<div class="art-setting-item-right"></div>`),d=J(`div`);switch(B(d,`art-setting-item-left-icon`),i){case`button`:case`switch`:case`range`:U(d,e.icon||a.config);break;case`selector`:e.selector?.length?U(d,e.icon||a.config):U(d,a.check)}U(l,d),E(e,`$icon`,{configurable:!0,get:()=>d}),E(e,`icon`,{configurable:!0,get(){return d.innerHTML},set(e){d.innerHTML=``,U(d,e)}});let f=J(`div`);B(f,`art-setting-item-left-text`),U(f,e.html||``),U(l,f),E(e,`$html`,{configurable:!0,get:()=>f}),E(e,`html`,{configurable:!0,get(){return f.innerHTML},set(e){f.innerHTML=``,U(f,e)}});let p=J(`div`);switch(B(p,`art-setting-item-right-tooltip`),U(p,e.tooltip||``),U(u,p),E(e,`$tooltip`,{configurable:!0,get:()=>p}),E(e,`tooltip`,{configurable:!0,get(){return p.innerHTML},set(e){p.innerHTML=``,U(p,e)}}),i){case`switch`:{let t=J(`div`);B(t,`art-setting-item-right-icon`);let n=U(t,a.switchOn),r=U(t,a.switchOff);W(e.switch?r:n,`display`,`none`),U(u,t),E(e,`$switch`,{configurable:!0,get:()=>t});let i=e.switch;E(e,`switch`,{configurable:!0,get:()=>i,set(e){i=e,e?(W(r,`display`,`none`),W(n,`display`,null)):(W(r,`display`,null),W(n,`display`,`none`))}});break}case`range`:{let t=J(`div`);B(t,`art-setting-item-right-icon`);let n=U(t,`<input type="range">`);n.value=e.range[0],n.min=e.range[1],n.max=e.range[2],n.step=e.range[3],B(n,`art-setting-range`),U(u,t),E(e,`$range`,{configurable:!0,get:()=>n});let r=[...e.range];E(e,`range`,{configurable:!0,get:()=>r,set(e){r=[...e],n.value=e[0],n.min=e[1],n.max=e[2],n.step=e[3]}})}break;case`selector`:if(e.selector?.length){let e=J(`div`);B(e,`art-setting-item-right-icon`),U(e,a.arrowRight),U(u,e)}}switch(i){case`switch`:if(e.onSwitch){let t=o(c,`click`,async t=>{e.switch=await e.onSwitch.call(this.art,e,c,t)});e.$events.push(t)}break;case`range`:if(e.$range){if(e.onRange){let t=o(e.$range,`change`,async t=>{e.range[0]=e.$range.valueAsNumber,e.tooltip=await e.onRange.call(this.art,e,c,t)});e.$events.push(t)}if(e.onChange){let t=o(e.$range,`input`,async t=>{e.range[0]=e.$range.valueAsNumber,e.tooltip=await e.onChange.call(this.art,e,c,t)});e.$events.push(t)}}break;case`selector`:{let t=o(c,`click`,async t=>{e.selector?.length?this.render(e.selector):(this.check(e),e.$parent.onSelect&&(e.$parent.tooltip=await e.$parent.onSelect.call(this.art,e,c,t)))});e.$events.push(t),e.default&&B(c,`art-current`)}break;case`button`:if(e.onClick){let t=o(c,`click`,async t=>{e.tooltip=await e.onClick.call(this.art,e,c,t)});e.$events.push(t)}}E(e,`$item`,{configurable:!0,get:()=>c}),t?Tt(c,r):U(n,c),e.mounted&&setTimeout(()=>e.mounted.call(this.art,e.$item,e),0)}render(e=this.option){if(this.active=e,this.cache.has(e))G(this.cache.get(e),`art-current`);else{let t=J(`div`);this.cache.set(e,t),B(t,`art-setting-panel`),U(this.$parent,t),G(t,`art-current`),e[0]?.$parent&&this.createHeader(e[0]);for(let t=0;t<e.length;t++)this.createItem(e[t])}this.resize()}},dt=class{constructor(){this.name=`artplayer_settings`,this.settings={}}get(e){try{let t=JSON.parse(window.localStorage.getItem(this.name))||{};return e?t[e]:t}catch{return e?this.settings[e]:this.settings}}set(e,t){try{let n=Object.assign({},this.get(),{[e]:t});window.localStorage.setItem(this.name,JSON.stringify(n))}catch{this.settings[e]=t}}del(e){try{let t=this.get();delete t[e],window.localStorage.setItem(this.name,JSON.stringify(t))}catch{delete this.settings[e]}}clear(){try{window.localStorage.removeItem(this.name)}catch{this.settings={}}}},ft=`.art-video-player {
  --art-theme: #f00;
  --art-font-color: #fff;
...
`,pt=class extends N{constructor(e){super(e),this.name=`subtitle`,this.option=null,this.destroyEvent=()=>null,this.init(e.option.subtitle);let t=!1;e.on(`video:timeupdate`,()=>{if(!this.url)return;let e=this.art.template.$video.webkitDisplayingFullscreen;typeof e==`boolean`&&e!==t&&(t=e,this.createTrack(e?`subtitles`:`metadata`,this.url))})}get url(){return this.art.template.$track.src}set url(e){this.switch(e)}get textTrack(){return this.art.template.$video?.textTracks?.[0]}get activeCues(){return this.textTrack?Array.from(this.textTrack.activeCues):[]}get cues(){return this.textTrack?Array.from(this.textTrack.cues):[]}style(e,t){let{$subtitle:n}=this.art.template;return typeof e==`object`?xt(n,e):W(n,e,t)}update(){let{option:{subtitle:e},template:{$subtitle:t}}=this.art;t.innerHTML=``,this.activeCues.length&&(this.art.emit(`subtitleBeforeUpdate`,this.activeCues),t.innerHTML=this.activeCues.map((t,n)=>t.text.split(/\r?\n/).filter(e=>e.trim()).map(t=>`<div class="art-subtitle-line" data-group="${n}">
            ...
            <div class="art-info">
              <div class="art-info-panel">
                <div class="art-info-item">
                  ...
                  <div class="art-info-content">${y}</div>
                </div>
                <div class="art-info-item">
        ...
        `}query(e){return R(e,this.$container)}init(){let{option:t}=this.art;if(t.useSSR||(this.$container.innerHTML=e.html),this.$player=this.query(`.art-video-player`),this.$video=this.query(`.art-video`),this.$track=this.query(`track`),this.$poster=this.query(`.art-poster`),this.$subtitle=this.query(`.art-subtitle`),this.$danmuku=this.query(`.art-danmuku`),this.$bottom=this.query(`.art-bottom`),this.$progress=this.query(`.art-progress`),this.$controls=this.query(`.art-controls`),this.$controlsLeft=this.query(`.art-controls-left`),this.$controlsCenter=this.query(`.art-controls-center`),this.$controlsRight=this.query(`.art-controls-right`),this.$layer=this.query(`.art-layers`),this.$loading=this.query(`.art-loading`),this.$notice=this.query(`.art-notice`),this.$noticeInner=this.query(`.art-notice-inner`),this.$mask=this.query(`.art-mask`),this.$state=this.query(`.art-state`),this.$setting=this.query(`.art-settings`),this.$info=this.query(`.art-info`),this.$infoPanel=this.query(`.art-info-panel`),this.$infoClose=this.query(`.art-info-close`),this.$contextmenu=this.query(`.art-contextmenus`),t.proxy){let e=t.proxy.call(this.art,this.art);X(e instanceof HTMLVideoElement||e instanceof HTMLCanvasElement,`Function 'option.proxy' needs to return 'HTMLVideoElement' or 'HTMLCanvasElement'`),Tt(e,this.$video),e.className=`art-video`,this.$video=e}t.backdrop&&B(this.$player,`art-backdrop`),w&&B(this.$player,`art-mobile`)}destroy(e){e?this.$container.innerHTML=``:B(this.$player,`art-destroy`)}},ht=class{on(e,t,n){let r=this.e||(this.e={});return(r[e]||(r[e]=[])).push({fn:t,ctx:n}),this}once(e,t,n){let r=this;function i(...a){r.off(e,i),t.apply(n,a)}return i._=t,this.on(e,i,n)}emit(e,...t){let n=((this.e||(this.e={}))[e]||[]).slice();for(let e=0;e<n.length;e+=1)n[e].fn.apply(n[e].ctx,t);return this}off(e,t){let n=this.e||(this.e={}),r=n[e],i=[];if(r&&t)for(let e=0,n=r.length;e<n;e+=1)r[e].fn!==t&&r[e].fn._!==t&&i.push(r[e]);return i.length?n[e]=i:delete n[e],this}},gt=0,I=[],e(`i`,L=class e extends ht{constructor(t,n){if(super(),!T)throw Error(`Artplayer can only be used in the browser environment`);this.id=++gt;let r=Rt(e.option,t);if(r.container=t.container,this.option=v(r,be),this.isLock=!1,this.isReady=!1,this.isFocus=!1,this.isInput=!1,this.isRotate=!1,this.isDestroy=!1,this.template=new mt(this),this.events=new Ce(this),this.storage=new dt(this),this.icons=new et(this),this.i18n=new Ee(this),this.notice=new at(this),this.player=new ct(this),this.layers=new nt(this),this.controls=new Se(this),this.contextmenu=new xe(this),this.subtitle=new pt(this),this.info=new tt(this),this.loading=new rt(this),this.hotkey=new we(this),this.mask=new it(this),this.setting=new ut(this),this.plugins=new lt(this),typeof n==`function`&&this.on(`ready`,()=>n.call(this,this)),e.DEBUG){let t=e=>console.log(`[ART.${this.id}] -> ${e}`);t(`Version@${e.version}`);for(let e=0;e<b.events.length;e++)this.on(`video:${b.events[e]}`,e=>t(`Event@${e.type}`))}I.push(this)}static get instances(){return I}static get version(){return y}static get config(){return b}static get utils(){return ve}static get scheme(){return be}static get Emitter(){return ht}static get validator(){return v}static get kindOf(){return v.kindOf}static get html(){return mt.html}static get option(){return{id:``,container:`#artplayer`,url:``,poster:``,type:``,theme:`#f00`,volume:.7,isLive:!1,muted:!1,autoplay:!1,autoSize:!1,autoMini:!1,loop:!1,flip:!1,playbackRate:!1,aspectRatio:!1,screenshot:!1,setting:!1,hotkey:!0,pip:!1,mutex:!0,backdrop:!0,fullscreen:!1,fullscreenWeb:!1,subtitleOffset:!1,miniProgressBar:!1,useSSR:!1,playsInline:!0,lock:!1,gesture:!0,fastForward:!1,autoPlayback:!1,autoOrientation:!1,airplay:!1,proxy:void 0,layers:[],contextmenu:[],controls:[],settings:[],quality:[],highlight:[],plugins:[],thumbnails:{url:``,number:60,column:10,width:0,height:0,scale:1},subtitle:{url:``,type:``,style:{},name:``,escape:!0,encoding:`utf-8`,onVttLoad:e=>e},moreVideoAttr:{controls:!1,preload:S?`auto`:`metadata`},i18n:{},icons:{},cssVar:{},customType:{},lang:navigator?.language.toLowerCase()}}get proxy(){return this.events.proxy}get query(){return this.template.query}get video(){return this.template.$video}reset(){this.video.removeAttribute(`src`),this.video.load()}destroy(t=!0){e.REMOVE_SRC_WHEN_DESTROY&&this.reset(),this.events.destroy(),this.template.destroy(t),I.splice(I.indexOf(this),1),this.isDestroy=!0,this.emit(`destroy`)}}),L.STYLE=ft,L.DEBUG=!1,L.CONTEXTMENU=!0,L.NOTICE_TIME=2e3,L.SETTING_WIDTH=250,L.SETTING_ITEM_WIDTH=200,L.SETTING_ITEM_HEIGHT=35,L.RESIZE_TIME=200,L.SCROLL_TIME=200,L.SCROLL_GAP=50,L.AUTO_PLAYBACK_MAX=10,L.AUTO_PLAYBACK_MIN=5,L.AUTO_PLAYBACK_TIMEOUT=3e3,L.RECONNECT_TIME_MAX=5,L.RECONNECT_SLEEP_TIME=1e3,L.CONTROL_HIDE_TIME=3e3,L.DBCLICK_TIME=300,L.DBCLICK_FULLSCREEN=!0,L.MOBILE_DBCLICK_PLAY=!0,L.MOBILE_CLICK_PLAY=!1,L.AUTO_ORIENTATION_TIME=200,L.INFO_LOOP_TIME=1e3,L.FAST_FORWARD_VALUE=3,L.FAST_FORWARD_TIME=1e3,L.TOUCH_MOVE_RATIO=.5,L.VOLUME_STEP=.1,L.SEEK_STEP=5,L.PLAYBACK_RATE=[.5,.75,1,1.25,1.5,2],L.ASPECT_RATIO=[`default`,`4:3`,`16:9`],L.FLIP=[`normal`,`horizontal`,`vertical`],L.FULLSCREEN_WEB_IN_BODY=!0,L.LOG_VERSION=!0,L.USE_RAF=!1,L.REMOVE_SRC_WHEN_DESTROY=!0,T&&(Dt(`artplayer-style`,ft),setTimeout(()=>{L.LOG_VERSION&&console.log(`%c ArtPlayer %c ${L.version} %c https://artplayer.org`,`color: #fff; background: #5f5f5f`,`color: #fff; background: #4bc729`,``)},100)),L.PLAYBACK_RATE=[.5,.75,1,1.25,1.5,2,3,4],L.REMOVE_SRC_WHEN_DESTROY=!0,e(`r`,_t=[{icon:`iina`,name:`IINA`,scheme:`iina://weblink?url=$edurl`,platforms:[`MacOS`]},{icon:`potplayer`,name:`PotPlayer`,scheme:`potplayer://$durl`,platforms:[`Windows`]},{icon:`vlc`,name:`VLC`,scheme:`vlc://$durl`,platforms:[`Windows`,`MacOS`,`Linux`,`Android`,`iOS`]},{icon:`android`,name:`Android`,scheme:`intent:$durl#Intent;type=video/*;S.title=$name;end`,platforms:[`Android`]},{icon:`nplayer`,name:`nPlayer`,scheme:`nplayer-$durl`,platforms:[`Android`,`iOS`]},{icon:`omniplayer`,name:`OmniPlayer`,scheme:`omniplayer://weblink?url=$durl`,platforms:[`MacOS`]},{icon:`figplayer`,name:`Fig Player`,scheme:`figplayer://weblink?url=$durl`,platforms:[`Windows`,`MacOS`]},{icon:`vivid`,name:`Vivid Player`,scheme:`vividplayer://play?src=direct&u=$edurl&title=$name`,platforms:[`Windows`]},{icon:`infuse`,name:`Infuse`,scheme:`infuse://x-callback-url/play?url=$durl`,platforms:[`MacOS`,`iOS`]},{icon:`fileball`,name:`Fileball`,scheme:`filebox://play?url=$durl`,platforms:[`MacOS`,`iOS`]},{icon:`mxplayer`,name:`MX Player`,scheme:`intent:$durl#Intent;package=com.mxtech.videoplayer.ad;S.title=$name;end`,platforms:[`Android`]},{icon:`mxplayer-pro`,name:`MX Player Pro`,scheme:`intent:$durl#Intent;package=com.mxtech.videoplayer.pro;S.title=$name;end`,platforms:[`Android`]},{icon:`iPlay`,name:`iPlay`,scheme:`iplay://play/any?type=url&url=$bdurl`,platforms:[`iOS`]},{icon:`mpv`,name:`mpv`,scheme:`mpv://$edurl`,platforms:[`Windows`,`MacOS`,`Linux`,`Android`]}]),e(`t`,e=>{let{$container:t,$video:n}=e.template,r=t.parentElement;e.on(`ready`,()=>{r.style.maxHeight=`calc(100vh - ${r.offsetTop}px - 1.75rem)`,r.style.minHeight=`320px`,e.autoHeight()}),e.on(`resize`,()=>{e.autoHeight()}),e.on(`error`,()=>{n.style.height||(t.style.height=`60vh`,n.style.height=`100%`)})}),e(`n`,e=>{let{replace:t,pathname:_}=re(),{currentObjLink:pe}=ee(),{handleFolder:me}=te(),[v,y]=ce(``),b=se(()=>{let e=!0,t=!1,n=r.objs.filter(n=>n.type===f.VIDEO&&(n.name===r.obj.name?(e=!1,t=!0,y(n.name)):t=!1,!0));if(t&&(e=ae().type!==`all`),e){let e=_();if(!e.endsWith(r.obj.name))return n.push(r.obj),y(r.obj.name),n;let t=r.objs.length>0;me(ue(e),m()+ +!!t,void 0,t,!1,!0)}return n}),x=le(),S=localStorage.getItem(`video_auto_next`);S||(S=`true`),e.onAutoNextChange(S===`true`);let[C,he]=ce(localStorage.getItem(`video_show_all_players`)===`true`),w=ie(),T=se(()=>C()||w===`Unknown`?_t:_t.filter(e=>e.platforms.includes(w)));return n(u,{w:`$full`,spacing:`$2`,get children(){return[c(()=>e.children),n(o,{get when(){return v()!==``},get children(){return n(oe,{spacing:`$2`,w:`$full`,get children(){return[n(de,{onChange:e=>{t(e)},get value(){return v()},get options(){return b().map(e=>({value:e.name}))}}),n(a,{css:{whiteSpace:`nowrap`},defaultChecked:S===`true`,onChange:t=>{e.onAutoNextChange(t.currentTarget.checked),localStorage.setItem(`video_auto_next`,t.currentTarget.checked.toString())},get children(){return x(`home.preview.auto_next`)}})]}})}}),n(p,{wrap:`wrap`,gap:`$1`,justifyContent:`center`,alignItems:`center`,get children(){return[n(i,{get each(){return T()},children:e=>n(g,{placement:`top`,withArrow:!0,get label(){return e.name},get children(){return n(d,{get href(){return s(e.scheme,{raw_url:r.raw_url,name:r.obj.name,d_url:pe(!0)})},get children(){return n(l,{m:`0 auto`,boxSize:`$8`,get src(){return`${window.__dynamic_base__}/images/${e.icon}.webp`}})}})}})}),n(ne,{"aria-label":`Show all players`,variant:`ghost`,onClick:()=>{let e=!C();he(e),localStorage.setItem(`video_show_all_players`,e.toString())},get icon(){return n(h,{as:fe,boxSize:`$6`,color:`accent.500`,get transform(){return C()?`rotate(180deg)`:`none`},transition:`transform 0.2s`})}})]}})]}})})}}})})();
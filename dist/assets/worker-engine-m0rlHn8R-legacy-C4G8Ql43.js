(function(){System.register([`./browser-BKLM0ThC-IxjwuOIz-legacy-yvmR0Zf2.js`,`./pdf-legacy-B9BBJT0o.js`],function(e,t){var n,r,i,a,o,s,c,l,u,d,f,p,m;function h(e,t){let{logger:i,encoderPoolSize:a,fontFallback:o}=t instanceof Object&&`debug`in t?{logger:t}:t||{},s=new Worker(URL.createObjectURL(new Blob([`var Rotation = /* @__PURE__ */ ((Rotation2) => {
...
`],{type:`application/javascript`})),{type:`module`}),c=new d(s,{wasmUrl:e,logger:i,fontFallback:o}),l=URL.createObjectURL(new Blob([`function rgbaToBmpBlob(rgba, width, height) {

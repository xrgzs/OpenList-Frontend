(function(){System.register([`./embedpdf-7TNsu-EA-legacy-PH-oqWbQ.js`,`./browser-BKLM0ThC-CkSOgtCM-legacy-OlObZEm-.js`],function(e,t){var n,r,i,a,o,s,c,l,u,d,f,p,m;function h(e,t){let{logger:n,encoderPoolSize:r,fontFallback:i}=t instanceof Object&&`debug`in t?{logger:t}:t||{},a=new Worker(URL.createObjectURL(new Blob([`var Rotation = /* @__PURE__ */ ((Rotation2) => {
...
`],{type:`application/javascript`})),{type:`module`}),c=new d(a,{wasmUrl:e,logger:n,fontFallback:i}),l=URL.createObjectURL(new Blob([`function rgbaToBmpBlob(rgba, width, height) {

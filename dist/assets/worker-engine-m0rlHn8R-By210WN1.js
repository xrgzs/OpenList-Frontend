...
`],{type:`application/javascript`})),{type:`module`}),{wasmUrl:n,logger:i,fontFallback:o}),c=URL.createObjectURL(new Blob([`function rgbaToBmpBlob(rgba, width, height) {
...
`],{type:`application/javascript`})),u=new f(a??2,c,i);return new t(s,{imageConverter:e(u),logger:i})}export{p as createPdfiumEngine};
import{$i as e,C as t,Dn as n,Kn as r,Qn as i,V as a,X as o,Xi as s,Y as c,Z as l,Zt as u,at as d,bt as f,ca as p,fa as m,hn as ee,ia as h,l as te,nr as ne,qr as re,ri as ie,rr as ae,ti as oe,tr as se,tt as ce,zi as le}from"./store-BpEGx78c.js";import{a as ue,u as de}from"./index-uBJla3yT.js";function fe(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,`default`)?e.default:e}var g={exports:{}},pe=g.exports,me;function he(){return me?g.exports:(me=1,(function(e,t){(function(t,n){e.exports=n()})(pe,function(){function e(t){return(e=typeof Symbol==`function`&&typeof Symbol.iterator==`symbol`?function(e){return typeof e}:function(e){return e&&typeof Symbol==`function`&&e.constructor===Symbol&&e!==Symbol.prototype?`symbol`:typeof e})(t)}var t=Object.prototype.toString,n=function(n){if(n===void 0)return`undefined`;if(n===null)return`null`;var i=e(n);if(i===`boolean`)return`boolean`;if(i===`string`)return`string`;if(i===`number`)return`number`;if(i===`symbol`)return`symbol`;if(i===`function`)return(function(e){return r(e)===`GeneratorFunction`})(n)?`generatorfunction`:`function`;if((function(e){return Array.isArray?Array.isArray(e):e instanceof Array})(n))return`array`;if((function(e){return e.constructor&&typeof e.constructor.isBuffer==`function`?e.constructor.isBuffer(e):!1})(n))return`buffer`;if((function(e){try{if(typeof e.length==`number`&&typeof e.callee==`function`)return!0}catch(e){if(e.message.indexOf(`callee`)!==-1)return!0}return!1})(n))return`arguments`;if((function(e){return e instanceof Date||typeof e.toDateString==`function`&&typeof e.getDate==`function`&&typeof e.setDate==`function`})(n))return`date`;if((function(e){return e instanceof Error||typeof e.message==`string`&&e.constructor&&typeof e.constructor.stackTraceLimit==`number`})(n))return`error`;if((function(e){return e instanceof RegExp||typeof e.flags==`string`&&typeof e.ignoreCase==`boolean`&&typeof e.multiline==`boolean`&&typeof e.global==`boolean`})(n))return`regexp`;switch(r(n)){case`Symbol`:return`symbol`;case`Promise`:return`promise`;case`WeakMap`:return`weakmap`;case`WeakSet`:return`weakset`;case`Map`:return`map`;case`Set`:return`set`;case`Int8Array`:return`int8array`;case`Uint8Array`:return`uint8array`;case`Uint8ClampedArray`:return`uint8clampedarray`;case`Int16Array`:return`int16array`;case`Uint16Array`:return`uint16array`;case`Int32Array`:return`int32array`;case`Uint32Array`:return`uint32array`;case`Float32Array`:return`float32array`;case`Float64Array`:return`float64array`}if((function(e){return typeof e.throw==`function`&&typeof e.return==`function`&&typeof e.next==`function`})(n))return`generator`;switch(i=t.call(n)){case`[object Object]`:return`object`;case`[object Map Iterator]`:return`mapiterator`;case`[object Set Iterator]`:return`setiterator`;case`[object String Iterator]`:return`stringiterator`;case`[object Array Iterator]`:return`arrayiterator`}return i.slice(8,-1).toLowerCase().replace(/\s/g,``)};function r(e){return e.constructor?e.constructor.name:null}function i(e,t){var r=2<arguments.length&&arguments[2]!==void 0?arguments[2]:[`option`];return a(e,t,r),o(e,t,r),(function(e,t,r){var s=n(t),c=n(e);if(s===`object`){if(c!==`object`)throw Error(`[Type Error]: '${r.join(`.`)}' require 'object' type, but got '${c}'`);Object.keys(t).forEach(function(n){var s=e[n],c=t[n],l=r.slice();l.push(n),a(s,c,l),o(s,c,l),i(s,c,l)})}if(s===`array`){if(c!==`array`)throw Error(`[Type Error]: '${r.join(`.`)}' require 'array' type, but got '${c}'`);e.forEach(function(n,s){var c=e[s],l=t[s]||t[0],u=r.slice();u.push(s),a(c,l,u),o(c,l,u),i(c,l,u)})}})(e,t,r),e}function a(e,t,r){if(n(t)===`string`){var i=n(e);if(t[0]===`?`&&(t=t.slice(1)+`|undefined`),!(-1<t.indexOf(`|`)?t.split(`|`).map(function(e){return e.toLowerCase().trim()}).filter(Boolean).some(function(e){return i===e}):t.toLowerCase().trim()===i))throw Error(`[Type Error]: '${r.join(`.`)}' require '${t}' type, but got '${i}'`)}}function o(e,t,r){if(n(t)===`function`){var i=t(e,n(e),r);if(!0!==i){var a=n(i);throw a===`string`?Error(i):a===`error`?i:Error(`[Validator Error]: The scheme for '${r.join(`.`)}' validator require return true, but got '${i}'`)}}}return i.kindOf=n,i})})(g),g.exports)}var _=fe(he()),v=`5.4.0`,y={properties:`audioTracks.autoplay.buffered.controller.controls.crossOrigin.currentSrc.currentTime.defaultMuted.defaultPlaybackRate.duration.ended.error.loop.mediaGroup.muted.networkState.paused.playbackRate.played.preload.readyState.seekable.seeking.src.startDate.textTracks.videoTracks.volume`.split(`.`),methods:[`addTextTrack`,`canPlayType`,`load`,`play`,`pause`],events:[`abort`,`canplay`,`canplaythrough`,`durationchange`,`emptied`,`ended`,`error`,`loadeddata`,`loadedmetadata`,`loadstart`,`pause`,`play`,`playing`,`progress`,`ratechange`,`seeked`,`seeking`,`stalled`,`suspend`,`timeupdate`,`volumechange`,`waiting`],prototypes:[`width`,`height`,`videoWidth`,`videoHeight`,`poster`,`webkitDecodedFrameCount`,`webkitDroppedFrameCount`,`playsInline`,`webkitSupportsFullscreen`,`webkitDisplayingFullscreen`,`onenterpictureinpicture`,`onleavepictureinpicture`,`disablePictureInPicture`,`cancelVideoFrameCallback`,`requestVideoFrameCallback`,`getVideoPlaybackQuality`,`requestPictureInPicture`,`webkitEnterFullScreen`,`webkitEnterFullscreen`,`webkitExitFullScreen`,`webkitExitFullscreen`]},b=globalThis?.CUSTOM_USER_AGENT??(typeof navigator<`u`?navigator.userAgent:``),x=/^(?:(?!chrome|android).)*safari/i.test(b),S=/iPad|iPhone|iPod/i.test(b)&&!window.MSStream,ge=S||b.includes(`Macintosh`)&&navigator.maxTouchPoints>=1,C=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(b)||ge,w=typeof window<`u`&&typeof document<`u`;function T(e,t=document){return t.querySelector(e)}function E(e,t=document){return Array.from(t.querySelectorAll(e))}function D(e,t){return e.classList.add(t)}function O(e,t){return e.classList.remove(t)}function k(e,t){return e.classList.contains(t)}function A(e,t){return t instanceof Element?e.appendChild(t):e.insertAdjacentHTML(`beforeend`,String(t)),e.lastElementChild||e.lastChild}function _e(e){return e.parentNode.removeChild(e)}function j(e,t,n){return e.style[t]=n,e}function ve(e,t){for(let n in t)j(e,n,t[n]);return e}function ye(e,t,n=!0){let r=window.getComputedStyle(e,null).getPropertyValue(t);return n?Number.parseFloat(r):r}function be(e){return Array.from(e.parentElement.children).filter(t=>t!==e)}function M(e,t){be(e).forEach(e=>O(e,t)),D(e,t)}function N(e,t,n=`top`){C||(e.setAttribute(`aria-label`,t),D(e,`hint--rounded`),D(e,`hint--${n}`))}function xe(e,t=0){let n=e.getBoundingClientRect(),r=window.innerHeight||document.documentElement.clientHeight,i=window.innerWidth||document.documentElement.clientWidth,a=n.top-t<=r&&n.top+n.height+t>=0,o=n.left-t<=i+t&&n.left+n.width+t>=0;return a&&o}function P(e,t){return De(e).includes(t)}function Se(e,t){return t.parentNode.replaceChild(e,t),e}function F(e){return document.createElement(e)}function Ce(e=``,t=``){let n=F(`i`);return D(n,`art-icon`),D(n,`art-icon-${e}`),A(n,t),n}function we(e,t){let n=document.getElementById(e);n||(n=document.createElement(`style`),n.id=e,document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,()=>{document.head.appendChild(n)}):(document.head||document.documentElement).appendChild(n)),n.textContent=t}function Te(){let e=document.createElement(`div`);return e.style.display=`flex`,e.style.display===`flex`}function I(e){return e.getBoundingClientRect()}function Ee(e,t){return new Promise((n,r)=>{let i=new Image;i.onload=function(){if(!t||t===1)n(i);else{let a=document.createElement(`canvas`),o=a.getContext(`2d`);a.width=i.width*t,a.height=i.height*t,o.drawImage(i,0,0,a.width,a.height),a.toBlob(t=>{let i=URL.createObjectURL(t),a=new Image;a.onload=function(){n(a)},a.onerror=function(){URL.revokeObjectURL(i),r(Error(`Image load failed: ${e}`))},a.src=i})}},i.onerror=function(){r(Error(`Image load failed: ${e}`))},i.src=e})}function De(e){if(e.composedPath)return e.composedPath();let t=[],n=e.target;for(;n;)t.push(n),n=n.parentNode;return!t.includes(window)&&window!==void 0&&t.push(window),t}var Oe=class extends Error{constructor(e,t){super(e),typeof Error.captureStackTrace==`function`&&Error.captureStackTrace(this,t||this.constructor),this.name=`ArtPlayerError`}};function L(e,t){if(!e)throw new Oe(t);return e}function ke(e){return e.includes(`?`)?ke(e.split(`?`)[0]):e.includes(`#`)?ke(e.split(`#`)[0]):e.trim().toLowerCase().split(`.`).pop()}function Ae(e,t){let n=document.createElement(`a`);n.style.display=`none`,n.href=e,n.download=t,document.body.appendChild(n),n.click(),document.body.removeChild(n)}function R(e,t,n){return Math.max(Math.min(e,Math.max(t,n)),Math.min(t,n))}function je(e){return e.charAt(0).toUpperCase()+e.slice(1)}function z(e){if(!e)return`00:00`;let t=e=>e<10?`0${e}`:String(e),n=Math.floor(e/3600),r=Math.floor((e-n*3600)/60),i=Math.floor(e-n*3600-r*60);return(n>0?[n,r,i]:[r,i]).map(t).join(`:`)}function Me(e){return e.replace(/[&<>'"]/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,"'":`&#39;`,'"':`&quot;`})[e]||e)}function Ne(e){let t={"&amp;":`&`,"&lt;":`<`,"&gt;":`>`,"&#39;":`'`,"&quot;":`"`},n=RegExp(`(${Object.keys(t).join(`|`)})`,`g`);return e.replace(n,e=>t[e]||e)}var B=Object.defineProperty,{hasOwnProperty:Pe}=Object.prototype;function V(e,t){return Pe.call(e,t)}function Fe(e,t){return Object.getOwnPropertyDescriptor(e,t)}function Ie(...e){let t=e=>e&&typeof e==`object`&&!Array.isArray(e);return e.reduce((e,n)=>(Object.keys(n).forEach(r=>{let i=e[r],a=n[r];e[r]=Array.isArray(i)&&Array.isArray(a)?i.concat(...a):t(i)&&t(a)?Ie(i,a):a}),e),{})}function Le(e){return e.replace(/(\d\d:\d\d:\d\d)[,.](\d+)/g,(e,t,n)=>{let r=n.slice(0,3);return n.length===1&&(r=`${n}00`),n.length===2&&(r=`${n}0`),`${t},${r}`})}function Re(e){return`WEBVTT \r
\r
...
`)}`}function H(e=0){return new Promise(t=>setTimeout(t,e))}function Ve(e,t){let n;return function(...r){clearTimeout(n),n=setTimeout(()=>(n=null,e.apply(this,r)),t)}}function He(e,t){let n=!1;return function(...r){n||(e.apply(this,r),n=!0,setTimeout(()=>{n=!1},t))}}var Ue=Object.freeze(Object.defineProperty({__proto__:null,ArtPlayerError:Oe,addClass:D,append:A,assToVtt:Be,capitalize:je,clamp:R,createElement:F,debounce:Ve,def:B,download:Ae,errorHandle:L,escape:Me,get:Fe,getComposedPath:De,getExt:ke,getIcon:Ce,getRect:I,getStyle:ye,has:V,hasClass:k,includeFromEvent:P,inverseClass:M,isBrowser:w,isIOS:S,isIOS13:ge,isInViewport:xe,isMobile:C,isSafari:x,loadImg:Ee,mergeDeep:Ie,query:T,queryAll:E,remove:_e,removeClass:O,replaceElement:Se,secondToTime:z,setStyle:j,setStyleText:we,setStyles:ve,siblings:be,sleep:H,srtToVtt:Re,supportsFlex:Te,throttle:He,tooltip:N,unescape:Ne,userAgent:b,vttToBlob:ze},Symbol.toStringTag,{value:`Module`})),We=`array`,U=`boolean`,W=`string`,G=`number`,K=`object`,q=`function`;function Ge(e,t,n){return L(t===W||t===G||e instanceof Element,`${n.join(`.`)} require '${W}' or 'Element' type`)}var J={html:Ge,disable:`?${U}`,name:`?${W}`,index:`?${G}`,style:`?${K}`,click:`?${q}`,mounted:`?${q}`,tooltip:`?${W}|${G}`,width:`?${G}`,selector:`?${We}`,onSelect:`?${q}`,switch:`?${U}`,onSwitch:`?${q}`,range:`?${We}`,onRange:`?${q}`,onChange:`?${q}`},Ke={id:W,container:Ge,url:W,poster:W,type:W,theme:W,lang:W,volume:G,isLive:U,muted:U,autoplay:U,autoSize:U,autoMini:U,loop:U,flip:U,playbackRate:U,aspectRatio:U,screenshot:U,setting:U,hotkey:U,pip:U,mutex:U,backdrop:U,fullscreen:U,fullscreenWeb:U,subtitleOffset:U,miniProgressBar:U,useSSR:U,playsInline:U,lock:U,gesture:U,fastForward:U,autoPlayback:U,autoOrientation:U,airplay:U,proxy:`?${q}`,plugins:[q],layers:[J],contextmenu:[J],settings:[J],controls:[{...J,position:(e,t,n)=>{let r=[`top`,`left`,`right`];return L(r.includes(e),`${n.join(`.`)} only accept ${r.toString()} as parameters`)}}],quality:[{default:`?${U}`,html:W,url:W}],highlight:[{time:G,text:W}],thumbnails:{url:W,number:G,column:G,width:G,height:G,scale:G},subtitle:{url:W,name:W,type:W,style:K,escape:U,encoding:W,onVttLoad:q},moreVideoAttr:K,i18n:K,icons:K,cssVar:K,customType:K},Y=class{constructor(e){this.id=0,this.art=e,this.cache=new Map,this.add=this.add.bind(this),this.remove=this.remove.bind(this),this.update=this.update.bind(this)}get show(){return k(this.art.template.$player,`art-${this.name}-show`)}set show(e){let{$player:t}=this.art.template,n=`art-${this.name}-show`;e?D(t,n):O(t,n),this.art.emit(this.name,e)}toggle(){this.show=!this.show}add(e){let t=typeof e==`function`?e(this.art):e;if(t.html=t.html||``,_(t,J),!this.$parent||!this.name||t.disable)return;let n=t.name||`${this.name}${this.id}`;L(!this.cache.has(n),`Can't add an existing [${n}] to the [${this.name}]`),this.id+=1;let r=F(`div`);D(r,`art-${this.name}`),D(r,`art-${this.name}-${n}`);let i=Array.from(this.$parent.children);r.dataset.index=t.index||this.id;let a=i.find(e=>Number(e.dataset.index)>=Number(r.dataset.index));a?a.insertAdjacentElement(`beforebegin`,r):A(this.$parent,r),t.html&&A(r,t.html),t.style&&ve(r,t.style),t.tooltip&&N(r,t.tooltip);let o=[];if(t.click){let e=this.art.events.proxy(r,`click`,e=>{e.preventDefault(),t.click.call(this.art,this,e)});o.push(e)}return t.selector&&[`left`,`right`].includes(t.position)&&this.selector(t,r,o),this[n]=r,this.cache.set(n,{$ref:r,events:o,option:t}),t.mounted&&t.mounted.call(this.art,r),r}remove(e){L(this.cache.has(e),`Can't find [${e}] from the [${this.name}]`);let t=this.cache.get(e);t.option.beforeUnmount&&t.option.beforeUnmount.call(this.art,t.$ref);for(let e of t.events)this.art.events.remove(e);this.cache.delete(e),delete this[e],_e(t.$ref)}update(e){if(this.cache.has(e.name)){let t=this.cache.get(e.name);e=Object.assign(t.option,e),this.remove(e.name)}return this.add(e)}};function qe(e){return t=>{let{i18n:n,constructor:{ASPECT_RATIO:r}}=t,i=r.map(e=>`<span data-value="${e}">${e==="default"?n.get(`Default`):e}</span>`).join(``);return{...e,html:`${n.get(`Aspect Ratio`)}: ${i}`,click:(e,n)=>{let{value:r}=n.target.dataset;r&&(t.aspectRatio=r,e.show=!1)},mounted:e=>{let n=T(`[data-value="default"]`,e);n&&M(n,`art-current`),t.on(`aspectRatio`,t=>{let n=E(`span`,e).find(e=>e.dataset.value===t);n&&M(n,`art-current`)})}}}}function Je(e){return t=>({...e,html:t.i18n.get(`Close`),click:e=>{e.show=!1}})}function Ye(e){return t=>{let{i18n:n,constructor:{FLIP:r}}=t,i=r.map(e=>`<span data-value="${e}">${n.get(je(e))}</span>`).join(``);return{...e,html:`${n.get(`Video Flip`)}: ${i}`,click:(e,n)=>{let{value:r}=n.target.dataset;r&&(t.flip=r.toLowerCase(),e.show=!1)},mounted:e=>{let n=T(`[data-value="normal"]`,e);n&&M(n,`art-current`),t.on(`flip`,t=>{let n=E(`span`,e).find(e=>e.dataset.value===t);n&&M(n,`art-current`)})}}}}function Xe(e){return t=>({...e,html:t.i18n.get(`Video Info`),click:e=>{t.info.show=!0,e.show=!1}})}function Ze(e){return t=>{let{i18n:n,constructor:{PLAYBACK_RATE:r}}=t,i=r.map(e=>`<span data-value="${e}">${e===1?n.get(`Normal`):e.toFixed(1)}</span>`).join(``);return{...e,html:`${n.get(`Play Speed`)}: ${i}`,click:(e,n)=>{let{value:r}=n.target.dataset;r&&(t.playbackRate=Number(r),e.show=!1)},mounted:e=>{let n=T(`[data-value="1"]`,e);n&&M(n,`art-current`),t.on(`video:ratechange`,()=>{let n=E(`span`,e).find(e=>Number(e.dataset.value)===t.playbackRate);n&&M(n,`art-current`)})}}}}function Qe(e){let t=w?location.href:``;return{...e,html:`<a href="https://artplayer.org?ref=${encodeURIComponent(t)}" target="_blank" style="width:100%;">ArtPlayer ${v}</a>`}}var $e=class extends Y{constructor(e){super(e),this.name=`contextmenu`,this.$parent=e.template.$contextmenu,C||this.init()}init(){let{option:e,proxy:t,template:{$player:n,$contextmenu:r}}=this.art;e.playbackRate&&this.add(Ze({name:`playbackRate`,index:10})),e.aspectRatio&&this.add(qe({name:`aspectRatio`,index:20})),e.flip&&this.add(Ye({name:`flip`,index:30})),this.add(Xe({name:`info`,index:40})),this.add(Qe({name:`version`,index:50})),this.add(Je({name:`close`,index:60}));for(let t=0;t<e.contextmenu.length;t++)this.add(e.contextmenu[t]);t(n,`contextmenu`,e=>{if(!this.art.constructor.CONTEXTMENU)return;e.preventDefault(),this.show=!0;let t=e.clientX,i=e.clientY,{height:a,width:o,left:s,top:c}=I(n),{height:l,width:u}=I(r),d=t-s,f=i-c;t+u>s+o&&(d=o-u),i+l>c+a&&(f=a-l),ve(r,{top:`${f}px`,left:`${d}px`})}),t(n,`click`,e=>{P(e,r)||(this.show=!1)}),this.art.on(`blur`,()=>{this.show=!1})}};function et(e){return t=>({...e,tooltip:t.i18n.get(`AirPlay`),mounted:e=>{let{proxy:n,icons:r}=t;A(e,r.airplay),n(e,`click`,()=>t.airplay())}})}function tt(e){return t=>({...e,tooltip:t.i18n.get(`Fullscreen`),mounted:e=>{let{proxy:n,icons:r,i18n:i}=t,a=A(e,r.fullscreenOn),o=A(e,r.fullscreenOff);j(o,`display`,`none`),n(e,`click`,()=>{t.fullscreen=!t.fullscreen}),t.on(`fullscreen`,t=>{t?(N(e,i.get(`Exit Fullscreen`)),j(a,`display`,`none`),j(o,`display`,`inline-flex`)):(N(e,i.get(`Fullscreen`)),j(a,`display`,`inline-flex`),j(o,`display`,`none`))})}})}function nt(e){return t=>({...e,tooltip:t.i18n.get(`Web Fullscreen`),mounted:e=>{let{proxy:n,icons:r,i18n:i}=t,a=A(e,r.fullscreenWebOn),o=A(e,r.fullscreenWebOff);j(o,`display`,`none`),n(e,`click`,()=>{t.fullscreenWeb=!t.fullscreenWeb}),t.on(`fullscreenWeb`,t=>{t?(N(e,i.get(`Exit Web Fullscreen`)),j(a,`display`,`none`),j(o,`display`,`inline-flex`)):(N(e,i.get(`Web Fullscreen`)),j(a,`display`,`inline-flex`),j(o,`display`,`none`))})}})}function rt(e){return t=>({...e,tooltip:t.i18n.get(`PIP Mode`),mounted:e=>{let{proxy:n,icons:r,i18n:i}=t;A(e,r.pip),n(e,`click`,()=>{t.pip=!t.pip}),t.on(`pip`,t=>{N(e,i.get(t?`Exit PIP Mode`:`PIP Mode`))})}})}function it(e){return t=>({...e,mounted:e=>{let{proxy:n,icons:r,i18n:i}=t,a=A(e,r.play),o=A(e,r.pause);N(a,i.get(`Play`)),N(o,i.get(`Pause`)),n(a,`click`,()=>{t.play()}),n(o,`click`,()=>{t.pause()});function s(){j(a,`display`,`flex`),j(o,`display`,`none`)}function c(){j(a,`display`,`none`),j(o,`display`,`flex`)}t.playing?c():s(),t.on(`video:playing`,()=>{c()}),t.on(`video:pause`,()=>{s()})}})}function X(e,t){let{$progress:n}=e.template,{left:r}=I(n),i=R((C?t.touches[0].clientX:t.clientX)-r,0,n.clientWidth),a=i/n.clientWidth*e.duration;return{second:a,time:z(a),width:i,percentage:R(i/n.clientWidth,0,1)}}function at(e,t){if(e.isRotate){let n=t.touches[0].clientY/e.height,r=n*e.duration;e.emit(`setBar`,`played`,n,t),e.seek=r}else{let{second:n,percentage:r}=X(e,t);e.emit(`setBar`,`played`,r,t),e.seek=n}}function ot(e){return t=>{let{icons:n,option:r,proxy:i}=t,{$player:a,$progress:o}=t.template;return{...e,html:`
            ...
            `,mounted:e=>{let s=null,c=!1,l=T(`.art-progress-hover`,e),u=T(`.art-progress-loaded`,e),d=T(`.art-progress-played`,e),f=T(`.art-progress-highlight`,e),p=T(`.art-progress-indicator`,e),m=T(`.art-progress-tip`,e);n.indicator?A(p,n.indicator):j(p,`backgroundColor`,`var(--art-theme)`);function ee(n){let{width:r}=X(t,n),{text:i}=n.target.dataset;m.textContent=i;let a=m.clientWidth;r<=a/2?j(m,`left`,0):r>e.clientWidth-a/2?j(m,`left`,`${e.clientWidth-a}px`):j(m,`left`,`${r-a/2}px`)}function h(n,r){let{width:i,time:a}=r||X(t,n);m.textContent=a||`00:00`;let o=m.clientWidth;i<=o/2?j(m,`left`,0):i>e.clientWidth-o/2?j(m,`left`,`${e.clientWidth-o}px`):j(m,`left`,`${i-o/2}px`)}function te(){f.textContent=``;for(let e=0;e<r.highlight.length;e++){let n=r.highlight[e],i=R(n.time,0,t.duration)/t.duration*100,a=`<span data-text="${n.text}" data-time="${n.time}" style="left: ${i}%"></span>`;A(f,a)}}function ne(n,r,i){let o=n===`played`&&i&&C;n===`loaded`&&j(u,`width`,`${r*100}%`),n===`hover`&&(j(l,`width`,`${r*100}%`),P(i,f)?ee(i):h(i),r===0?O(a,`art-progress-hover`):D(a,`art-progress-hover`)),n===`played`&&(j(d,`width`,`${r*100}%`),j(p,`left`,`${r*100}%`)),o&&(D(a,`art-progress-hover`),h(i,{width:e.clientWidth*r,time:z(r*t.duration)}),clearTimeout(s),s=setTimeout(()=>{O(a,`art-progress-hover`)},500))}t.on(`setBar`,ne),t.on(`video:loadedmetadata`,te),t.constructor.USE_RAF?t.on(`raf`,()=>{t.emit(`setBar`,`played`,t.played),t.emit(`setBar`,`loaded`,t.loaded)}):(t.on(`video:timeupdate`,()=>{t.emit(`setBar`,`played`,t.played)}),t.on(`video:progress`,()=>{t.emit(`setBar`,`loaded`,t.loaded)}),t.on(`video:ended`,()=>{t.emit(`setBar`,`played`,1)})),t.emit(`setBar`,`loaded`,t.loaded||0),C||(i(o,`click`,e=>{e.target!==p&&at(t,e)}),i(o,`mousemove`,e=>{let{percentage:n}=X(t,e);t.emit(`setBar`,`hover`,n,e)}),i(o,`mouseleave`,e=>{t.emit(`setBar`,`hover`,0,e)}),i(o,`mousedown`,e=>{c=e.button===0}),t.on(`document:mousemove`,e=>{if(c){let{second:n,percentage:r}=X(t,e);t.emit(`setBar`,`played`,r,e),t.seek=n}}),t.on(`document:mouseup`,()=>{c&&(c=!1)}))}}}}function st(e){return t=>({...e,tooltip:t.i18n.get(`Screenshot`),mounted:e=>{let{proxy:n,icons:r}=t;A(e,r.screenshot),n(e,`click`,()=>{t.screenshot()})}})}function ct(e){return t=>({...e,tooltip:t.i18n.get(`Show Setting`),mounted:e=>{let{proxy:n,icons:r,i18n:i}=t;A(e,r.setting),n(e,`click`,()=>{t.setting.toggle(),t.setting.resize()}),t.on(`setting`,t=>{N(e,i.get(t?`Hide Setting`:`Show Setting`))})}})}function lt(e){return t=>({...e,style:C?{fontSize:`12px`,padding:`0 5px`}:{cursor:`auto`,padding:`0 10px`},mounted:e=>{function n(){let n=`${z(t.currentTime)} / ${z(t.duration)}`;n!==e.textContent&&(e.textContent=n)}n();let r=[`video:loadedmetadata`,`video:timeupdate`,`video:progress`];for(let e=0;e<r.length;e++)t.on(r[e],n)}})}function ut(e){return t=>({...e,mounted:e=>{let{proxy:n,icons:r}=t,i=A(e,r.volume),a=A(e,r.volumeClose),o=A(e,`<div class="art-volume-panel"></div>`),s=A(o,`<div class="art-volume-inner"></div>`),c=A(s,`<div class="art-volume-val"></div>`),l=A(s,`<div class="art-volume-slider"></div>`),u=A(A(l,`<div class="art-volume-handle"></div>`),`<div class="art-volume-loaded"></div>`),d=A(l,`<div class="art-volume-indicator"></div>`);function f(e){let{top:t,height:n}=I(l);return 1-(e.clientY-t)/n}function p(){if(t.muted||t.volume===0)j(i,`display`,`none`),j(a,`display`,`flex`),j(d,`top`,`100%`),j(u,`top`,`100%`),c.textContent=0;else{let e=t.volume*100;j(i,`display`,`flex`),j(a,`display`,`none`),j(d,`top`,`${100-e}%`),j(u,`top`,`${100-e}%`),c.textContent=Math.floor(e)}}if(p(),t.on(`video:volumechange`,p),n(i,`click`,()=>{t.muted=!0}),n(a,`click`,()=>{t.muted=!1}),C)j(o,`display`,`none`);else{let e=!1;n(l,`mousedown`,n=>{e=n.button===0,t.volume=f(n)}),t.on(`document:mousemove`,n=>{e&&(t.muted=!1,t.volume=f(n))}),t.on(`document:mouseup`,()=>{e&&(e=!1)})}}})}var dt=class extends Y{constructor(e){super(e),this.isHover=!1,this.name=`control`,this.timer=Date.now();let{constructor:t}=e,{$player:n,$bottom:r}=this.art.template;e.on(`mousemove`,()=>{C||(this.show=!0)}),e.on(`click`,()=>{C?this.toggle():this.show=!0}),e.on(`document:mousemove`,e=>{this.isHover=P(e,r)}),e.on(`video:timeupdate`,()=>{!e.setting.show&&!this.isHover&&!e.isInput&&e.playing&&this.show&&Date.now()-this.timer>=t.CONTROL_HIDE_TIME&&(this.show=!1)}),e.on(`control`,e=>{e?(O(n,`art-hide-cursor`),D(n,`art-hover`),this.timer=Date.now()):(D(n,`art-hide-cursor`),O(n,`art-hover`))}),this.init()}init(){let{option:e}=this.art;e.isLive||this.add(ot({name:`progress`,position:`top`,index:10})),this.add({name:`thumbnails`,position:`top`,index:20}),this.add(it({name:`playAndPause`,position:`left`,index:10})),this.add(ut({name:`volume`,position:`left`,index:20})),e.isLive||this.add(lt({name:`time`,position:`left`,index:30})),e.quality.length&&H().then(()=>{this.art.quality=e.quality}),e.screenshot&&!C&&this.add(st({name:`screenshot`,position:`right`,index:20})),e.setting&&this.add(ct({name:`setting`,position:`right`,index:30})),e.pip&&this.add(rt({name:`pip`,position:`right`,index:40})),e.airplay&&window.WebKitPlaybackTargetAvailabilityEvent&&this.add(et({name:`airplay`,position:`right`,index:50})),e.fullscreenWeb&&this.add(nt({name:`fullscreenWeb`,position:`right`,index:60})),e.fullscreen&&this.add(tt({name:`fullscreen`,position:`right`,index:70}));for(let t=0;t<e.controls.length;t++)this.add(e.controls[t])}add(e){let t=typeof e==`function`?e(this.art):e,{$progress:n,$controlsLeft:r,$controlsRight:i}=this.art.template;switch(t.position){case`top`:this.$parent=n;break;case`left`:this.$parent=r;break;case`right`:this.$parent=i;break;default:L(!1,`Control option.position must one of 'top', 'left', 'right'`)}super.add(t)}check(e){if(e){e.$control_value.innerHTML=e.html;for(let t=0;t<e.$control_option.length;t++){let n=e.$control_option[t];n.default=n===e,n.default&&M(n.$control_item,`art-current`)}}}selector(e,t,n){let{proxy:r}=this.art.events;D(t,`art-control-selector`);let i=F(`div`);D(i,`art-selector-value`),A(i,e.html),t.textContent=``,A(t,i);let a=F(`div`);D(a,`art-selector-list`),A(t,a);for(let t=0;t<e.selector.length;t++){let n=e.selector[t],r=F(`div`);D(r,`art-selector-item`),n.default&&D(r,`art-current`),r.dataset.index=t,r.dataset.value=n.value,r.innerHTML=n.html,A(a,r),B(n,`$control_option`,{get:()=>e.selector}),B(n,`$control_item`,{get:()=>r}),B(n,`$control_value`,{get:()=>i})}let o=r(a,`click`,async t=>{let n=De(t),r=e.selector.find(e=>e.$control_item===n.find(t=>e.$control_item===t));this.check(r),e.onSelect&&(i.innerHTML=await e.onSelect.call(this.art,r,r.$control_item,t))});n.push(o)}};function ft(e,t){let{constructor:n,template:{$player:r,$video:i}}=e;function a(t){P(t,r)?(e.isInput=t.target.tagName===`INPUT`,e.isFocus=!0,e.emit(`focus`,t)):(e.isInput=!1,e.isFocus=!1,e.emit(`blur`,t))}e.on(`document:click`,a),e.on(`document:contextmenu`,a);let o=[];t.proxy(i,`click`,t=>{let r=Date.now();o.push(r);let{MOBILE_CLICK_PLAY:i,DBCLICK_TIME:a,MOBILE_DBCLICK_PLAY:s,DBCLICK_FULLSCREEN:c}=n,l=o.filter(e=>r-e<=a);switch(l.length){case 1:e.emit(`click`,t),C?!e.isLock&&i&&e.toggle():e.toggle(),o=l;break;case 2:e.emit(`dblclick`,t),C?!e.isLock&&s&&e.toggle():c&&(e.fullscreen=!e.fullscreen),o=[];break;default:o=[]}})}function pt(e,t){return Math.atan2(t,e)*180/Math.PI}function mt(e,t,n,r){let i=t-r,a=n-e,o=0;if(Math.abs(a)<2&&Math.abs(i)<2)return o;let s=pt(a,i);return s>=-45&&s<45?o=4:s>=45&&s<135?o=1:s>=-135&&s<-45?o=2:(s>=135&&s<=180||s>=-180&&s<-135)&&(o=3),o}function ht(e,t){if(C&&!e.option.isLive){let{$video:n,$progress:r}=e.template,i=null,a=!1,o=0,s=0,c=0,l=t=>{if(t.touches.length===1&&!e.isLock){i===r&&at(e,t),a=!0;let{pageX:n,pageY:l}=t.touches[0];o=n,s=l,c=e.currentTime}},u=t=>{if(t.touches.length===1&&a&&e.duration){let{pageX:r,pageY:a}=t.touches[0],l=mt(o,s,r,a),u=[3,4].includes(l),d=[1,2].includes(l);if(u&&!e.isRotate||d&&e.isRotate){let l=R((r-o)/e.width,-1,1),u=R((a-s)/e.height,-1,1),d=e.isRotate?u:l,f=i===n?e.constructor.TOUCH_MOVE_RATIO:1,p=R(c+e.duration*d*f,0,e.duration);e.seek=p,e.emit(`setBar`,`played`,R(p/e.duration,0,1),t),e.notice.show=`${z(p)} / ${z(e.duration)}`}}};e.option.gesture&&(t.proxy(n,`touchstart`,e=>{i=n,l(e)}),t.proxy(n,`touchmove`,u)),t.proxy(r,`touchstart`,e=>{i=r,l(e)}),t.proxy(r,`touchmove`,u),e.on(`document:touchend`,()=>{a&&(o=0,s=0,c=0,a=!1,i=null)})}}function gt(e,t){let n=[`click`,`mouseup`,`keydown`,`touchend`,`touchmove`,`mousemove`,`pointerup`,`contextmenu`,`pointermove`,`visibilitychange`,`webkitfullscreenchange`],r=[`resize`,`scroll`,`orientationchange`],i=[];function a(a={}){for(let e=0;e<i.length;e++)t.remove(i[e]);i.length=0;let{$player:o}=e.template;n.forEach(n=>{let r=a.document||o.ownerDocument||document,s=t.proxy(r,n,t=>{e.emit(`document:${n}`,t)});i.push(s)}),r.forEach(n=>{let r=a.window||o.ownerDocument?.defaultView||window,s=t.proxy(r,n,t=>{e.emit(`window:${n}`,t)});i.push(s)})}a(),t.bindGlobalEvents=a}function _t(e,t){let{$player:n}=e.template;t.hover(n,t=>{D(n,`art-hover`),e.emit(`hover`,!0,t)},t=>{O(n,`art-hover`),e.emit(`hover`,!1,t)})}function vt(e,t){let{$player:n}=e.template;t.proxy(n,`mousemove`,t=>{e.emit(`mousemove`,t)})}function yt(e,t){let{option:n,constructor:r}=e;e.on(`resize`,()=>{let{aspectRatio:t,notice:r}=e;e.state===`standard`&&n.autoSize&&e.autoSize(),e.aspectRatio=t,r.show=``});let i=Ve(()=>e.emit(`resize`),r.RESIZE_TIME);e.on(`window:orientationchange`,()=>i()),e.on(`window:resize`,()=>i()),screen&&screen.orientation&&screen.orientation.onchange&&t.proxy(screen.orientation,`change`,()=>i())}function bt(e){if(e.constructor.USE_RAF){let t=null;(function n(){e.playing&&e.emit(`raf`),e.isDestroy||(t=requestAnimationFrame(n))})(),e.on(`destroy`,()=>{cancelAnimationFrame(t)})}}function xt(e){let{option:t,constructor:n,template:{$container:r}}=e,i=He(()=>{e.emit(`view`,xe(r,n.SCROLL_GAP))},n.SCROLL_TIME);e.on(`window:scroll`,()=>i()),e.on(`view`,n=>{t.autoMini&&(e.mini=!n)})}var St=class{constructor(e){this.destroyEvents=new Set,this.proxy=this.proxy.bind(this),this.hover=this.hover.bind(this),ft(e,this),_t(e,this),vt(e,this),yt(e,this),ht(e,this),xt(e),gt(e,this),bt(e)}proxy(e,t,n,r={}){if(Array.isArray(t))return t.map(t=>this.proxy(e,t,n,r));e.addEventListener(t,n,r);let i=()=>e.removeEventListener(t,n,r);return this.destroyEvents.add(i),i}hover(e,t,n){t&&this.proxy(e,`mouseenter`,t),n&&this.proxy(e,`mouseleave`,n)}remove(e){if(this.destroyEvents.has(e))try{e()}catch(e){console.warn(`Failed to remove event listener:`,e)}finally{this.destroyEvents.delete(e)}}destroy(){for(let e of this.destroyEvents)try{e()}catch(e){console.warn(`Failed to destroy event listener:`,e)}this.destroyEvents.clear()}},Ct=class{constructor(e){this.art=e,this.keys={},C||this.init()}init(){let{constructor:e}=this.art;this.art.option.hotkey&&(this.add(`Escape`,()=>{this.art.fullscreenWeb&&(this.art.fullscreenWeb=!1)}),this.add(`Space`,()=>{this.art.toggle()}),this.add(`ArrowLeft`,()=>{this.art.backward=e.SEEK_STEP}),this.add(`ArrowUp`,()=>{this.art.volume+=e.VOLUME_STEP}),this.add(`ArrowRight`,()=>{this.art.forward=e.SEEK_STEP}),this.add(`ArrowDown`,()=>{this.art.volume-=e.VOLUME_STEP})),this.art.on(`document:keydown`,e=>{if(this.art.isFocus){let t=document.activeElement.tagName.toUpperCase(),n=document.activeElement.getAttribute(`contenteditable`);if(t!==`INPUT`&&t!==`TEXTAREA`&&n!==``&&n!==`true`&&!e.altKey&&!e.ctrlKey&&!e.metaKey&&!e.shiftKey){let t=this.keys[e.code];if(t){e.preventDefault();for(let n=0;n<t.length;n++)t[n].call(this.art,e);this.art.emit(`hotkey`,e)}}}this.art.emit(`keydown`,e)})}add(e,t){return this.keys[e]?this.keys[e].includes(t)||this.keys[e].push(t):this.keys[e]=[t],this}remove(e,t){if(this.keys[e]){let n=this.keys[e].indexOf(t);n!==-1&&this.keys[e].splice(n,1),this.keys[e].length===0&&delete this.keys[e]}return this}},wt={"Video Info":`统计信息`,Close:`关闭`,"Video Load Failed":`加载失败`,Volume:`音量`,Play:`播放`,Pause:`暂停`,Rate:`速度`,Mute:`静音`,"Video Flip":`画面翻转`,Horizontal:`水平`,Vertical:`垂直`,Reconnect:`重新连接`,"Show Setting":`显示设置`,"Hide Setting":`隐藏设置`,Screenshot:`截图`,"Play Speed":`播放速度`,"Aspect Ratio":`画面比例`,Default:`默认`,Normal:`正常`,Open:`打开`,"Switch Video":`切换`,"Switch Subtitle":`切换字幕`,Fullscreen:`全屏`,"Exit Fullscreen":`退出全屏`,"Web Fullscreen":`网页全屏`,"Exit Web Fullscreen":`退出网页全屏`,"Mini Player":`迷你播放器`,"PIP Mode":`开启画中画`,"Exit PIP Mode":`退出画中画`,"PIP Not Supported":`不支持画中画`,"Fullscreen Not Supported":`不支持全屏`,"Subtitle Offset":`字幕偏移`,"Last Seen":`上次看到`,"Jump Play":`跳转播放`,AirPlay:`隔空播放`,"AirPlay Not Available":`隔空播放不可用`};typeof window<`u`&&(window[`artplayer-i18n-zh-cn`]=wt);var Tt=class{constructor(e){this.art=e,this.languages={"zh-cn":wt},this.language={},this.update(e.option.i18n)}init(){let e=this.art.option.lang.toLowerCase();this.language=this.languages[e]||{}}get(e){return this.language[e]||e}update(e){this.languages=Ie(this.languages,e),this.init()}},Et=`<svg width="18px" height="18px" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
    <g>
...
</svg>`,$t=class{constructor(e){let t={loading:zt,state:qt,play:Ut,pause:Vt,check:At,volume:Qt,volumeClose:Zt,screenshot:Gt,setting:Kt,pip:Ht,arrowLeft:Dt,arrowRight:Ot,playbackRate:Wt,aspectRatio:kt,config:Mt,lock:Bt,flip:Pt,unlock:Xt,fullscreenOff:Ft,fullscreenOn:It,fullscreenWebOff:Lt,fullscreenWebOn:Rt,switchOn:Yt,switchOff:Jt,error:Nt,close:jt,airplay:Et,...e.option.icons};for(let e in t)B(this,e,{get:()=>Ce(e,t[e])})}},en=class extends Y{constructor(e){super(e),this.name=`info`,C||this.init()}init(){let{proxy:e,constructor:t,template:{$infoPanel:n,$infoClose:r,$video:i}}=this.art;e(r,`click`,()=>{this.show=!1});let a=null,o=E(`[data-video]`,n)||[];this.art.on(`destroy`,()=>clearTimeout(a));function s(){for(let e=0;e<o.length;e++){let t=o[e],n=i[t.dataset.video],r=typeof n==`number`?n.toFixed(2):n;t.textContent!==r&&(t.textContent=r)}a=setTimeout(s,t.INFO_LOOP_TIME)}s()}},tn=class extends Y{constructor(e){super(e);let{option:t,template:{$layer:n}}=e;this.name=`layer`,this.$parent=n;for(let e=0;e<t.layers.length;e++)this.add(t.layers[e])}},nn=class extends Y{constructor(e){super(e),this.name=`loading`,A(e.template.$loading,e.icons.loading)}},rn=class extends Y{constructor(e){super(e),this.name=`mask`;let{template:t,icons:n,events:r}=e,i=A(t.$state,n.state),a=A(t.$state,n.error);j(a,`display`,`none`),e.on(`destroy`,()=>{j(i,`display`,`none`),j(a,`display`,null)}),r.proxy(t.$state,`click`,()=>e.play())}},an=class{constructor(e){this.art=e,this.timer=null,e.on(`destroy`,()=>this.destroy())}destroy(){this.timer&&(clearTimeout(this.timer),this.timer=null)}set show(e){let{constructor:t,template:{$player:n,$noticeInner:r}}=this.art;e?(r.textContent=e instanceof Error?e.message.trim():e,D(n,`art-notice-show`),clearTimeout(this.timer),this.timer=setTimeout(()=>{r.textContent=``,O(n,`art-notice-show`)},t.NOTICE_TIME)):O(n,`art-notice-show`)}get show(){let{template:{$player:e}}=this.art;return e.classList.contains(`art-notice-show`)}};function on(e){let{i18n:t,notice:n,proxy:r,template:{$video:i}}=e,a=!0;window.WebKitPlaybackTargetAvailabilityEvent&&i.webkitShowPlaybackTargetPicker?r(i,`webkitplaybacktargetavailabilitychanged`,e=>{switch(e.availability){case`available`:a=!0;break;case`not-available`:a=!1}}):a=!1,B(e,`airplay`,{value(){a?(i.webkitShowPlaybackTargetPicker(),e.emit(`airplay`)):n.show=t.get(`AirPlay Not Available`)}})}function sn(e){let{i18n:t,notice:n,template:{$video:r,$player:i}}=e;B(e,`aspectRatio`,{get(){return i.dataset.aspectRatio||`default`},set(a){if(a||(a=`default`),a==="default")j(r,`width`,null),j(r,`height`,null),j(r,`margin`,null),delete i.dataset.aspectRatio;else{let e=a.split(`:`).map(Number),{clientWidth:t,clientHeight:n}=i,o=t/n,s=e[0]/e[1];o>s?(j(r,`width`,`${s*n}px`),j(r,`height`,`100%`),j(r,`margin`,`0 auto`)):(j(r,`width`,`100%`),j(r,`height`,`${t/s}px`),j(r,`margin`,`auto 0`)),i.dataset.aspectRatio=a}n.show=`${t.get(`Aspect Ratio`)}: ${a==="default"?t.get(`Default`):a}`,e.emit(`aspectRatio`,a)}})}function cn(e){let{template:{$video:t}}=e;B(e,`attr`,{value(e,n){if(n===void 0)return t[e];t[e]=n}})}function ln(e){let{template:{$container:t,$video:n}}=e;B(e,`autoHeight`,{value(){let{clientWidth:r}=t,{videoHeight:i,videoWidth:a}=n,o=r/a*i;j(t,`height`,`${o}px`),e.emit(`autoHeight`,o)}})}function un(e){let{$container:t,$player:n,$video:r}=e.template;B(e,`autoSize`,{value(){let{videoWidth:i,videoHeight:a}=r,{width:o,height:s}=I(t),c=i/a;if(o/s>c){let e=s*c/o*100;j(n,`width`,`${e}%`),j(n,`height`,`100%`)}else{let e=o/c/s*100;j(n,`width`,`100%`),j(n,`height`,`${e}%`)}e.emit(`autoSize`,{width:e.width,height:e.height})}})}function dn(e){let{$player:t}=e.template;B(e,`cssVar`,{value(e,n){return n?t.style.setProperty(e,n):getComputedStyle(t).getPropertyValue(e)}})}function fn(e){let{$video:t}=e.template;B(e,`currentTime`,{get:()=>t.currentTime||0,set:n=>{n=Number.parseFloat(n),!Number.isNaN(n)&&(t.currentTime=R(n,0,e.duration))}})}function pn(e){B(e,`duration`,{get:()=>{let{duration:t}=e.template.$video;return t===1/0?0:t||0}})}function mn(e){let{i18n:t,notice:n,option:r,constructor:i,proxy:a,template:{$player:o,$video:s,$poster:c}}=e,l=0;for(let t=0;t<y.events.length;t++)a(s,y.events[t],t=>{e.emit(`video:${t.type}`,t)});e.on(`video:canplay`,()=>{l=0,e.loading.show=!1}),e.once(`video:canplay`,()=>{e.loading.show=!1,e.controls.show=!0,e.mask.show=!0,e.isReady=!0,e.emit(`ready`)}),e.on(`video:ended`,()=>{r.loop?(e.seek=0,e.play(),e.controls.show=!1,e.mask.show=!1):(e.controls.show=!0,e.mask.show=!0)}),e.on(`video:error`,async a=>{l<i.RECONNECT_TIME_MAX?(await H(i.RECONNECT_SLEEP_TIME),l+=1,e.url=r.url,n.show=`${t.get(`Reconnect`)}: ${l}`,e.emit(`error`,a,l)):(e.mask.show=!0,e.loading.show=!1,e.controls.show=!0,D(o,`art-error`),await H(i.RECONNECT_SLEEP_TIME),n.show=t.get(`Video Load Failed`))}),e.on(`video:loadedmetadata`,()=>{e.emit(`resize`),C&&(e.loading.show=!1,e.controls.show=!0,e.mask.show=!0)}),e.on(`video:loadstart`,()=>{e.loading.show=!0,e.mask.show=!1,e.controls.show=!0}),e.on(`video:pause`,()=>{e.controls.show=!0,e.mask.show=!0}),e.on(`video:play`,()=>{e.mask.show=!1,j(c,`display`,`none`)}),e.on(`video:playing`,()=>{e.mask.show=!1}),e.on(`video:progress`,()=>{e.playing&&(e.loading.show=!1)}),e.on(`video:seeked`,()=>{e.loading.show=!1,e.mask.show=!0}),e.on(`video:seeking`,()=>{e.loading.show=!0,e.mask.show=!1}),e.on(`video:timeupdate`,()=>{e.mask.show=!1}),e.on(`video:waiting`,()=>{e.loading.show=!0,e.mask.show=!1})}function hn(e){let{template:{$player:t},i18n:n,notice:r}=e;B(e,`flip`,{get(){return t.dataset.flip||`normal`},set(i){i||(i=`normal`),i===`normal`?delete t.dataset.flip:t.dataset.flip=i,r.show=`${n.get(`Video Flip`)}: ${n.get(je(i))}`,e.emit(`flip`,i)}})}var gn=[[`requestFullscreen`,`exitFullscreen`,`fullscreenElement`,`fullscreenEnabled`,`fullscreenchange`,`fullscreenerror`],[`webkitRequestFullscreen`,`webkitExitFullscreen`,`webkitFullscreenElement`,`webkitFullscreenEnabled`,`webkitfullscreenchange`,`webkitfullscreenerror`],[`webkitRequestFullScreen`,`webkitCancelFullScreen`,`webkitCurrentFullScreenElement`,`webkitCancelFullScreen`,`webkitfullscreenchange`,`webkitfullscreenerror`],[`mozRequestFullScreen`,`mozCancelFullScreen`,`mozFullScreenElement`,`mozFullScreenEnabled`,`mozfullscreenchange`,`mozfullscreenerror`],[`msRequestFullscreen`,`msExitFullscreen`,`msFullscreenElement`,`msFullscreenEnabled`,`MSFullscreenChange`,`MSFullscreenError`]],Z=(()=>{if(typeof document>`u`)return!1;let e=gn[0],t={};for(let n of gn)if(n[1]in document){for(let[r,i]of n.entries())t[e[r]]=i;return t}return!1})(),_n={change:Z.fullscreenchange,error:Z.fullscreenerror},Q={request(e=document.documentElement,t){return new Promise((n,r)=>{let i=()=>{Q.off(`change`,i),n()};Q.on(`change`,i);let a=e[Z.requestFullscreen](t);a instanceof Promise&&a.then(i).catch(r)})},exit(){return new Promise((e,t)=>{if(!Q.isFullscreen){e();return}let n=()=>{Q.off(`change`,n),e()};Q.on(`change`,n);let r=document[Z.exitFullscreen]();r instanceof Promise&&r.then(n).catch(t)})},toggle(e,t){return Q.isFullscreen?Q.exit():Q.request(e,t)},onchange(e){Q.on(`change`,e)},onerror(e){Q.on(`error`,e)},on(e,t){let n=_n[e];n&&document.addEventListener(n,t,!1)},off(e,t){let n=_n[e];n&&document.removeEventListener(n,t,!1)},raw:Z};Object.defineProperties(Q,{isFullscreen:{get:()=>!!document[Z.fullscreenElement]},element:{enumerable:!0,get:()=>document[Z.fullscreenElement]},isEnabled:{enumerable:!0,get:()=>!!document[Z.fullscreenEnabled]}});function vn(e){let{i18n:t,notice:n,template:{$video:r,$player:i}}=e,a=e=>{Q.on(`change`,()=>{e.emit(`fullscreen`,Q.isFullscreen),Q.isFullscreen?(e.state=`fullscreen`,D(i,`art-fullscreen`)):O(i,`art-fullscreen`),e.emit(`resize`)}),Q.on(`error`,t=>{e.emit(`fullscreenError`,t)}),B(e,`fullscreen`,{get(){return Q.isFullscreen},async set(e){e?await Q.request(i):await Q.exit()}})},o=e=>{e.on(`document:webkitfullscreenchange`,()=>{e.emit(`fullscreen`,e.fullscreen),e.emit(`resize`)}),B(e,`fullscreen`,{get(){return document.fullscreenElement===r},set(t){t?(e.state=`fullscreen`,r.webkitEnterFullscreen()):r.webkitExitFullscreen()}})};e.once(`video:loadedmetadata`,()=>{Q.isEnabled?a(e):r.webkitSupportsFullscreen?o(e):B(e,`fullscreen`,{get(){return!1},set(){n.show=t.get(`Fullscreen Not Supported`)}}),B(e,`fullscreen`,Fe(e,`fullscreen`))})}function yn(e){let{constructor:t,template:{$container:n,$player:r}}=e,i=``;B(e,`fullscreenWeb`,{get(){return k(r,`art-fullscreen-web`)},set(a){a?(i=r.style.cssText,t.FULLSCREEN_WEB_IN_BODY&&A(document.body,r),e.state=`fullscreenWeb`,j(r,`width`,`100%`),j(r,`height`,`100%`),D(r,`art-fullscreen-web`),e.emit(`fullscreenWeb`,!0)):(t.FULLSCREEN_WEB_IN_BODY&&A(n,r),i&&(r.style.cssText=i,i=``),O(r,`art-fullscreen-web`),e.emit(`fullscreenWeb`,!1)),e.emit(`resize`)}})}function bn(e){let{$video:t}=e.template;B(e,`loaded`,{get:()=>e.loadedTime/t.duration}),B(e,`loadedTime`,{get:()=>t.buffered.length?t.buffered.end(t.buffered.length-1):0})}function xn(e){let{icons:t,proxy:n,storage:r,template:{$player:i,$video:a}}=e,o=!1,s=0,c=0;function l(){let{$mini:t}=e.template;t&&(O(i,`art-mini`),j(t,`display`,`none`),i.prepend(a),e.emit(`mini`,!1))}function u(t,n){e.playing?(j(t,`display`,`none`),j(n,`display`,`flex`)):(j(t,`display`,`flex`),j(n,`display`,`none`))}function d(){let{$mini:i}=e.template;if(i)return A(i,a),j(i,`display`,`flex`);{let i=F(`div`);D(i,`art-mini-popup`),A(document.body,i),e.template.$mini=i,A(i,a);let d=A(i,`<div class="art-mini-close"></div>`);A(d,t.close),n(d,`click`,l);let f=A(i,`<div class="art-mini-state"></div>`),p=A(f,t.play),m=A(f,t.pause);return n(p,`click`,()=>e.play()),n(m,`click`,()=>e.pause()),u(p,m),e.on(`video:playing`,()=>u(p,m)),e.on(`video:pause`,()=>u(p,m)),e.on(`video:timeupdate`,()=>u(p,m)),n(i,`mousedown`,e=>{o=e.button===0,s=e.pageX,c=e.pageY}),e.on(`document:mousemove`,e=>{if(o){D(i,`art-mini-dragging`);let t=e.pageX-s,n=e.pageY-c;j(i,`transform`,`translate(${t}px, ${n}px)`)}}),e.on(`document:mouseup`,()=>{if(o){o=!1,O(i,`art-mini-dragging`);let e=I(i);r.set(`left`,e.left),r.set(`top`,e.top),j(i,`left`,`${e.left}px`),j(i,`top`,`${e.top}px`),j(i,`transform`,null)}}),i}}function f(){let{$mini:t}=e.template,n=I(t),i=window.innerHeight-n.height-50,a=window.innerWidth-n.width-50;r.set(`top`,i),r.set(`left`,a),j(t,`top`,`${i}px`),j(t,`left`,`${a}px`)}B(e,`mini`,{get(){return k(i,`art-mini`)},set(t){if(t){e.state=`mini`,D(i,`art-mini`);let t=d(),n=r.get(`top`),a=r.get(`left`);typeof n==`number`&&typeof a==`number`?(j(t,`top`,`${n}px`),j(t,`left`,`${a}px`),xe(t)||f()):f(),e.emit(`mini`,!0)}else l()}})}function Sn(e){let{option:t,storage:n,template:{$video:r,$poster:i}}=e;for(let n in t.moreVideoAttr)e.attr(n,t.moreVideoAttr[n]);t.muted&&(e.muted=t.muted),t.volume&&(r.volume=R(t.volume,0,1));let a=n.get(`volume`);typeof a==`number`&&(r.volume=R(a,0,1)),t.poster&&j(i,`backgroundImage`,`url(${t.poster})`),t.autoplay&&(r.autoplay=t.autoplay),t.playsInline&&(r.playsInline=!0,r[`webkit-playsinline`]=!0),t.theme&&(t.cssVar[`--art-theme`]=t.theme);for(let n in t.cssVar)e.cssVar(n,t.cssVar[n]);e.url=t.url}function Cn(e){let{template:{$video:t},i18n:n,notice:r}=e;B(e,`pause`,{value(){let i=t.pause();return r.show=n.get(`Pause`),e.emit(`pause`),i}})}function wn(e){let{template:{$video:t},proxy:n,notice:r}=e;t.disablePictureInPicture=!1,B(e,`pip`,{get(){return document.pictureInPictureElement},set(n){n?(e.state=`pip`,t.requestPictureInPicture().catch(e=>{throw r.show=e,e})):document.exitPictureInPicture().catch(e=>{throw r.show=e,e})}}),n(t,`enterpictureinpicture`,()=>{e.emit(`pip`,!0)}),n(t,`leavepictureinpicture`,()=>{e.emit(`pip`,!1)})}function Tn(e){let{$video:t}=e.template;t.webkitSetPresentationMode(`inline`),B(e,`pip`,{get(){return t.webkitPresentationMode===`picture-in-picture`},set(n){n?(e.state=`pip`,t.webkitSetPresentationMode(`picture-in-picture`),e.emit(`pip`,!0)):(t.webkitSetPresentationMode(`inline`),e.emit(`pip`,!1))}})}function En(e){let{i18n:t,notice:n,template:{$video:r}}=e;document.pictureInPictureEnabled?wn(e):r.webkitSupportsPresentationMode?Tn(e):B(e,`pip`,{get(){return!1},set(){n.show=t.get(`PIP Not Supported`)}})}function Dn(e){let{template:{$video:t},i18n:n,notice:r}=e;B(e,`playbackRate`,{get(){return t.playbackRate},set(i){if(i){if(i===t.playbackRate)return;t.playbackRate=i,r.show=`${n.get(`Rate`)}: ${i===1?n.get(`Normal`):`${i}x`}`}else e.playbackRate=1}})}function On(e){B(e,`played`,{get:()=>e.currentTime/e.duration})}function kn(e){let{$video:t}=e.template;B(e,`playing`,{get:()=>typeof t.playing==`boolean`?t.playing:t.currentTime>0&&!t.paused&&!t.ended&&t.readyState>2})}function An(e){let{i18n:t,notice:n,option:r,constructor:{instances:i},template:{$video:a}}=e;B(e,`play`,{async value(){let o=await a.play();if(n.show=t.get(`Play`),e.emit(`play`),r.mutex)for(let t=0;t<i.length;t++){let n=i[t];n!==e&&n.pause()}return o}})}function jn(e){let{template:{$poster:t}}=e;B(e,`poster`,{get:()=>{try{return t.style.backgroundImage.match(/"(.*)"/)[1]}catch{return``}},set(e){j(t,`backgroundImage`,`url(${e})`)}})}function Mn(e){B(e,`quality`,{set(t){let{controls:n,notice:r,i18n:i}=e,a=t.find(e=>e.default)||t[0];n.update({name:`quality`,position:`right`,index:10,style:{marginRight:`10px`},html:a?.html||``,selector:t,async onSelect(t){return await e.switchQuality(t.url),r.show=`${i.get(`Switch Video`)}: ${t.html}`,t.html}})}})}function Nn(e){B(e,`rect`,{get:()=>I(e.template.$player)});let t=[`bottom`,`height`,`left`,`right`,`top`,`width`];for(let n=0;n<t.length;n++){let r=t[n];B(e,r,{get:()=>e.rect[r]})}B(e,`x`,{get:()=>e.left+window.pageXOffset}),B(e,`y`,{get:()=>e.top+window.pageYOffset})}function Pn(e){let{notice:t,template:{$video:n}}=e,r=F(`canvas`);B(e,`getDataURL`,{value:()=>new Promise((e,i)=>{try{r.width=n.videoWidth,r.height=n.videoHeight,r.getContext(`2d`).drawImage(n,0,0),e(r.toDataURL(`image/png`))}catch(e){t.show=e,i(e)}})}),B(e,`getBlobUrl`,{value:()=>new Promise((e,i)=>{try{r.width=n.videoWidth,r.height=n.videoHeight,r.getContext(`2d`).drawImage(n,0,0),r.toBlob(t=>{e(URL.createObjectURL(t))})}catch(e){t.show=e,i(e)}})}),B(e,`screenshot`,{value:async t=>{let r=await e.getDataURL();return Ae(r,`${t||`artplayer_${z(n.currentTime)}`}.png`),e.emit(`screenshot`,r),r}})}function Fn(e){let{notice:t}=e;B(e,`seek`,{set(n){e.currentTime=n,e.duration&&(t.show=`${z(e.currentTime)} / ${z(e.duration)}`),e.emit(`seek`,e.currentTime,n)}}),B(e,`forward`,{set(t){e.seek=e.currentTime+t}}),B(e,`backward`,{set(t){e.seek=e.currentTime-t}})}function In(e){let t=[`mini`,`pip`,`fullscreen`,`fullscreenWeb`];B(e,`state`,{get:()=>t.find(t=>e[t])||`standard`,set(n){for(let r=0;r<t.length;r++){let i=t[r];i!==n&&e[i]&&(e[i]=!1)}}})}function Ln(e){let{notice:t,i18n:n,template:r}=e;B(e,`subtitleOffset`,{get(){return r.$track?.offset||0},set(i){let{cues:a}=e.subtitle;if(!r.$track||a.length===0)return;let o=R(i,-10,10);r.$track.offset=o;for(let t=0;t<a.length;t++){let n=a[t];n.originalStartTime=n.originalStartTime??n.startTime,n.originalEndTime=n.originalEndTime??n.endTime,n.startTime=R(n.originalStartTime+o,0,e.duration),n.endTime=R(n.originalEndTime+o,0,e.duration)}e.subtitle.update(),t.show=`${n.get(`Subtitle Offset`)}: ${i}s`,e.emit(`subtitleOffset`,i)}})}function Rn(e){function t(t,n){return new Promise((r,i)=>{if(t===e.url){r();return}let{playing:a,aspectRatio:o,playbackRate:s}=e;e.pause(),e.url=t,e.notice.show=``;let c={};c.error=t=>{e.off(`video:canplay`,c.canplay),e.off(`video:loadedmetadata`,c.metadata),i(t)},c.metadata=()=>{e.currentTime=n},c.canplay=async()=>{e.off(`video:error`,c.error),e.playbackRate=s,e.aspectRatio=o,a&&await e.play(),e.notice.show=``,r()},e.once(`video:error`,c.error),e.once(`video:loadedmetadata`,c.metadata),e.once(`video:canplay`,c.canplay)})}B(e,`switchQuality`,{value:n=>t(n,e.currentTime)}),B(e,`switchUrl`,{value:e=>t(e,0)}),B(e,`switch`,{set:e.switchUrl})}function zn(e){B(e,`theme`,{get(){return e.cssVar(`--art-theme`)},set(t){e.cssVar(`--art-theme`,t)}})}function Bn(e){let{option:t,template:{$progress:n,$video:r}}=e,i=null,a=!1,o=null;function s(){clearTimeout(i),i=null,a=!1,o=null}function c(i){let a=e.controls?.thumbnails;if(!a)return;let{number:s,column:c,width:l,height:u,scale:d}=t.thumbnails,f=l*d||o.naturalWidth/c,p=u*d||f/(r.videoWidth/r.videoHeight),m=n.clientWidth/s,ee=Math.floor(i/m),h=Math.ceil(ee/c)-1,te=ee%c||c-1;j(a,`backgroundImage`,`url(${o.src})`),j(a,`height`,`${p}px`),j(a,`width`,`${f}px`),j(a,`backgroundPosition`,`-${te*f}px -${h*p}px`),i<=f/2?j(a,`left`,0):i>n.clientWidth-f/2?j(a,`left`,`${n.clientWidth-f}px`):j(a,`left`,`${i-f/2}px`)}e.on(`setBar`,async(r,i,s)=>{let l=e.controls?.thumbnails,{url:u,scale:d}=t.thumbnails;if(!(!l||!u)&&(r===`hover`||r===`played`&&s&&C)){if(!o&&!a&&(a=!0,o=await Ee(u,d),a=!1),!o)return;let e=n.clientWidth*i;e>0&&e<n.clientWidth&&c(e)}}),B(e,`thumbnails`,{get(){return e.option.thumbnails},set(t){t.url&&!e.option.isLive&&(e.option.thumbnails=t,s())}})}function Vn(e){B(e,`toggle`,{value(){return e.playing?e.pause():e.play()}})}function Hn(e){B(e,`type`,{get(){return e.option.type},set(t){e.option.type=t}})}function Un(e){let{option:t,template:{$video:n}}=e;B(e,`url`,{get(){return n.src},async set(r){if(r){let i=e.url,a=t.type||ke(r),o=t.customType[a];a&&o?(await H(),e.loading.show=!0,o.call(e,n,r,e)):(URL.revokeObjectURL(i),n.src=r),i!==e.url&&(e.option.url=r,e.isReady&&i&&e.once(`video:canplay`,()=>{e.emit(`restart`,r)}))}else await H(),e.loading.show=!0}})}function Wn(e){let{template:{$video:t},i18n:n,notice:r,storage:i}=e;B(e,`volume`,{get:()=>t.volume||0,set:e=>{t.volume=R(e,0,1),r.show=`${n.get(`Volume`)}: ${Number.parseInt(t.volume*100,10)}`,t.volume!==0&&i.set(`volume`,t.volume)}}),B(e,`muted`,{get:()=>t.muted,set:n=>{t.muted=n,e.emit(`muted`,n)}})}var Gn=class{constructor(e){Un(e),cn(e),An(e),Cn(e),Vn(e),Fn(e),Wn(e),fn(e),pn(e),Rn(e),Dn(e),sn(e),Pn(e),vn(e),yn(e),En(e),bn(e),On(e),kn(e),un(e),Nn(e),hn(e),xn(e),jn(e),ln(e),dn(e),zn(e),Hn(e),In(e),Ln(e),on(e),Mn(e),Bn(e),mn(e),Sn(e)}};function Kn(e){let{notice:t,constructor:n,template:{$player:r,$video:i}}=e,a=`art-auto-orientation`,o=`art-auto-orientation-fullscreen`,s=!1;function c(){let t=document.documentElement.clientWidth,n=document.documentElement.clientHeight;j(r,`width`,`${n}px`),j(r,`height`,`${t}px`),j(r,`transform-origin`,`0 0`),j(r,`transform`,`rotate(90deg) translate(0, -${t}px)`),D(r,a),e.isRotate=!0,e.emit(`resize`)}function l(){j(r,`width`,``),j(r,`height`,``),j(r,`transform-origin`,``),j(r,`transform`,``),O(r,a),e.isRotate=!1,e.emit(`resize`)}function u(){let{videoWidth:e,videoHeight:t}=i,n=document.documentElement.clientWidth,r=document.documentElement.clientHeight;return e>t&&n<r||e<t&&n>r}return e.on(`fullscreenWeb`,t=>{if(t){if(u()){let t=Number(n.AUTO_ORIENTATION_TIME??0);setTimeout(()=>{e.fullscreenWeb&&!k(r,a)&&c()},t)}}else k(r,a)&&l()}),e.on(`fullscreen`,async e=>{let n=!!screen?.orientation?.lock;if(e){if(n&&u())try{let e=screen.orientation.type.startsWith(`portrait`)?`landscape`:`portrait`;await screen.orientation.lock(e),s=!0,D(r,o)}catch(e){s=!1,t.show=e}}else if(k(r,o)&&O(r,o),n&&s){try{screen.orientation.unlock()}catch{}s=!1}}),{name:`autoOrientation`,get state(){return k(r,a)}}}function qn(e){let{i18n:t,icons:n,storage:r,constructor:i,proxy:a,template:{$poster:o}}=e,s=e.layers.add({name:`auto-playback`,html:`
            <div class="art-auto-playback-close"></div>
            <div class="art-auto-playback-last"></div>
            <div class="art-auto-playback-jump"></div>
        `}),c=T(`.art-auto-playback-last`,s),l=T(`.art-auto-playback-jump`,s),u=T(`.art-auto-playback-close`,s);A(u,n.close);let d=null;e.on(`video:timeupdate`,()=>{if(e.playing){let t=r.get(`times`)||{},n=Object.keys(t);n.length>i.AUTO_PLAYBACK_MAX&&delete t[n[0]],t[e.option.id||e.option.url]=e.currentTime,r.set(`times`,t)}});function f(){let n=(r.get(`times`)||{})[e.option.id||e.option.url];clearTimeout(d),j(s,`display`,`none`),n&&n>=i.AUTO_PLAYBACK_MIN&&(j(s,`display`,`flex`),c.textContent=`${t.get(`Last Seen`)} ${z(n)}`,l.textContent=t.get(`Jump Play`),a(u,`click`,()=>{j(s,`display`,`none`)}),a(l,`click`,()=>{e.seek=n,e.play(),j(o,`display`,`none`),j(s,`display`,`none`)}),e.once(`video:timeupdate`,()=>{d=setTimeout(()=>{j(s,`display`,`none`)},i.AUTO_PLAYBACK_TIMEOUT)}))}return e.on(`ready`,f),e.on(`restart`,f),{name:`auto-playback`,get times(){return r.get(`times`)||{}},clear(){return r.del(`times`)},delete(e){let t=r.get(`times`)||{};return delete t[e],r.set(`times`,t),t}}}function Jn(e){let{constructor:t,proxy:n,template:{$player:r,$video:i}}=e,a=null,o=!1,s=1,c=n=>{n.touches.length===1&&e.playing&&!e.isLock&&(a=setTimeout(()=>{o=!0,s=e.playbackRate,e.playbackRate=t.FAST_FORWARD_VALUE,D(r,`art-fast-forward`)},t.FAST_FORWARD_TIME))},l=()=>{clearTimeout(a),o&&(o=!1,e.playbackRate=s,O(r,`art-fast-forward`))};return n(i,`touchstart`,c),e.on(`document:touchmove`,l),e.on(`document:touchend`,l),{name:`fastForward`,get state(){return k(r,`art-fast-forward`)}}}function Yn(e){let{layers:t,icons:n,template:{$player:r}}=e;function i(){return k(r,`art-lock`)}function a(){D(r,`art-lock`),e.isLock=!0,e.emit(`lock`,!0)}function o(){O(r,`art-lock`),e.isLock=!1,e.emit(`lock`,!1)}return t.add({name:`lock`,mounted(t){let r=A(t,n.lock),i=A(t,n.unlock);j(r,`display`,`none`),e.on(`lock`,e=>{e?(j(r,`display`,`inline-flex`),j(i,`display`,`none`)):(j(r,`display`,`none`),j(i,`display`,`inline-flex`))})},click(){i()?o():a()}}),{name:`lock`,get state(){return i()},set state(e){e?a():o()}}}function Xn(e){return e.on(`control`,t=>{t?O(e.template.$player,`art-mini-progress-bar`):D(e.template.$player,`art-mini-progress-bar`)}),{name:`mini-progress-bar`}}var Zn=class{constructor(e){this.art=e,this.id=0;let{option:t}=e;t.miniProgressBar&&!t.isLive&&this.add(Xn),t.lock&&C&&this.add(Yn),t.autoPlayback&&!t.isLive&&this.add(qn),t.autoOrientation&&C&&this.add(Kn),t.fastForward&&C&&!t.isLive&&this.add(Jn);for(let e=0;e<t.plugins.length;e++)this.add(t.plugins[e])}add(e){this.id+=1;let t=e.call(this.art,this.art);return t instanceof Promise?t.then(t=>this.next(e,t)):this.next(e,t)}next(e,t){let n=t&&t.name||e.name||`plugin${this.id}`;return L(!V(this,n),`Cannot add a plugin that already has the same name: ${n}`),B(this,n,{value:t}),this}};function Qn(e){let{i18n:t,icons:n,constructor:{SETTING_ITEM_WIDTH:r,ASPECT_RATIO:i}}=e;function a(e){return e==="default"?t.get(`Default`):e}function o(){let t=e.setting.find(`aspect-ratio-${e.aspectRatio}`);e.setting.check(t)}return{width:r,name:`aspect-ratio`,html:t.get(`Aspect Ratio`),icon:n.aspectRatio,tooltip:a(e.aspectRatio),selector:i.map(t=>({value:t,name:`aspect-ratio-${t}`,default:t===e.aspectRatio,html:a(t)})),onSelect(t){return e.aspectRatio=t.value,t.html},mounted:()=>{o(),e.on(`aspectRatio`,()=>o())}}}function $n(e){let{i18n:t,icons:n,constructor:{SETTING_ITEM_WIDTH:r,FLIP:i}}=e;function a(e){return t.get(je(e))}function o(){let t=e.setting.find(`flip-${e.flip}`);e.setting.check(t)}return{width:r,name:`flip`,html:t.get(`Video Flip`),tooltip:a(e.flip),icon:n.flip,selector:i.map(t=>({value:t,name:`flip-${t}`,default:t===e.flip,html:a(t)})),onSelect(t){return e.flip=t.value,t.html},mounted:()=>{o(),e.on(`flip`,()=>o())}}}function er(e){let{i18n:t,icons:n,constructor:{SETTING_ITEM_WIDTH:r,PLAYBACK_RATE:i}}=e;function a(e){return e===1?t.get(`Normal`):e.toFixed(1)}function o(){let t=e.setting.find(`playback-rate-${e.playbackRate}`);e.setting.check(t)}return{width:r,name:`playback-rate`,html:t.get(`Play Speed`),tooltip:a(e.playbackRate),icon:n.playbackRate,selector:i.map(t=>({value:t,name:`playback-rate-${t}`,default:t===e.playbackRate,html:a(t)})),onSelect(t){return e.playbackRate=t.value,t.html},mounted:()=>{o(),e.on(`video:ratechange`,()=>o())}}}function tr(e){let{i18n:t,icons:n,constructor:r}=e;return{width:r.SETTING_ITEM_WIDTH,name:`subtitle-offset`,html:t.get(`Subtitle Offset`),icon:n.subtitle,tooltip:`0s`,range:[0,-10,10,.1],onChange(t){return e.subtitleOffset=t.range[0],`${t.range[0]}s`},mounted:(t,n)=>{e.on(`subtitleOffset`,e=>{n.$range.value=e,n.tooltip=`${e}s`})}}}var nr=class extends Y{constructor(e){super(e);let{option:t,controls:n,template:{$setting:r}}=e;this.name=`setting`,this.$parent=r,this.id=0,this.active=null,this.cache=new Map,this.option=[...this.builtin,...t.settings],t.setting&&(this.format(),this.render(),e.on(`blur`,()=>{this.show&&(this.show=!1,this.render())}),e.on(`focus`,e=>{let t=P(e,n.setting),r=P(e,this.$parent);this.show&&!t&&!r&&(this.show=!1,this.render())}),e.on(`resize`,()=>this.resize()))}get builtin(){let e=[],{option:t}=this.art;return t.playbackRate&&e.push(er(this.art)),t.aspectRatio&&e.push(Qn(this.art)),t.flip&&e.push($n(this.art)),t.subtitleOffset&&e.push(tr(this.art)),e}traverse(e,t=this.option){for(let n=0;n<t.length;n++){let r=t[n];e(r),r.selector?.length&&this.traverse(e,r.selector)}}check(e){e&&(e.$parent.tooltip=e.html,this.traverse(t=>{t.default=t===e,t.default&&t.$item&&M(t.$item,`art-current`)},e.$option),this.render(e.$parents))}format(e=this.option,t,n,r=[]){for(let i=0;i<e.length;i++){let a=e[i];if(a?.name?(L(!r.includes(a.name),`The [${a.name}] already exists in [setting]`),r.push(a.name)):a.name=`setting-${this.id++}`,!a.$formatted){B(a,`$parent`,{get:()=>t}),B(a,`$parents`,{get:()=>n}),B(a,`$option`,{get:()=>e});let r=[];B(a,`$events`,{get:()=>r}),B(a,`$formatted`,{get:()=>!0})}this.format(a.selector||[],a,e,r)}this.option=e}find(e=``){let t=null;return this.traverse(n=>{n.name===e&&(t=n)}),t}resize(){let{controls:e,constructor:{SETTING_WIDTH:t,SETTING_ITEM_HEIGHT:n},template:{$player:r,$setting:i}}=this.art;if(e.setting&&this.show){let a=this.active[0]?.$parent?.width||t,{left:o,width:s}=I(e.setting),{left:c,width:l}=I(r),u=o-c+s/2-a/2;if(j(i,`height`,`${this.active===this.option?this.active.length*n:(this.active.length+1)*n}px`),j(i,`width`,`${a}px`),this.art.isRotate||C)return;u+a>l?(j(i,`left`,null),j(i,`right`,null)):(j(i,`left`,`${u}px`),j(i,`right`,`auto`))}}inactivate(e){for(let t=0;t<e.$events.length;t++)this.art.events.remove(e.$events[t]);e.$events.length=0}remove(e){let t=this.find(e);L(t,`Can't find [${e}] in the [setting]`);let n=t.$option.indexOf(t);t.$option.splice(n,1),this.inactivate(t),t.$item&&_e(t.$item),this.render()}update(e){let t=this.find(e.name);return t?(this.inactivate(t),Object.assign(t,e),this.format(),this.createItem(t,!0),this.render(),t):this.add(e)}add(e,t=this.option){return t.push(e),this.format(),this.createItem(e),this.render(),e}createHeader(e){if(!this.cache.has(e.$option))return;let t=this.cache.get(e.$option),{proxy:n,icons:{arrowLeft:r},constructor:{SETTING_ITEM_HEIGHT:i}}=this.art,a=F(`div`);j(a,`height`,`${i}px`),D(a,`art-setting-item`),D(a,`art-setting-item-back`);let o=A(a,`<div class="art-setting-item-left"></div>`),s=F(`div`);D(s,`art-setting-item-left-icon`),A(s,r),A(o,s),A(o,e.$parent.html);let c=n(a,`click`,()=>this.render(e.$parents));e.$parent.$events.push(c),A(t,a)}createItem(e,t=!1){if(!this.cache.has(e.$option))return;let n=this.cache.get(e.$option),r=e.$item,i=`selector`;V(e,`switch`)&&(i=`switch`),V(e,`range`)&&(i=`range`),V(e,`onClick`)&&(i=`button`);let{icons:a,proxy:o,constructor:s}=this.art,c=F(`div`);D(c,`art-setting-item`),j(c,`height`,`${s.SETTING_ITEM_HEIGHT}px`),c.dataset.name=e.name||``,c.dataset.value=e.value||``;let l=A(c,`<div class="art-setting-item-left"></div>`),u=A(c,`<div class="art-setting-item-right"></div>`),d=F(`div`);switch(D(d,`art-setting-item-left-icon`),i){case`button`:case`switch`:case`range`:A(d,e.icon||a.config);break;case`selector`:e.selector?.length?A(d,e.icon||a.config):A(d,a.check)}A(l,d),B(e,`$icon`,{configurable:!0,get:()=>d}),B(e,`icon`,{configurable:!0,get(){return d.innerHTML},set(e){d.innerHTML=``,A(d,e)}});let f=F(`div`);D(f,`art-setting-item-left-text`),A(f,e.html||``),A(l,f),B(e,`$html`,{configurable:!0,get:()=>f}),B(e,`html`,{configurable:!0,get(){return f.innerHTML},set(e){f.innerHTML=``,A(f,e)}});let p=F(`div`);switch(D(p,`art-setting-item-right-tooltip`),A(p,e.tooltip||``),A(u,p),B(e,`$tooltip`,{configurable:!0,get:()=>p}),B(e,`tooltip`,{configurable:!0,get(){return p.innerHTML},set(e){p.innerHTML=``,A(p,e)}}),i){case`switch`:{let t=F(`div`);D(t,`art-setting-item-right-icon`);let n=A(t,a.switchOn),r=A(t,a.switchOff);j(e.switch?r:n,`display`,`none`),A(u,t),B(e,`$switch`,{configurable:!0,get:()=>t});let i=e.switch;B(e,`switch`,{configurable:!0,get:()=>i,set(e){i=e,e?(j(r,`display`,`none`),j(n,`display`,null)):(j(r,`display`,null),j(n,`display`,`none`))}});break}case`range`:{let t=F(`div`);D(t,`art-setting-item-right-icon`);let n=A(t,`<input type="range">`);n.value=e.range[0],n.min=e.range[1],n.max=e.range[2],n.step=e.range[3],D(n,`art-setting-range`),A(u,t),B(e,`$range`,{configurable:!0,get:()=>n});let r=[...e.range];B(e,`range`,{configurable:!0,get:()=>r,set(e){r=[...e],n.value=e[0],n.min=e[1],n.max=e[2],n.step=e[3]}})}break;case`selector`:if(e.selector?.length){let e=F(`div`);D(e,`art-setting-item-right-icon`),A(e,a.arrowRight),A(u,e)}}switch(i){case`switch`:if(e.onSwitch){let t=o(c,`click`,async t=>{e.switch=await e.onSwitch.call(this.art,e,c,t)});e.$events.push(t)}break;case`range`:if(e.$range){if(e.onRange){let t=o(e.$range,`change`,async t=>{e.range[0]=e.$range.valueAsNumber,e.tooltip=await e.onRange.call(this.art,e,c,t)});e.$events.push(t)}if(e.onChange){let t=o(e.$range,`input`,async t=>{e.range[0]=e.$range.valueAsNumber,e.tooltip=await e.onChange.call(this.art,e,c,t)});e.$events.push(t)}}break;case`selector`:{let t=o(c,`click`,async t=>{e.selector?.length?this.render(e.selector):(this.check(e),e.$parent.onSelect&&(e.$parent.tooltip=await e.$parent.onSelect.call(this.art,e,c,t)))});e.$events.push(t),e.default&&D(c,`art-current`)}break;case`button`:if(e.onClick){let t=o(c,`click`,async t=>{e.tooltip=await e.onClick.call(this.art,e,c,t)});e.$events.push(t)}}B(e,`$item`,{configurable:!0,get:()=>c}),t?Se(c,r):A(n,c),e.mounted&&setTimeout(()=>e.mounted.call(this.art,e.$item,e),0)}render(e=this.option){if(this.active=e,this.cache.has(e))M(this.cache.get(e),`art-current`);else{let t=F(`div`);this.cache.set(e,t),D(t,`art-setting-panel`),A(this.$parent,t),M(t,`art-current`),e[0]?.$parent&&this.createHeader(e[0]);for(let t=0;t<e.length;t++)this.createItem(e[t])}this.resize()}},rr=class{constructor(){this.name=`artplayer_settings`,this.settings={}}get(e){try{let t=JSON.parse(window.localStorage.getItem(this.name))||{};return e?t[e]:t}catch{return e?this.settings[e]:this.settings}}set(e,t){try{let n=Object.assign({},this.get(),{[e]:t});window.localStorage.setItem(this.name,JSON.stringify(n))}catch{this.settings[e]=t}}del(e){try{let t=this.get();delete t[e],window.localStorage.setItem(this.name,JSON.stringify(t))}catch{delete this.settings[e]}}clear(){try{window.localStorage.removeItem(this.name)}catch{this.settings={}}}},ir=`.art-video-player {
  --art-theme: #f00;
  --art-font-color: #fff;
...
`,ar=class extends Y{constructor(e){super(e),this.name=`subtitle`,this.option=null,this.destroyEvent=()=>null,this.init(e.option.subtitle);let t=!1;e.on(`video:timeupdate`,()=>{if(!this.url)return;let e=this.art.template.$video.webkitDisplayingFullscreen;typeof e==`boolean`&&e!==t&&(t=e,this.createTrack(e?`subtitles`:`metadata`,this.url))})}get url(){return this.art.template.$track.src}set url(e){this.switch(e)}get textTrack(){return this.art.template.$video?.textTracks?.[0]}get activeCues(){return this.textTrack?Array.from(this.textTrack.activeCues):[]}get cues(){return this.textTrack?Array.from(this.textTrack.cues):[]}style(e,t){let{$subtitle:n}=this.art.template;return typeof e==`object`?ve(n,e):j(n,e,t)}update(){let{option:{subtitle:e},template:{$subtitle:t}}=this.art;t.innerHTML=``,this.activeCues.length&&(this.art.emit(`subtitleBeforeUpdate`,this.activeCues),t.innerHTML=this.activeCues.map((t,n)=>t.text.split(/\r?\n/).filter(e=>e.trim()).map(t=>`<div class="art-subtitle-line" data-group="${n}">
                                ${e.escape?Me(t):t}
                            </div>`).join(``)).join(``),this.art.emit(`subtitleAfterUpdate`,this.activeCues))}async switch(e,t={}){let{i18n:n,notice:r,option:i}=this.art,a={...i.subtitle,...t,url:e},o=await this.init(a);return t.name&&(r.show=`${n.get(`Switch Subtitle`)}: ${t.name}`),o}createTrack(e,t){let{template:n,proxy:r,option:i}=this.art,{$video:a,$track:o}=n,s=F(`track`);s.default=!0,s.kind=e,s.src=t,s.label=i.subtitle.name||`Artplayer`,s.track.mode=`hidden`,s.onload=()=>{this.art.emit(`subtitleLoad`,this.cues,this.option)},this.art.events.remove(this.destroyEvent),o.onload=null,_e(o),A(a,s),n.$track=s,this.destroyEvent=r(this.textTrack,`cuechange`,()=>this.update())}async init(e){let{notice:t,template:{$subtitle:n}}=this.art;if(!this.textTrack)return null;if(_(e,Ke.subtitle),e.url)return this.option=e,this.style(e.style),fetch(e.url).then(e=>e.arrayBuffer()).then(t=>{let n=new TextDecoder(e.encoding).decode(t);switch(e.type||ke(e.url)){case`srt`:{let t=Re(n);return ze(e.onVttLoad(t))}case`ass`:{let t=Be(n);return ze(e.onVttLoad(t))}case`vtt`:return ze(e.onVttLoad(n));default:return e.url}}).then(e=>(n.innerHTML=``,this.url===e?e:(URL.revokeObjectURL(this.url),this.createTrack(`metadata`,e),e))).catch(e=>{throw n.innerHTML=``,t.show=e,e})}},or=class e{constructor(e){this.art=e;let{option:t,constructor:n}=e;t.container instanceof Element?this.$container=t.container:(this.$container=T(t.container),L(this.$container,`No container element found by ${t.container}`)),L(Te(),`The current browser does not support flex layout`);let r=this.$container.tagName.toLowerCase();L(r===`div`,`Unsupported container element type, only support 'div' but got '${r}'`),L(n.instances.every(e=>e.template.$container!==this.$container),`Cannot mount multiple instances on the same dom element`),this.query=this.query.bind(this),this.$container.dataset.artId=e.id,this.init()}static get html(){return`
            ...
            <div class="art-info">
              <div class="art-info-panel">
                <div class="art-info-item">
                  ...
                  <div class="art-info-content">${v}</div>
                </div>
                <div class="art-info-item">
        ...
        `}query(e){return T(e,this.$container)}init(){let{option:t}=this.art;if(t.useSSR||(this.$container.innerHTML=e.html),this.$player=this.query(`.art-video-player`),this.$video=this.query(`.art-video`),this.$track=this.query(`track`),this.$poster=this.query(`.art-poster`),this.$subtitle=this.query(`.art-subtitle`),this.$danmuku=this.query(`.art-danmuku`),this.$bottom=this.query(`.art-bottom`),this.$progress=this.query(`.art-progress`),this.$controls=this.query(`.art-controls`),this.$controlsLeft=this.query(`.art-controls-left`),this.$controlsCenter=this.query(`.art-controls-center`),this.$controlsRight=this.query(`.art-controls-right`),this.$layer=this.query(`.art-layers`),this.$loading=this.query(`.art-loading`),this.$notice=this.query(`.art-notice`),this.$noticeInner=this.query(`.art-notice-inner`),this.$mask=this.query(`.art-mask`),this.$state=this.query(`.art-state`),this.$setting=this.query(`.art-settings`),this.$info=this.query(`.art-info`),this.$infoPanel=this.query(`.art-info-panel`),this.$infoClose=this.query(`.art-info-close`),this.$contextmenu=this.query(`.art-contextmenus`),t.proxy){let e=t.proxy.call(this.art,this.art);L(e instanceof HTMLVideoElement||e instanceof HTMLCanvasElement,`Function 'option.proxy' needs to return 'HTMLVideoElement' or 'HTMLCanvasElement'`),Se(e,this.$video),e.className=`art-video`,this.$video=e}t.backdrop&&D(this.$player,`art-backdrop`),C&&D(this.$player,`art-mobile`)}destroy(e){e?this.$container.innerHTML=``:D(this.$player,`art-destroy`)}},sr=class{on(e,t,n){let r=this.e||(this.e={});return(r[e]||(r[e]=[])).push({fn:t,ctx:n}),this}once(e,t,n){let r=this;function i(...a){r.off(e,i),t.apply(n,a)}return i._=t,this.on(e,i,n)}emit(e,...t){let n=((this.e||(this.e={}))[e]||[]).slice();for(let e=0;e<n.length;e+=1)n[e].fn.apply(n[e].ctx,t);return this}off(e,t){let n=this.e||(this.e={}),r=n[e],i=[];if(r&&t)for(let e=0,n=r.length;e<n;e+=1)r[e].fn!==t&&r[e].fn._!==t&&i.push(r[e]);return i.length?n[e]=i:delete n[e],this}},cr=0,lr=[],$=class e extends sr{constructor(t,n){if(super(),!w)throw Error(`Artplayer can only be used in the browser environment`);this.id=++cr;let r=Ie(e.option,t);if(r.container=t.container,this.option=_(r,Ke),this.isLock=!1,this.isReady=!1,this.isFocus=!1,this.isInput=!1,this.isRotate=!1,this.isDestroy=!1,this.template=new or(this),this.events=new St(this),this.storage=new rr(this),this.icons=new $t(this),this.i18n=new Tt(this),this.notice=new an(this),this.player=new Gn(this),this.layers=new tn(this),this.controls=new dt(this),this.contextmenu=new $e(this),this.subtitle=new ar(this),this.info=new en(this),this.loading=new nn(this),this.hotkey=new Ct(this),this.mask=new rn(this),this.setting=new nr(this),this.plugins=new Zn(this),typeof n==`function`&&this.on(`ready`,()=>n.call(this,this)),e.DEBUG){let t=e=>console.log(`[ART.${this.id}] -> ${e}`);t(`Version@${e.version}`);for(let e=0;e<y.events.length;e++)this.on(`video:${y.events[e]}`,e=>t(`Event@${e.type}`))}lr.push(this)}static get instances(){return lr}static get version(){return v}static get config(){return y}static get utils(){return Ue}static get scheme(){return Ke}static get Emitter(){return sr}static get validator(){return _}static get kindOf(){return _.kindOf}static get html(){return or.html}static get option(){return{id:``,container:`#artplayer`,url:``,poster:``,type:``,theme:`#f00`,volume:.7,isLive:!1,muted:!1,autoplay:!1,autoSize:!1,autoMini:!1,loop:!1,flip:!1,playbackRate:!1,aspectRatio:!1,screenshot:!1,setting:!1,hotkey:!0,pip:!1,mutex:!0,backdrop:!0,fullscreen:!1,fullscreenWeb:!1,subtitleOffset:!1,miniProgressBar:!1,useSSR:!1,playsInline:!0,lock:!1,gesture:!0,fastForward:!1,autoPlayback:!1,autoOrientation:!1,airplay:!1,proxy:void 0,layers:[],contextmenu:[],controls:[],settings:[],quality:[],highlight:[],plugins:[],thumbnails:{url:``,number:60,column:10,width:0,height:0,scale:1},subtitle:{url:``,type:``,style:{},name:``,escape:!0,encoding:`utf-8`,onVttLoad:e=>e},moreVideoAttr:{controls:!1,preload:x?`auto`:`metadata`},i18n:{},icons:{},cssVar:{},customType:{},lang:navigator?.language.toLowerCase()}}get proxy(){return this.events.proxy}get query(){return this.template.query}get video(){return this.template.$video}reset(){this.video.removeAttribute(`src`),this.video.load()}destroy(t=!0){e.REMOVE_SRC_WHEN_DESTROY&&this.reset(),this.events.destroy(),this.template.destroy(t),lr.splice(lr.indexOf(this),1),this.isDestroy=!0,this.emit(`destroy`)}};$.STYLE=ir,$.DEBUG=!1,$.CONTEXTMENU=!0,$.NOTICE_TIME=2e3,$.SETTING_WIDTH=250,$.SETTING_ITEM_WIDTH=200,$.SETTING_ITEM_HEIGHT=35,$.RESIZE_TIME=200,$.SCROLL_TIME=200,$.SCROLL_GAP=50,$.AUTO_PLAYBACK_MAX=10,$.AUTO_PLAYBACK_MIN=5,$.AUTO_PLAYBACK_TIMEOUT=3e3,$.RECONNECT_TIME_MAX=5,$.RECONNECT_SLEEP_TIME=1e3,$.CONTROL_HIDE_TIME=3e3,$.DBCLICK_TIME=300,$.DBCLICK_FULLSCREEN=!0,$.MOBILE_DBCLICK_PLAY=!0,$.MOBILE_CLICK_PLAY=!1,$.AUTO_ORIENTATION_TIME=200,$.INFO_LOOP_TIME=1e3,$.FAST_FORWARD_VALUE=3,$.FAST_FORWARD_TIME=1e3,$.TOUCH_MOVE_RATIO=.5,$.VOLUME_STEP=.1,$.SEEK_STEP=5,$.PLAYBACK_RATE=[.5,.75,1,1.25,1.5,2],$.ASPECT_RATIO=[`default`,`4:3`,`16:9`],$.FLIP=[`normal`,`horizontal`,`vertical`],$.FULLSCREEN_WEB_IN_BODY=!0,$.LOG_VERSION=!0,$.USE_RAF=!1,$.REMOVE_SRC_WHEN_DESTROY=!0,w&&(we(`artplayer-style`,ir),setTimeout(()=>{$.LOG_VERSION&&console.log(`%c ArtPlayer %c ${$.version} %c https://artplayer.org`,`color: #fff; background: #5f5f5f`,`color: #fff; background: #4bc729`,``)},100)),$.PLAYBACK_RATE=[.5,.75,1,1.25,1.5,2,3,4],$.REMOVE_SRC_WHEN_DESTROY=!0;var ur=[{icon:`iina`,name:`IINA`,scheme:`iina://weblink?url=$edurl`,platforms:[`MacOS`]},{icon:`potplayer`,name:`PotPlayer`,scheme:`potplayer://$durl`,platforms:[`Windows`]},{icon:`vlc`,name:`VLC`,scheme:`vlc://$durl`,platforms:[`Windows`,`MacOS`,`Linux`,`Android`,`iOS`]},{icon:`android`,name:`Android`,scheme:`intent:$durl#Intent;type=video/*;S.title=$name;end`,platforms:[`Android`]},{icon:`nplayer`,name:`nPlayer`,scheme:`nplayer-$durl`,platforms:[`Android`,`iOS`]},{icon:`omniplayer`,name:`OmniPlayer`,scheme:`omniplayer://weblink?url=$durl`,platforms:[`MacOS`]},{icon:`figplayer`,name:`Fig Player`,scheme:`figplayer://weblink?url=$durl`,platforms:[`Windows`,`MacOS`]},{icon:`vivid`,name:`Vivid Player`,scheme:`vividplayer://play?src=direct&u=$edurl&title=$name`,platforms:[`Windows`]},{icon:`infuse`,name:`Infuse`,scheme:`infuse://x-callback-url/play?url=$durl`,platforms:[`MacOS`,`iOS`]},{icon:`fileball`,name:`Fileball`,scheme:`filebox://play?url=$durl`,platforms:[`MacOS`,`iOS`]},{icon:`mxplayer`,name:`MX Player`,scheme:`intent:$durl#Intent;package=com.mxtech.videoplayer.ad;S.title=$name;end`,platforms:[`Android`]},{icon:`mxplayer-pro`,name:`MX Player Pro`,scheme:`intent:$durl#Intent;package=com.mxtech.videoplayer.pro;S.title=$name;end`,platforms:[`Android`]},{icon:`iPlay`,name:`iPlay`,scheme:`iplay://play/any?type=url&url=$bdurl`,platforms:[`iOS`]},{icon:`mpv`,name:`mpv`,scheme:`mpv://$edurl`,platforms:[`Windows`,`MacOS`,`Linux`,`Android`]}],dr=e=>{let{$container:t,$video:n}=e.template,r=t.parentElement;e.on(`ready`,()=>{r.style.maxHeight=`calc(100vh - ${r.offsetTop}px - 1.75rem)`,r.style.minHeight=`320px`,e.autoHeight()}),e.on(`resize`,()=>{e.autoHeight()}),e.on(`error`,()=>{n.style.height||(t.style.height=`60vh`,n.style.height=`100%`)})},fr=fe=>{let{replace:g,pathname:pe}=d(),{currentObjLink:me}=c(),{handleFolder:he}=l(),[_,v]=m(``),y=p(()=>{let e=!0,n=!1,r=t.objs.filter(r=>r.type===a.VIDEO&&(r.name===t.obj.name?(e=!1,n=!0,v(r.name)):n=!1,!0));if(n&&(e=te().type!==`all`),e){let e=pe();if(!e.endsWith(t.obj.name))return r.push(t.obj),v(t.obj.name),r;let n=t.objs.length>0;he(ee(e),o()+ +!!n,void 0,n,!1,!0)}return r}),b=ce(),x=localStorage.getItem(`video_auto_next`);x||(x=`true`),fe.onAutoNextChange(x===`true`);let[S,ge]=m(localStorage.getItem(`video_show_all_players`)===`true`),C=f(),w=p(()=>S()||C===`Unknown`?ur:ur.filter(e=>e.platforms.includes(C)));return h(ie,{w:`$full`,spacing:`$2`,get children(){return[le(()=>fe.children),h(e,{get when(){return _()!==``},get children(){return h(i,{spacing:`$2`,w:`$full`,get children(){return[h(ue,{onChange:e=>{g(e)},get value(){return _()},get options(){return y().map(e=>({value:e.name}))}}),h(re,{css:{whiteSpace:`nowrap`},defaultChecked:x===`true`,onChange:e=>{fe.onAutoNextChange(e.currentTarget.checked),localStorage.setItem(`video_auto_next`,e.currentTarget.checked.toString())},get children(){return b(`home.preview.auto_next`)}})]}})}}),h(r,{wrap:`wrap`,gap:`$1`,justifyContent:`center`,alignItems:`center`,get children(){return[h(s,{get each(){return w()},children:e=>h(oe,{placement:`top`,withArrow:!0,get label(){return e.name},get children(){return h(n,{get href(){return u(e.scheme,{raw_url:t.raw_url,name:t.obj.name,d_url:me(!0)})},get children(){return h(ae,{m:`0 auto`,boxSize:`$8`,get src(){return`${window.__dynamic_base__}/images/${e.icon}.webp`}})}})}})}),h(ne,{"aria-label":`Show all players`,variant:`ghost`,onClick:()=>{let e=!S();ge(e),localStorage.setItem(`video_show_all_players`,e.toString())},get icon(){return h(se,{as:de,boxSize:`$6`,color:`accent.500`,get transform(){return S()?`rotate(180deg)`:`none`},transition:`transform 0.2s`})}})]}})]}})};export{$ as i,fr as n,ur as r,dr as t};
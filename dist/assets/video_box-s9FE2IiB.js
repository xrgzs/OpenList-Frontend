...
`)}`}function H(e=0){return new Promise(t=>setTimeout(t,e))}function Be(e,t){let n;return function(...r){clearTimeout(n),n=setTimeout(()=>(n=null,e.apply(this,r)),t)}}function Ve(e,t){let n=!1;return function(...r){n||(e.apply(this,r),n=!0,setTimeout(()=>{n=!1},t))}}var He=Object.freeze(Object.defineProperty({__proto__:null,ArtPlayerError:Oe,addClass:E,append:k,assToVtt:ze,capitalize:Ae,clamp:R,createElement:P,debounce:Be,def:B,download:ke,errorHandle:I,escape:je,get:Pe,getComposedPath:De,getExt:L,getIcon:Ce,getRect:F,getStyle:ye,has:V,hasClass:O,includeFromEvent:N,inverseClass:j,isBrowser:C,isIOS:x,isIOS13:ge,isInViewport:xe,isMobile:S,isSafari:b,loadImg:Ee,mergeDeep:Fe,query:w,queryAll:T,remove:_e,removeClass:D,replaceElement:Se,secondToTime:z,setStyle:A,setStyleText:we,setStyles:ve,siblings:be,sleep:H,srtToVtt:Le,supportsFlex:Te,throttle:Ve,tooltip:M,unescape:Me,userAgent:y,vttToBlob:Re},Symbol.toStringTag,{value:`Module`})),Ue=`array`,U=`boolean`,W=`string`,G=`number`,K=`object`,q=`function`;function We(e,t,n){return I(t===W||t===G||e instanceof Element,`${n.join(`.`)} require '${W}' or 'Element' type`)}var J={html:We,disable:`?${U}`,name:`?${W}`,index:`?${G}`,style:`?${K}`,click:`?${q}`,mounted:`?${q}`,tooltip:`?${W}|${G}`,width:`?${G}`,selector:`?${Ue}`,onSelect:`?${q}`,switch:`?${U}`,onSwitch:`?${q}`,range:`?${Ue}`,onRange:`?${q}`,onChange:`?${q}`},Ge={id:W,container:We,url:W,poster:W,type:W,theme:W,lang:W,volume:G,isLive:U,muted:U,autoplay:U,autoSize:U,autoMini:U,loop:U,flip:U,playbackRate:U,aspectRatio:U,screenshot:U,setting:U,hotkey:U,pip:U,mutex:U,backdrop:U,fullscreen:U,fullscreenWeb:U,subtitleOffset:U,miniProgressBar:U,useSSR:U,playsInline:U,lock:U,gesture:U,fastForward:U,autoPlayback:U,autoOrientation:U,airplay:U,proxy:`?${q}`,plugins:[q],layers:[J],contextmenu:[J],settings:[J],controls:[{...J,position:(e,t,n)=>{let r=[`top`,`left`,`right`];return I(r.includes(e),`${n.join(`.`)} only accept ${r.toString()} as parameters`)}}],quality:[{default:`?${U}`,html:W,url:W}],highlight:[{time:G,text:W}],thumbnails:{url:W,number:G,column:G,width:G,height:G,scale:G},subtitle:{url:W,name:W,type:W,style:K,escape:U,encoding:W,onVttLoad:q},moreVideoAttr:K,i18n:K,icons:K,cssVar:K,customType:K},Y=class{constructor(e){this.id=0,this.art=e,this.cache=new Map,this.add=this.add.bind(this),this.remove=this.remove.bind(this),this.update=this.update.bind(this)}get show(){return O(this.art.template.$player,`art-${this.name}-show`)}set show(e){let{$player:t}=this.art.template,n=`art-${this.name}-show`;e?E(t,n):D(t,n),this.art.emit(this.name,e)}toggle(){this.show=!this.show}add(e){let t=typeof e==`function`?e(this.art):e;if(t.html=t.html||``,g(t,J),!this.$parent||!this.name||t.disable)return;let n=t.name||`${this.name}${this.id}`;I(!this.cache.has(n),`Can't add an existing [${n}] to the [${this.name}]`),this.id+=1;let r=P(`div`);E(r,`art-${this.name}`),E(r,`art-${this.name}-${n}`);let i=Array.from(this.$parent.children);r.dataset.index=t.index||this.id;let a=i.find(e=>Number(e.dataset.index)>=Number(r.dataset.index));a?a.insertAdjacentElement(`beforebegin`,r):k(this.$parent,r),t.html&&k(r,t.html),t.style&&ve(r,t.style),t.tooltip&&M(r,t.tooltip);let o=[];if(t.click){let e=this.art.events.proxy(r,`click`,e=>{e.preventDefault(),t.click.call(this.art,this,e)});o.push(e)}return t.selector&&[`left`,`right`].includes(t.position)&&this.selector(t,r,o),this[n]=r,this.cache.set(n,{$ref:r,events:o,option:t}),t.mounted&&t.mounted.call(this.art,r),r}remove(e){I(this.cache.has(e),`Can't find [${e}] from the [${this.name}]`);let t=this.cache.get(e);t.option.beforeUnmount&&t.option.beforeUnmount.call(this.art,t.$ref);for(let e of t.events)this.art.events.remove(e);this.cache.delete(e),delete this[e],_e(t.$ref)}update(e){if(this.cache.has(e.name)){let t=this.cache.get(e.name);e=Object.assign(t.option,e),this.remove(e.name)}return this.add(e)}};function Ke(e){return t=>{let{i18n:n,constructor:{ASPECT_RATIO:r}}=t,i=r.map(e=>`<span data-value="${e}">${e===`default`?n.get(`Default`):e}</span>`).join(``);return{...e,html:`${n.get(`Aspect Ratio`)}: ${i}`,click:(e,n)=>{let{value:r}=n.target.dataset;r&&(t.aspectRatio=r,e.show=!1)},mounted:e=>{let n=w(`[data-value="default"]`,e);n&&j(n,`art-current`),t.on(`aspectRatio`,t=>{let n=T(`span`,e).find(e=>e.dataset.value===t);n&&j(n,`art-current`)})}}}}function qe(e){return t=>({...e,html:t.i18n.get(`Close`),click:e=>{e.show=!1}})}function Je(e){return t=>{let{i18n:n,constructor:{FLIP:r}}=t,i=r.map(e=>`<span data-value="${e}">${n.get(Ae(e))}</span>`).join(``);return{...e,html:`${n.get(`Video Flip`)}: ${i}`,click:(e,n)=>{let{value:r}=n.target.dataset;r&&(t.flip=r.toLowerCase(),e.show=!1)},mounted:e=>{let n=w(`[data-value="normal"]`,e);n&&j(n,`art-current`),t.on(`flip`,t=>{let n=T(`span`,e).find(e=>e.dataset.value===t);n&&j(n,`art-current`)})}}}}function Ye(e){return t=>({...e,html:t.i18n.get(`Video Info`),click:e=>{t.info.show=!0,e.show=!1}})}function Xe(e){return t=>{let{i18n:n,constructor:{PLAYBACK_RATE:r}}=t,i=r.map(e=>`<span data-value="${e}">${e===1?n.get(`Normal`):e.toFixed(1)}</span>`).join(``);return{...e,html:`${n.get(`Play Speed`)}: ${i}`,click:(e,n)=>{let{value:r}=n.target.dataset;r&&(t.playbackRate=Number(r),e.show=!1)},mounted:e=>{let n=w(`[data-value="1"]`,e);n&&j(n,`art-current`),t.on(`video:ratechange`,()=>{let n=T(`span`,e).find(e=>Number(e.dataset.value)===t.playbackRate);n&&j(n,`art-current`)})}}}}function Ze(e){let t=C?location.href:``;return{...e,html:`<a href="https://artplayer.org?ref=${encodeURIComponent(t)}" target="_blank" style="width:100%;">ArtPlayer ${_}</a>`}}var Qe=class extends Y{constructor(e){super(e),this.name=`contextmenu`,this.$parent=e.template.$contextmenu,S||this.init()}init(){let{option:e,proxy:t,template:{$player:n,$contextmenu:r}}=this.art;e.playbackRate&&this.add(Xe({name:`playbackRate`,index:10})),e.aspectRatio&&this.add(Ke({name:`aspectRatio`,index:20})),e.flip&&this.add(Je({name:`flip`,index:30})),this.add(Ye({name:`info`,index:40})),this.add(Ze({name:`version`,index:50})),this.add(qe({name:`close`,index:60}));for(let t=0;t<e.contextmenu.length;t++)this.add(e.contextmenu[t]);t(n,`contextmenu`,e=>{if(!this.art.constructor.CONTEXTMENU)return;e.preventDefault(),this.show=!0;let t=e.clientX,i=e.clientY,{height:a,width:o,left:s,top:c}=F(n),{height:l,width:u}=F(r),d=t-s,f=i-c;t+u>s+o&&(d=o-u),i+l>c+a&&(f=a-l),ve(r,{top:`${f}px`,left:`${d}px`})}),t(n,`click`,e=>{N(e,r)||(this.show=!1)}),this.art.on(`blur`,()=>{this.show=!1})}};function $e(e){return t=>({...e,tooltip:t.i18n.get(`AirPlay`),mounted:e=>{let{proxy:n,icons:r}=t;k(e,r.airplay),n(e,`click`,()=>t.airplay())}})}function et(e){return t=>({...e,tooltip:t.i18n.get(`Fullscreen`),mounted:e=>{let{proxy:n,icons:r,i18n:i}=t,a=k(e,r.fullscreenOn),o=k(e,r.fullscreenOff);A(o,`display`,`none`),n(e,`click`,()=>{t.fullscreen=!t.fullscreen}),t.on(`fullscreen`,t=>{t?(M(e,i.get(`Exit Fullscreen`)),A(a,`display`,`none`),A(o,`display`,`inline-flex`)):(M(e,i.get(`Fullscreen`)),A(a,`display`,`inline-flex`),A(o,`display`,`none`))})}})}function tt(e){return t=>({...e,tooltip:t.i18n.get(`Web Fullscreen`),mounted:e=>{let{proxy:n,icons:r,i18n:i}=t,a=k(e,r.fullscreenWebOn),o=k(e,r.fullscreenWebOff);A(o,`display`,`none`),n(e,`click`,()=>{t.fullscreenWeb=!t.fullscreenWeb}),t.on(`fullscreenWeb`,t=>{t?(M(e,i.get(`Exit Web Fullscreen`)),A(a,`display`,`none`),A(o,`display`,`inline-flex`)):(M(e,i.get(`Web Fullscreen`)),A(a,`display`,`inline-flex`),A(o,`display`,`none`))})}})}function nt(e){return t=>({...e,tooltip:t.i18n.get(`PIP Mode`),mounted:e=>{let{proxy:n,icons:r,i18n:i}=t;k(e,r.pip),n(e,`click`,()=>{t.pip=!t.pip}),t.on(`pip`,t=>{M(e,i.get(t?`Exit PIP Mode`:`PIP Mode`))})}})}function rt(e){return t=>({...e,mounted:e=>{let{proxy:n,icons:r,i18n:i}=t,a=k(e,r.play),o=k(e,r.pause);M(a,i.get(`Play`)),M(o,i.get(`Pause`)),n(a,`click`,()=>{t.play()}),n(o,`click`,()=>{t.pause()});function s(){A(a,`display`,`flex`),A(o,`display`,`none`)}function c(){A(a,`display`,`none`),A(o,`display`,`flex`)}t.playing?c():s(),t.on(`video:playing`,()=>{c()}),t.on(`video:pause`,()=>{s()})}})}function X(e,t){let{$progress:n}=e.template,{left:r}=F(n),i=R((S?t.touches[0].clientX:t.clientX)-r,0,n.clientWidth),a=i/n.clientWidth*e.duration;return{second:a,time:z(a),width:i,percentage:R(i/n.clientWidth,0,1)}}function it(e,t){if(e.isRotate){let n=t.touches[0].clientY/e.height,r=n*e.duration;e.emit(`setBar`,`played`,n,t),e.seek=r}else{let{second:n,percentage:r}=X(e,t);e.emit(`setBar`,`played`,r,t),e.seek=n}}function at(e){return t=>{let{icons:n,option:r,proxy:i}=t,{$player:a,$progress:o}=t.template;return{...e,html:`
            ...
            `,mounted:e=>{let s=null,c=!1,l=w(`.art-progress-hover`,e),u=w(`.art-progress-loaded`,e),d=w(`.art-progress-played`,e),f=w(`.art-progress-highlight`,e),p=w(`.art-progress-indicator`,e),m=w(`.art-progress-tip`,e);n.indicator?k(p,n.indicator):A(p,`backgroundColor`,`var(--art-theme)`);function ee(n){let{width:r}=X(t,n),{text:i}=n.target.dataset;m.textContent=i;let a=m.clientWidth;r<=a/2?A(m,`left`,0):r>e.clientWidth-a/2?A(m,`left`,`${e.clientWidth-a}px`):A(m,`left`,`${r-a/2}px`)}function te(n,r){let{width:i,time:a}=r||X(t,n);m.textContent=a||`00:00`;let o=m.clientWidth;i<=o/2?A(m,`left`,0):i>e.clientWidth-o/2?A(m,`left`,`${e.clientWidth-o}px`):A(m,`left`,`${i-o/2}px`)}function ne(){f.textContent=``;for(let e=0;e<r.highlight.length;e++){let n=r.highlight[e],i=R(n.time,0,t.duration)/t.duration*100;k(f,`<span data-text="${n.text}" data-time="${n.time}" style="left: ${i}%"></span>`)}}function re(n,r,i){let o=n===`played`&&i&&S;n===`loaded`&&A(u,`width`,`${r*100}%`),n===`hover`&&(A(l,`width`,`${r*100}%`),N(i,f)?ee(i):te(i),r===0?D(a,`art-progress-hover`):E(a,`art-progress-hover`)),n===`played`&&(A(d,`width`,`${r*100}%`),A(p,`left`,`${r*100}%`)),o&&(E(a,`art-progress-hover`),te(i,{width:e.clientWidth*r,time:z(r*t.duration)}),clearTimeout(s),s=setTimeout(()=>{D(a,`art-progress-hover`)},500))}t.on(`setBar`,re),t.on(`video:loadedmetadata`,ne),t.constructor.USE_RAF?t.on(`raf`,()=>{t.emit(`setBar`,`played`,t.played),t.emit(`setBar`,`loaded`,t.loaded)}):(t.on(`video:timeupdate`,()=>{t.emit(`setBar`,`played`,t.played)}),t.on(`video:progress`,()=>{t.emit(`setBar`,`loaded`,t.loaded)}),t.on(`video:ended`,()=>{t.emit(`setBar`,`played`,1)})),t.emit(`setBar`,`loaded`,t.loaded||0),S||(i(o,`click`,e=>{e.target!==p&&it(t,e)}),i(o,`mousemove`,e=>{let{percentage:n}=X(t,e);t.emit(`setBar`,`hover`,n,e)}),i(o,`mouseleave`,e=>{t.emit(`setBar`,`hover`,0,e)}),i(o,`mousedown`,e=>{c=e.button===0}),t.on(`document:mousemove`,e=>{if(c){let{second:n,percentage:r}=X(t,e);t.emit(`setBar`,`played`,r,e),t.seek=n}}),t.on(`document:mouseup`,()=>{c&&(c=!1)}))}}}}function ot(e){return t=>({...e,tooltip:t.i18n.get(`Screenshot`),mounted:e=>{let{proxy:n,icons:r}=t;k(e,r.screenshot),n(e,`click`,()=>{t.screenshot()})}})}function st(e){return t=>({...e,tooltip:t.i18n.get(`Show Setting`),mounted:e=>{let{proxy:n,icons:r,i18n:i}=t;k(e,r.setting),n(e,`click`,()=>{t.setting.toggle(),t.setting.resize()}),t.on(`setting`,t=>{M(e,i.get(t?`Hide Setting`:`Show Setting`))})}})}function ct(e){return t=>({...e,style:S?{fontSize:`12px`,padding:`0 5px`}:{cursor:`auto`,padding:`0 10px`},mounted:e=>{function n(){let n=`${z(t.currentTime)} / ${z(t.duration)}`;n!==e.textContent&&(e.textContent=n)}n();let r=[`video:loadedmetadata`,`video:timeupdate`,`video:progress`];for(let e=0;e<r.length;e++)t.on(r[e],n)}})}function lt(e){return t=>({...e,mounted:e=>{let{proxy:n,icons:r}=t,i=k(e,r.volume),a=k(e,r.volumeClose),o=k(e,`<div class="art-volume-panel"></div>`),s=k(o,`<div class="art-volume-inner"></div>`),c=k(s,`<div class="art-volume-val"></div>`),l=k(s,`<div class="art-volume-slider"></div>`),u=k(k(l,`<div class="art-volume-handle"></div>`),`<div class="art-volume-loaded"></div>`),d=k(l,`<div class="art-volume-indicator"></div>`);function f(e){let{top:t,height:n}=F(l);return 1-(e.clientY-t)/n}function p(){if(t.muted||t.volume===0)A(i,`display`,`none`),A(a,`display`,`flex`),A(d,`top`,`100%`),A(u,`top`,`100%`),c.textContent=0;else{let e=t.volume*100;A(i,`display`,`flex`),A(a,`display`,`none`),A(d,`top`,`${100-e}%`),A(u,`top`,`${100-e}%`),c.textContent=Math.floor(e)}}if(p(),t.on(`video:volumechange`,p),n(i,`click`,()=>{t.muted=!0}),n(a,`click`,()=>{t.muted=!1}),S)A(o,`display`,`none`);else{let e=!1;n(l,`mousedown`,n=>{e=n.button===0,t.volume=f(n)}),t.on(`document:mousemove`,n=>{e&&(t.muted=!1,t.volume=f(n))}),t.on(`document:mouseup`,()=>{e&&(e=!1)})}}})}var ut=class extends Y{constructor(e){super(e),this.isHover=!1,this.name=`control`,this.timer=Date.now();let{constructor:t}=e,{$player:n,$bottom:r}=this.art.template;e.on(`mousemove`,()=>{S||(this.show=!0)}),e.on(`click`,()=>{S?this.toggle():this.show=!0}),e.on(`document:mousemove`,e=>{this.isHover=N(e,r)}),e.on(`video:timeupdate`,()=>{!e.setting.show&&!this.isHover&&!e.isInput&&e.playing&&this.show&&Date.now()-this.timer>=t.CONTROL_HIDE_TIME&&(this.show=!1)}),e.on(`control`,e=>{e?(D(n,`art-hide-cursor`),E(n,`art-hover`),this.timer=Date.now()):(E(n,`art-hide-cursor`),D(n,`art-hover`))}),this.init()}init(){let{option:e}=this.art;e.isLive||this.add(at({name:`progress`,position:`top`,index:10})),this.add({name:`thumbnails`,position:`top`,index:20}),this.add(rt({name:`playAndPause`,position:`left`,index:10})),this.add(lt({name:`volume`,position:`left`,index:20})),e.isLive||this.add(ct({name:`time`,position:`left`,index:30})),e.quality.length&&H().then(()=>{this.art.quality=e.quality}),e.screenshot&&!S&&this.add(ot({name:`screenshot`,position:`right`,index:20})),e.setting&&this.add(st({name:`setting`,position:`right`,index:30})),e.pip&&this.add(nt({name:`pip`,position:`right`,index:40})),e.airplay&&window.WebKitPlaybackTargetAvailabilityEvent&&this.add($e({name:`airplay`,position:`right`,index:50})),e.fullscreenWeb&&this.add(tt({name:`fullscreenWeb`,position:`right`,index:60})),e.fullscreen&&this.add(et({name:`fullscreen`,position:`right`,index:70}));for(let t=0;t<e.controls.length;t++)this.add(e.controls[t])}add(e){let t=typeof e==`function`?e(this.art):e,{$progress:n,$controlsLeft:r,$controlsRight:i}=this.art.template;switch(t.position){case`top`:this.$parent=n;break;case`left`:this.$parent=r;break;case`right`:this.$parent=i;break;default:I(!1,`Control option.position must one of 'top', 'left', 'right'`);break}super.add(t)}check(e){if(e){e.$control_value.innerHTML=e.html;for(let t=0;t<e.$control_option.length;t++){let n=e.$control_option[t];n.default=n===e,n.default&&j(n.$control_item,`art-current`)}}}selector(e,t,n){let{proxy:r}=this.art.events;E(t,`art-control-selector`);let i=P(`div`);E(i,`art-selector-value`),k(i,e.html),t.textContent=``,k(t,i);let a=P(`div`);E(a,`art-selector-list`),k(t,a);for(let t=0;t<e.selector.length;t++){let n=e.selector[t],r=P(`div`);E(r,`art-selector-item`),n.default&&E(r,`art-current`),r.dataset.index=t,r.dataset.value=n.value,r.innerHTML=n.html,k(a,r),B(n,`$control_option`,{get:()=>e.selector}),B(n,`$control_item`,{get:()=>r}),B(n,`$control_value`,{get:()=>i})}let o=r(a,`click`,async t=>{let n=De(t),r=e.selector.find(e=>e.$control_item===n.find(t=>e.$control_item===t));this.check(r),e.onSelect&&(i.innerHTML=await e.onSelect.call(this.art,r,r.$control_item,t))});n.push(o)}};function dt(e,t){let{constructor:n,template:{$player:r,$video:i}}=e;function a(t){N(t,r)?(e.isInput=t.target.tagName===`INPUT`,e.isFocus=!0,e.emit(`focus`,t)):(e.isInput=!1,e.isFocus=!1,e.emit(`blur`,t))}e.on(`document:click`,a),e.on(`document:contextmenu`,a);let o=[];t.proxy(i,`click`,t=>{let r=Date.now();o.push(r);let{MOBILE_CLICK_PLAY:i,DBCLICK_TIME:a,MOBILE_DBCLICK_PLAY:s,DBCLICK_FULLSCREEN:c}=n,l=o.filter(e=>r-e<=a);switch(l.length){case 1:e.emit(`click`,t),S?!e.isLock&&i&&e.toggle():e.toggle(),o=l;break;case 2:e.emit(`dblclick`,t),S?!e.isLock&&s&&e.toggle():c&&(e.fullscreen=!e.fullscreen),o=[];break;default:o=[]}})}function ft(e,t){return Math.atan2(t,e)*180/Math.PI}function pt(e,t,n,r){let i=t-r,a=n-e,o=0;if(Math.abs(a)<2&&Math.abs(i)<2)return o;let s=ft(a,i);return s>=-45&&s<45?o=4:s>=45&&s<135?o=1:s>=-135&&s<-45?o=2:(s>=135&&s<=180||s>=-180&&s<-135)&&(o=3),o}function mt(e,t){if(S&&!e.option.isLive){let{$video:n,$progress:r}=e.template,i=null,a=!1,o=0,s=0,c=0,l=t=>{if(t.touches.length===1&&!e.isLock){i===r&&it(e,t),a=!0;let{pageX:n,pageY:l}=t.touches[0];o=n,s=l,c=e.currentTime}},u=t=>{if(t.touches.length===1&&a&&e.duration){let{pageX:r,pageY:a}=t.touches[0],l=pt(o,s,r,a),u=[3,4].includes(l),d=[1,2].includes(l);if(u&&!e.isRotate||d&&e.isRotate){let l=R((r-o)/e.width,-1,1),u=R((a-s)/e.height,-1,1),d=e.isRotate?u:l,f=i===n?e.constructor.TOUCH_MOVE_RATIO:1,p=R(c+e.duration*d*f,0,e.duration);e.seek=p,e.emit(`setBar`,`played`,R(p/e.duration,0,1),t),e.notice.show=`${z(p)} / ${z(e.duration)}`}}};e.option.gesture&&(t.proxy(n,`touchstart`,e=>{i=n,l(e)}),t.proxy(n,`touchmove`,u)),t.proxy(r,`touchstart`,e=>{i=r,l(e)}),t.proxy(r,`touchmove`,u),e.on(`document:touchend`,()=>{a&&(o=0,s=0,c=0,a=!1,i=null)})}}function ht(e,t){let n=[`click`,`mouseup`,`keydown`,`touchend`,`touchmove`,`mousemove`,`pointerup`,`contextmenu`,`pointermove`,`visibilitychange`,`webkitfullscreenchange`],r=[`resize`,`scroll`,`orientationchange`],i=[];function a(a={}){for(let e=0;e<i.length;e++)t.remove(i[e]);i.length=0;let{$player:o}=e.template;n.forEach(n=>{let r=a.document||o.ownerDocument||document,s=t.proxy(r,n,t=>{e.emit(`document:${n}`,t)});i.push(s)}),r.forEach(n=>{let r=a.window||o.ownerDocument?.defaultView||window,s=t.proxy(r,n,t=>{e.emit(`window:${n}`,t)});i.push(s)})}a(),t.bindGlobalEvents=a}function gt(e,t){let{$player:n}=e.template;t.hover(n,t=>{E(n,`art-hover`),e.emit(`hover`,!0,t)},t=>{D(n,`art-hover`),e.emit(`hover`,!1,t)})}function _t(e,t){let{$player:n}=e.template;t.proxy(n,`mousemove`,t=>{e.emit(`mousemove`,t)})}function vt(e,t){let{option:n,constructor:r}=e;e.on(`resize`,()=>{let{aspectRatio:t,notice:r}=e;e.state===`standard`&&n.autoSize&&e.autoSize(),e.aspectRatio=t,r.show=``});let i=Be(()=>e.emit(`resize`),r.RESIZE_TIME);e.on(`window:orientationchange`,()=>i()),e.on(`window:resize`,()=>i()),screen&&screen.orientation&&screen.orientation.onchange&&t.proxy(screen.orientation,`change`,()=>i())}function yt(e){if(e.constructor.USE_RAF){let t=null;(function n(){e.playing&&e.emit(`raf`),e.isDestroy||(t=requestAnimationFrame(n))})(),e.on(`destroy`,()=>{cancelAnimationFrame(t)})}}function bt(e){let{option:t,constructor:n,template:{$container:r}}=e,i=Ve(()=>{e.emit(`view`,xe(r,n.SCROLL_GAP))},n.SCROLL_TIME);e.on(`window:scroll`,()=>i()),e.on(`view`,n=>{t.autoMini&&(e.mini=!n)})}var xt=class{constructor(e){this.destroyEvents=new Set,this.proxy=this.proxy.bind(this),this.hover=this.hover.bind(this),dt(e,this),gt(e,this),_t(e,this),vt(e,this),mt(e,this),bt(e),ht(e,this),yt(e)}proxy(e,t,n,r={}){if(Array.isArray(t))return t.map(t=>this.proxy(e,t,n,r));e.addEventListener(t,n,r);let i=()=>e.removeEventListener(t,n,r);return this.destroyEvents.add(i),i}hover(e,t,n){t&&this.proxy(e,`mouseenter`,t),n&&this.proxy(e,`mouseleave`,n)}remove(e){if(this.destroyEvents.has(e))try{e()}catch(e){console.warn(`Failed to remove event listener:`,e)}finally{this.destroyEvents.delete(e)}}destroy(){for(let e of this.destroyEvents)try{e()}catch(e){console.warn(`Failed to destroy event listener:`,e)}this.destroyEvents.clear()}},St=class{constructor(e){this.art=e,this.keys={},S||this.init()}init(){let{constructor:e}=this.art;this.art.option.hotkey&&(this.add(`Escape`,()=>{this.art.fullscreenWeb&&(this.art.fullscreenWeb=!1)}),this.add(`Space`,()=>{this.art.toggle()}),this.add(`ArrowLeft`,()=>{this.art.backward=e.SEEK_STEP}),this.add(`ArrowUp`,()=>{this.art.volume+=e.VOLUME_STEP}),this.add(`ArrowRight`,()=>{this.art.forward=e.SEEK_STEP}),this.add(`ArrowDown`,()=>{this.art.volume-=e.VOLUME_STEP})),this.art.on(`document:keydown`,e=>{if(this.art.isFocus){let t=document.activeElement.tagName.toUpperCase(),n=document.activeElement.getAttribute(`contenteditable`);if(t!==`INPUT`&&t!==`TEXTAREA`&&n!==``&&n!==`true`&&!e.altKey&&!e.ctrlKey&&!e.metaKey&&!e.shiftKey){let t=this.keys[e.code];if(t){e.preventDefault();for(let n=0;n<t.length;n++)t[n].call(this.art,e);this.art.emit(`hotkey`,e)}}}this.art.emit(`keydown`,e)})}add(e,t){return this.keys[e]?this.keys[e].includes(t)||this.keys[e].push(t):this.keys[e]=[t],this}remove(e,t){if(this.keys[e]){let n=this.keys[e].indexOf(t);n!==-1&&this.keys[e].splice(n,1),this.keys[e].length===0&&delete this.keys[e]}return this}},Ct={"Video Info":`统计信息`,Close:`关闭`,"Video Load Failed":`加载失败`,Volume:`音量`,Play:`播放`,Pause:`暂停`,Rate:`速度`,Mute:`静音`,"Video Flip":`画面翻转`,Horizontal:`水平`,Vertical:`垂直`,Reconnect:`重新连接`,"Show Setting":`显示设置`,"Hide Setting":`隐藏设置`,Screenshot:`截图`,"Play Speed":`播放速度`,"Aspect Ratio":`画面比例`,Default:`默认`,Normal:`正常`,Open:`打开`,"Switch Video":`切换`,"Switch Subtitle":`切换字幕`,Fullscreen:`全屏`,"Exit Fullscreen":`退出全屏`,"Web Fullscreen":`网页全屏`,"Exit Web Fullscreen":`退出网页全屏`,"Mini Player":`迷你播放器`,"PIP Mode":`开启画中画`,"Exit PIP Mode":`退出画中画`,"PIP Not Supported":`不支持画中画`,"Fullscreen Not Supported":`不支持全屏`,"Subtitle Offset":`字幕偏移`,"Last Seen":`上次看到`,"Jump Play":`跳转播放`,AirPlay:`隔空播放`,"AirPlay Not Available":`隔空播放不可用`};typeof window<`u`&&(window[`artplayer-i18n-zh-cn`]=Ct);var wt=class{constructor(e){this.art=e,this.languages={"zh-cn":Ct},this.language={},this.update(e.option.i18n)}init(){let e=this.art.option.lang.toLowerCase();this.language=this.languages[e]||{}}get(e){return this.language[e]||e}update(e){this.languages=Fe(this.languages,e),this.init()}},Tt=`<svg width="18px" height="18px" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
    <g>
...
</svg>`,jt=`<svg height="24" viewBox="0 0 24 24" width="24"><path d="M15,17h6v1h-6V17z M11,17H3v1h8v2h1v-2v-1v-2h-1V17z M14,8h1V6V5V3h-1v2H3v1h11V8z            M18,5v1h3V5H18z M6,14h1v-2v-1V9H6v2H3v1 h3V14z M10,12h11v-1H10V12z" data-darkreader-inline-fill="" style="--darkreader-inline-fill:#a8a6a4;"></path></svg>`,Mt=`<?xml version="1.0" standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
...
</svg>`,Nt=`<?xml version="1.0" standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
...
`,Pt=`<?xml version="1.0" standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
...
`,Rt=`<svg xmlns="http://www.w3.org/2000/svg" width="50px" height="50px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" class="uil-default">
...
</svg>`,zt=`<?xml version="1.0" standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
...
`,Bt=`<svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" viewBox="0 0 22 22">
    <path d="M7 3a2 2 0 0 0-2 2v12a2 2 0 1 0 4 0V5a2 2 0 0 0-2-2zM15 3a2 2 0 0 0-2 2v12a2 2 0 1 0 4 0V5a2 2 0 0 0-2-2z"></path>
</svg>`,Vt=`<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="22" height="22">
...
</svg>`,Ht=`<svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" viewBox="0 0 22 22">
  <path d="M17.982 9.275L8.06 3.27A2.013 2.013 0 0 0 5 4.994v12.011a2.017 2.017 0 0 0 3.06 1.725l9.922-6.005a2.017 2.017 0 0 0 0-3.45z"></path>
</svg>`,Ut=`<svg height="24" viewBox="0 0 24 24" width="24"><path d="M10,8v8l6-4L10,8L10,8z M6.3,5L5.7,4.2C7.2,3,9,2.2,11,2l0.1,1C9.3,3.2,7.7,3.9,6.3,5z            M5,6.3L4.2,5.7C3,7.2,2.2,9,2,11 l1,.1C3.2,9.3,3.9,7.7,5,6.3z            M5,17.7c-1.1-1.4-1.8-3.1-2-4.8L2,13c0.2,2,1,3.8,2.2,5.4L5,17.7z            M11.1,21c-1.8-0.2-3.4-0.9-4.8-2 l-0.6,.8C7.2,21,9,21.8,11,22L11.1,21z            M22,12c0-5.2-3.9-9.4-9-10l-0.1,1c4.6,.5,8.1,4.3,8.1,9s-3.5,8.5-8.1,9l0.1,1 C18.2,21.5,22,17.2,22,12z" data-darkreader-inline-fill="" style="--darkreader-inline-fill:#a8a6a4;"></path></svg>`,Wt=`<svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" viewBox="0 0 50 50">
...
`,Gt=`<svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" viewBox="0 0 22 22">
...
</svg>`,Kt=`<svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 24 24">
...
`,qt=`<?xml version="1.0" standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
...
</svg>`,Yt=`<?xml version="1.0" standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
...
`,ir=class extends Y{constructor(e){super(e),this.name=`subtitle`,this.option=null,this.destroyEvent=()=>null,this.init(e.option.subtitle);let t=!1;e.on(`video:timeupdate`,()=>{if(!this.url)return;let e=this.art.template.$video.webkitDisplayingFullscreen;typeof e==`boolean`&&e!==t&&(t=e,this.createTrack(e?`subtitles`:`metadata`,this.url))})}get url(){return this.art.template.$track.src}set url(e){this.switch(e)}get textTrack(){return this.art.template.$video?.textTracks?.[0]}get activeCues(){return this.textTrack?Array.from(this.textTrack.activeCues):[]}get cues(){return this.textTrack?Array.from(this.textTrack.cues):[]}style(e,t){let{$subtitle:n}=this.art.template;return typeof e==`object`?ve(n,e):A(n,e,t)}update(){let{option:{subtitle:e},template:{$subtitle:t}}=this.art;t.innerHTML=``,this.activeCues.length&&(this.art.emit(`subtitleBeforeUpdate`,this.activeCues),t.innerHTML=this.activeCues.map((t,n)=>t.text.split(/\r?\n/).filter(e=>e.trim()).map(t=>`<div class="art-subtitle-line" data-group="${n}">
                                ${e.escape?je(t):t}
                            </div>`).join(``)).join(``),this.art.emit(`subtitleAfterUpdate`,this.activeCues))}async switch(e,t={}){let{i18n:n,notice:r,option:i}=this.art,a={...i.subtitle,...t,url:e},o=await this.init(a);return t.name&&(r.show=`${n.get(`Switch Subtitle`)}: ${t.name}`),o}createTrack(e,t){let{template:n,proxy:r,option:i}=this.art,{$video:a,$track:o}=n,s=P(`track`);s.default=!0,s.kind=e,s.src=t,s.label=i.subtitle.name||`Artplayer`,s.track.mode=`hidden`,s.onload=()=>{this.art.emit(`subtitleLoad`,this.cues,this.option)},this.art.events.remove(this.destroyEvent),o.onload=null,_e(o),k(a,s),n.$track=s,this.destroyEvent=r(this.textTrack,`cuechange`,()=>this.update())}async init(e){let{notice:t,template:{$subtitle:n}}=this.art;if(!this.textTrack)return null;if(g(e,Ge.subtitle),e.url)return this.option=e,this.style(e.style),fetch(e.url).then(e=>e.arrayBuffer()).then(t=>{let n=new TextDecoder(e.encoding).decode(t);switch(e.type||L(e.url)){case`srt`:{let t=Le(n);return Re(e.onVttLoad(t))}case`ass`:{let t=ze(n);return Re(e.onVttLoad(t))}case`vtt`:return Re(e.onVttLoad(n));default:return e.url}}).then(e=>(n.innerHTML=``,this.url===e?e:(URL.revokeObjectURL(this.url),this.createTrack(`metadata`,e),e))).catch(e=>{throw n.innerHTML=``,t.show=e,e})}},ar=class e{constructor(e){this.art=e;let{option:t,constructor:n}=e;t.container instanceof Element?this.$container=t.container:(this.$container=w(t.container),I(this.$container,`No container element found by ${t.container}`)),I(Te(),`The current browser does not support flex layout`);let r=this.$container.tagName.toLowerCase();I(r===`div`,`Unsupported container element type, only support 'div' but got '${r}'`),I(n.instances.every(e=>e.template.$container!==this.$container),`Cannot mount multiple instances on the same dom element`),this.query=this.query.bind(this),this.$container.dataset.artId=e.id,this.init()}static get html(){return`
        ...
        `}query(e){return w(e,this.$container)}init(){let{option:t}=this.art;if(t.useSSR||(this.$container.innerHTML=e.html),this.$player=this.query(`.art-video-player`),this.$video=this.query(`.art-video`),this.$track=this.query(`track`),this.$poster=this.query(`.art-poster`),this.$subtitle=this.query(`.art-subtitle`),this.$danmuku=this.query(`.art-danmuku`),this.$bottom=this.query(`.art-bottom`),this.$progress=this.query(`.art-progress`),this.$controls=this.query(`.art-controls`),this.$controlsLeft=this.query(`.art-controls-left`),this.$controlsCenter=this.query(`.art-controls-center`),this.$controlsRight=this.query(`.art-controls-right`),this.$layer=this.query(`.art-layers`),this.$loading=this.query(`.art-loading`),this.$notice=this.query(`.art-notice`),this.$noticeInner=this.query(`.art-notice-inner`),this.$mask=this.query(`.art-mask`),this.$state=this.query(`.art-state`),this.$setting=this.query(`.art-settings`),this.$info=this.query(`.art-info`),this.$infoPanel=this.query(`.art-info-panel`),this.$infoClose=this.query(`.art-info-close`),this.$contextmenu=this.query(`.art-contextmenus`),t.proxy){let e=t.proxy.call(this.art,this.art);I(e instanceof HTMLVideoElement||e instanceof HTMLCanvasElement,`Function 'option.proxy' needs to return 'HTMLVideoElement' or 'HTMLCanvasElement'`),Se(e,this.$video),e.className=`art-video`,this.$video=e}t.backdrop&&E(this.$player,`art-backdrop`),S&&E(this.$player,`art-mobile`)}destroy(e){e?this.$container.innerHTML=``:E(this.$player,`art-destroy`)}},or=class{on(e,t,n){let r=this.e||(this.e={});return(r[e]||(r[e]=[])).push({fn:t,ctx:n}),this}once(e,t,n){let r=this;function i(...a){r.off(e,i),t.apply(n,a)}return i._=t,this.on(e,i,n)}emit(e,...t){let n=((this.e||(this.e={}))[e]||[]).slice();for(let e=0;e<n.length;e+=1)n[e].fn.apply(n[e].ctx,t);return this}off(e,t){let n=this.e||(this.e={}),r=n[e],i=[];if(r&&t)for(let e=0,n=r.length;e<n;e+=1)r[e].fn!==t&&r[e].fn._!==t&&i.push(r[e]);return i.length?n[e]=i:delete n[e],this}},sr=0,cr=[],$=class e extends or{constructor(t,n){if(super(),!C)throw Error(`Artplayer can only be used in the browser environment`);this.id=++sr;let r=Fe(e.option,t);if(r.container=t.container,this.option=g(r,Ge),this.isLock=!1,this.isReady=!1,this.isFocus=!1,this.isInput=!1,this.isRotate=!1,this.isDestroy=!1,this.template=new ar(this),this.events=new xt(this),this.storage=new nr(this),this.icons=new Qt(this),this.i18n=new wt(this),this.notice=new rn(this),this.player=new Wn(this),this.layers=new en(this),this.controls=new ut(this),this.contextmenu=new Qe(this),this.subtitle=new ir(this),this.info=new $t(this),this.loading=new tn(this),this.hotkey=new St(this),this.mask=new nn(this),this.setting=new tr(this),this.plugins=new Xn(this),typeof n==`function`&&this.on(`ready`,()=>n.call(this,this)),e.DEBUG){let t=e=>console.log(`[ART.${this.id}] -> ${e}`);t(`Version@${e.version}`);for(let e=0;e<v.events.length;e++)this.on(`video:${v.events[e]}`,e=>t(`Event@${e.type}`))}cr.push(this)}static get instances(){return cr}static get version(){return _}static get config(){return v}static get utils(){return He}static get scheme(){return Ge}static get Emitter(){return or}static get validator(){return g}static get kindOf(){return g.kindOf}static get html(){return ar.html}static get option(){return{id:``,container:`#artplayer`,url:``,poster:``,type:``,theme:`#f00`,volume:.7,isLive:!1,muted:!1,autoplay:!1,autoSize:!1,autoMini:!1,loop:!1,flip:!1,playbackRate:!1,aspectRatio:!1,screenshot:!1,setting:!1,hotkey:!0,pip:!1,mutex:!0,backdrop:!0,fullscreen:!1,fullscreenWeb:!1,subtitleOffset:!1,miniProgressBar:!1,useSSR:!1,playsInline:!0,lock:!1,gesture:!0,fastForward:!1,autoPlayback:!1,autoOrientation:!1,airplay:!1,proxy:void 0,layers:[],contextmenu:[],controls:[],settings:[],quality:[],highlight:[],plugins:[],thumbnails:{url:``,number:60,column:10,width:0,height:0,scale:1},subtitle:{url:``,type:``,style:{},name:``,escape:!0,encoding:`utf-8`,onVttLoad:e=>e},moreVideoAttr:{controls:!1,preload:b?`auto`:`metadata`},i18n:{},icons:{},cssVar:{},customType:{},lang:navigator?.language.toLowerCase()}}get proxy(){return this.events.proxy}get query(){return this.template.query}get video(){return this.template.$video}reset(){this.video.removeAttribute(`src`),this.video.load()}destroy(t=!0){e.REMOVE_SRC_WHEN_DESTROY&&this.reset(),this.events.destroy(),this.template.destroy(t),cr.splice(cr.indexOf(this),1),this.isDestroy=!0,this.emit(`destroy`)}};$.STYLE=rr,$.DEBUG=!1,$.CONTEXTMENU=!0,$.NOTICE_TIME=2e3,$.SETTING_WIDTH=250,$.SETTING_ITEM_WIDTH=200,$.SETTING_ITEM_HEIGHT=35,$.RESIZE_TIME=200,$.SCROLL_TIME=200,$.SCROLL_GAP=50,$.AUTO_PLAYBACK_MAX=10,$.AUTO_PLAYBACK_MIN=5,$.AUTO_PLAYBACK_TIMEOUT=3e3,$.RECONNECT_TIME_MAX=5,$.RECONNECT_SLEEP_TIME=1e3,$.CONTROL_HIDE_TIME=3e3,$.DBCLICK_TIME=300,$.DBCLICK_FULLSCREEN=!0,$.MOBILE_DBCLICK_PLAY=!0,$.MOBILE_CLICK_PLAY=!1,$.AUTO_ORIENTATION_TIME=200,$.INFO_LOOP_TIME=1e3,$.FAST_FORWARD_VALUE=3,$.FAST_FORWARD_TIME=1e3,$.TOUCH_MOVE_RATIO=.5,$.VOLUME_STEP=.1,$.SEEK_STEP=5,$.PLAYBACK_RATE=[.5,.75,1,1.25,1.5,2],$.ASPECT_RATIO=[`default`,`4:3`,`16:9`],$.FLIP=[`normal`,`horizontal`,`vertical`],$.FULLSCREEN_WEB_IN_BODY=!0,$.LOG_VERSION=!0,$.USE_RAF=!1,$.REMOVE_SRC_WHEN_DESTROY=!0,C&&(we(`artplayer-style`,rr),setTimeout(()=>{$.LOG_VERSION&&console.log(`%c ArtPlayer %c ${$.version} %c https://artplayer.org`,`color: #fff; background: #5f5f5f`,`color: #fff; background: #4bc729`,``)},100)),$.PLAYBACK_RATE=[.5,.75,1,1.25,1.5,2,3,4];var lr=[{icon:`iina`,name:`IINA`,scheme:`iina://weblink?url=$edurl`,platforms:[`MacOS`]},{icon:`potplayer`,name:`PotPlayer`,scheme:`potplayer://$durl`,platforms:[`Windows`]},{icon:`vlc`,name:`VLC`,scheme:`vlc://$durl`,platforms:[`Windows`,`MacOS`,`Linux`,`Android`,`iOS`]},{icon:`android`,name:`Android`,scheme:`intent:$durl#Intent;type=video/*;S.title=$name;end`,platforms:[`Android`]},{icon:`nplayer`,name:`nPlayer`,scheme:`nplayer-$durl`,platforms:[`Android`,`iOS`]},{icon:`omniplayer`,name:`OmniPlayer`,scheme:`omniplayer://weblink?url=$durl`,platforms:[`MacOS`]},{icon:`figplayer`,name:`Fig Player`,scheme:`figplayer://weblink?url=$durl`,platforms:[`MacOS`]},{icon:`infuse`,name:`Infuse`,scheme:`infuse://x-callback-url/play?url=$durl`,platforms:[`MacOS`,`iOS`]},{icon:`fileball`,name:`Fileball`,scheme:`filebox://play?url=$durl`,platforms:[`MacOS`,`iOS`]},{icon:`mxplayer`,name:`MX Player`,scheme:`intent:$durl#Intent;package=com.mxtech.videoplayer.ad;S.title=$name;end`,platforms:[`Android`]},{icon:`mxplayer-pro`,name:`MX Player Pro`,scheme:`intent:$durl#Intent;package=com.mxtech.videoplayer.pro;S.title=$name;end`,platforms:[`Android`]},{icon:`iPlay`,name:`iPlay`,scheme:`iplay://play/any?type=url&url=$bdurl`,platforms:[`iOS`]},{icon:`mpv`,name:`mpv`,scheme:`mpv://$edurl`,platforms:[`Windows`,`MacOS`,`Linux`,`Android`]}],ur=e=>{let{$container:t,$video:n}=e.template,r=t.parentElement;e.on(`ready`,()=>{r.style.maxHeight=`calc(100vh - ${r.offsetTop}px - 1.75rem)`,r.style.minHeight=`320px`,e.autoHeight()}),e.on(`resize`,()=>{e.autoHeight()}),e.on(`error`,()=>{n.style.height||(t.style.height=`60vh`,n.style.height=`100%`)})},dr=fe=>{let{replace:h,pathname:pe}=ee(),{currentObjLink:me}=ie(),{handleFolder:he}=f(),[g,_]=re(``),v=ne(()=>{let e=!0,t=!1,n=r.objs.filter(n=>n.type===le.VIDEO?(n.name===r.obj.name?(e=!1,t=!0,_(n.name)):t=!1,!0):!1);if(t&&(e=te().type!==`all`),e){let e=pe();if(!e.endsWith(r.obj.name))return n.push(r.obj),_(r.obj.name),n;let t=r.objs.length>0;he(se(e),a()+(t?1:0),void 0,t,!1,!0)}return n}),y=e(),b=localStorage.getItem(`video_auto_next`);b||(b=`true`),fe.onAutoNextChange(b===`true`);let[x,ge]=re(localStorage.getItem(`video_show_all_players`)===`true`),S=ce(),C=ne(()=>x()||S===`Unknown`?lr:lr.filter(e=>e.platforms.includes(S)));return c(n,{w:`$full`,spacing:`$2`,get children(){return[s(()=>fe.children),c(ae,{get when(){return g()!==``},get children(){return c(o,{spacing:`$2`,w:`$full`,get children(){return[c(ue,{onChange:e=>{h(e)},get value(){return g()},get options(){return v().map(e=>({value:e.name}))}}),c(u,{css:{whiteSpace:`nowrap`},defaultChecked:b===`true`,onChange:e=>{fe.onAutoNextChange(e.currentTarget.checked),localStorage.setItem(`video_auto_next`,e.currentTarget.checked.toString())},get children(){return y(`home.preview.auto_next`)}})]}})}}),c(i,{wrap:`wrap`,gap:`$1`,justifyContent:`center`,alignItems:`center`,get children(){return[c(d,{get each(){return C()},children:e=>c(m,{placement:`top`,withArrow:!0,get label(){return e.name},get children(){return c(t,{m:`0 auto`,boxSize:`$8`,get src(){return`${window.__dynamic_base__}/images/${e.icon}.webp`},onclick:()=>{let t=document.createElement(`a`);t.href=oe(e.scheme,{raw_url:r.raw_url,name:r.obj.name,d_url:me(!0)}),t.click()}})}})}),c(l,{"aria-label":`Show all players`,variant:`ghost`,onClick:()=>{let e=!x();ge(e),localStorage.setItem(`video_show_all_players`,e.toString())},get icon(){return c(p,{as:de,boxSize:`$6`,color:`accent.500`,get transform(){return x()?`rotate(180deg)`:`none`},transition:`transform 0.2s`})}})]}})]}})};export{$ as i,dr as n,lr as r,ur as t};
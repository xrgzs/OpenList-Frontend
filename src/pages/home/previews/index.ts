...
const previews: Preview[] = [
      ...
      ]),
  {
    ...
    component: lazy(() => import("./onlyoffice")),
    prior: true,
    availableInArchive: false,
  },
  {
    key: "drawio",
    exts: ["drawio", "dio"],
    component: lazy(() => import("./drawio")),
    prior: true,
  },
  {
    key: "excalidraw",
    exts: ["excalidraw"],
    component: lazy(() => import("./excalidraw")),
    prior: true,
  },
  {
    key: "photopea",
    exts: ["psd"],
    type: ObjType.IMAGE,
    component: lazy(() => import("./photopea")),
    prior: true,
  },
  {
    key: "file_viewer",
    ...
    component: lazy(() => import("./file-viewer")),
    prior: true,
  },
  {
    key: "ppt",
